...
/*   4 */ public class GLES10 {
    ...
    /*     */
    public static native void glDeleteTextures(int paramInt, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glFogfv(int paramInt, java.nio.FloatBuffer paramFloatBuffer);
    ...
    /*     */
    public static native void glFogxv(int paramInt, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glGenTextures(int paramInt, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glGetIntegerv(int paramInt, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glLightModelfv(int paramInt, java.nio.FloatBuffer paramFloatBuffer);
    ...
    /*     */
    public static native void glLightModelxv(int paramInt, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glLightfv(int paramInt1, int paramInt2, java.nio.FloatBuffer paramFloatBuffer);
    ...
    /*     */
    public static native void glLightxv(int paramInt1, int paramInt2, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glLoadMatrixf(java.nio.FloatBuffer paramFloatBuffer);

    /*     */
    public static native void glLoadMatrixx(int[] paramArrayOfInt, int paramInt);

    /*     */
    public static native void glLoadMatrixx(java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glMaterialfv(int paramInt1, int paramInt2, java.nio.FloatBuffer paramFloatBuffer);
    ...
    /*     */
    public static native void glMaterialxv(int paramInt1, int paramInt2, java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glMultMatrixf(java.nio.FloatBuffer paramFloatBuffer);

    /*     */
    public static native void glMultMatrixx(int[] paramArrayOfInt, int paramInt);

    /*     */
    public static native void glMultMatrixx(java.nio.IntBuffer paramIntBuffer);
    ...
    /*     */
    public static native void glTexEnvfv(int paramInt1, int paramInt2, java.nio.FloatBuffer paramFloatBuffer);
    ...
    /*     */
    public static native void glTexEnvxv(int paramInt1, int paramInt2, java.nio.IntBuffer paramIntBuffer);
...
/* Location:              /Users/amaurremi/uw/projects/WALA/com.ibm.wala.dalvik.test/data/android.jar!/android/opengl/GLES10.class
