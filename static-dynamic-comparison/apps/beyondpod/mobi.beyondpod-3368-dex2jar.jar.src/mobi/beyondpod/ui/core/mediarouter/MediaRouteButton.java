  ...
  extends View
{
  ...
  public MediaRouteButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setRemoteIndicatorDrawable(getResources().getDrawable(R.drawable.mr_ic_media_route_holo_dark));
    this.mMinHeight = 0;
    this.mMinWidth = 0;
    setClickable(true);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/beyondpod/mobi.beyondpod-3368-dex2jar.jar!/mobi/beyondpod/ui/core/mediarouter/MediaRouteButton.class
