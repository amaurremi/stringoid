  ...
  implements Serializable
{
  ...
  public static j a(Context paramContext)
  {
    ...
    //   4: ldc 2
    //   6: monitorenter
    //   7: getstatic 46	cmn/j:h	Lcmn/j;
    //   10: ifnull +12 -> 22
    //   13: getstatic 46	cmn/j:h	Lcmn/j;
    //   16: astore_0
    //   17: ldc 2
    //   19: monitorexit
    //   20: aload_0
    ...
    //   142: astore 10
    //   144: aload 9
    //   146: invokestatic 246	cmn/j:a	(Landroid/content/ContentResolver;)Ljava/lang/String;
    //   149: astore 9
    //   151: aload 9
    //   153: invokevirtual 249	java/lang/String:hashCode	()I
    //   156: istore_3
    //   157: aload 9
    //   159: invokestatic 251	cmn/j:a	(Ljava/lang/String;)J
    //   162: lstore 7
    //   164: aload 10
    //   166: ldc -31
    //   168: iload_2
    ...
    //   241: lload 7
    //   243: aload 9
    //   245: invokespecial 284	cmn/j:<init>	(IILjava/lang/String;JLjava/lang/String;)V
    //   248: astore 10
    //   250: aload 10
    //   252: aload 12
    //   254: putfield 286	cmn/j:z	Landroid/content/Context;
    //   257: aload 10
    //   259: aload 12
    //   261: invokespecial 289	cmn/j:b	(Landroid/content/Context;)V
    //   264: aload 12
    ...
    //   273: astore 9
    //   275: aload 11
    //   277: invokestatic 295	cmn/j:b	(Ljava/lang/String;)Z
    //   280: ifeq +19 -> 299
    //   283: aload 11
    //   285: aload 11
    //   287: bipush 46
    ...
    //   299: aload 10
    //   301: aload 9
    //   303: putfield 305	cmn/j:x	Ljava/lang/String;
    //   306: aload 10
    //   308: aload 12
    //   310: invokevirtual 292	android/content/Context:getPackageName	()Ljava/lang/String;
    //   313: putfield 307	cmn/j:y	Ljava/lang/String;
    //   316: aload 10
    //   318: aload 13
    //   320: invokestatic 312	cmn/ae:a	(Landroid/content/SharedPreferences;)Ljava/lang/String;
    //   323: putfield 74	cmn/j:j	Ljava/lang/String;
    //   326: aload 12
    //   328: ldc_w 314
    ...
    //   346: putfield 78	cmn/j:k	Ljava/lang/String;
    //   349: aload 10
    //   351: getfield 78	cmn/j:k	Ljava/lang/String;
    //   354: ifnonnull +10 -> 364
    //   357: aload 10
    //   359: ldc 76
    //   361: putfield 78	cmn/j:k	Ljava/lang/String;
    //   364: aload 10
    //   366: aload 9
    //   368: invokevirtual 326	android/telephony/TelephonyManager:getSimCountryIso	()Ljava/lang/String;
    //   371: putfield 80	cmn/j:l	Ljava/lang/String;
    //   374: aload 10
    //   376: getfield 80	cmn/j:l	Ljava/lang/String;
    //   379: ifnonnull +10 -> 389
    //   382: aload 10
    //   384: ldc 76
    //   386: putfield 80	cmn/j:l	Ljava/lang/String;
    //   389: aload 10
    //   391: aload 9
    //   393: invokevirtual 329	android/telephony/TelephonyManager:getSimOperator	()Ljava/lang/String;
    //   396: putfield 90	cmn/j:e	Ljava/lang/String;
    //   399: aload 10
    //   401: getfield 90	cmn/j:e	Ljava/lang/String;
    //   404: ifnonnull +10 -> 414
    //   407: aload 10
    //   409: ldc 76
    //   411: putfield 90	cmn/j:e	Ljava/lang/String;
    //   414: aload 10
    //   416: putstatic 46	cmn/j:h	Lcmn/j;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/broken screen/mobi.borken.android.brokenscreen-20-dex2jar.jar!/cmn/j.class
