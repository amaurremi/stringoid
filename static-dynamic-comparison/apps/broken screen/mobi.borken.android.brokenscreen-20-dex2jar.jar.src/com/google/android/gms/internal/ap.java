...
public final class ap
{
  ...
  public ap(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (this.mg = f(paramAttributeSet);; this.mg = f(str))
    {
      this.mh = paramContext.getString(2);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/broken screen/mobi.borken.android.brokenscreen-20-dex2jar.jar!/com/google/android/gms/internal/ap.class
