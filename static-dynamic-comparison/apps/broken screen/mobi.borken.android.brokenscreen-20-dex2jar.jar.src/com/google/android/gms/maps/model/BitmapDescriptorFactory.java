...
public final class BitmapDescriptorFactory
{
  ...
  public static BitmapDescriptor fromAsset(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(jH().bs(paramString));
      return paramString;
    }
  ...
  public static BitmapDescriptor fromBitmap(Bitmap paramBitmap)
  {
    try
    {
      paramBitmap = new BitmapDescriptor(jH().b(paramBitmap));
      return paramBitmap;
    }
  ...
  public static BitmapDescriptor fromFile(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(jH().bt(paramString));
      return paramString;
    }
    catch (RemoteException paramString)
    {
  ...
  public static BitmapDescriptor fromPath(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(jH().bu(paramString));
      return paramString;
    }
    catch (RemoteException paramString)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/broken screen/mobi.borken.android.brokenscreen-20-dex2jar.jar!/com/google/android/gms/maps/model/BitmapDescriptorFactory.class
