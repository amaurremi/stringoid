  ...
  extends AdWhirlAdapter
{
  ...
  public void displayCustom()
  {
    ...
    } while ((localObject1 == null) || (localAdWhirlLayout.custom == null));
    ...
    case 1: 
      ...
      {
        if (Extra2.verboselog) {
          Log.e("AdWhirl SDK", "adWhirlLayout.custom.image==null!!!!");
        }
        localAdWhirlLayout.rotateThreadedNow();
        return;
      }
    ...
    for (;;)
    {
      ...
      double d4 = AdWhirlUtil.getDensity((Activity)localObject1);
      double d1 = AdWhirlUtil.convertToScreenPixels(320, d4);
      double d2 = AdWhirlUtil.convertToScreenPixels(50, d4);
      double d3 = AdWhirlUtil.convertToScreenPixels(4, d4);
      d4 = AdWhirlUtil.convertToScreenPixels(6, d4);
      localRelativeLayout.setLayoutParams(new FrameLayout.LayoutParams((int)d1, (int)d2));
      ...
      ((ImageView)localObject2).setPadding((int)d3, 0, (int)d4, 0);
      ...
      ((ImageView)localObject3).setPadding((int)d3, 0, (int)d4, 0);
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      localException.handler.post(new CustomAdapter.DisplayCustomRunnable(this.customAdapter));
    }
  }
}


/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/bubble blast/com.magmamobile.game.BubbleBlast-23-dex2jar.jar!/com/adwhirl/adapters/CustomAdapter.class
