...
public class GoogleAnalyticsTracker
{
  ...
  private String userAgentVersion = "1.5.1";
  ...
  private void createEvent(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    paramString1 = new Event(paramString1, paramString2, paramString3, paramString4, paramString5, paramInt, this.parent.getResources().getDisplayMetrics().widthPixels, this.parent.getResources().getDisplayMetrics().heightPixels);
  ...
  void setOptOut(OptOut paramOptOut)
  {
    this.optOut = paramOptOut;
  }
  ...
  void start(String paramString, int paramInt, Context paramContext, HitStore paramHitStore, Dispatcher paramDispatcher, boolean paramBoolean, Dispatcher.Callbacks paramCallbacks)
  {
    ...
    this.optOut = new DeviceOptOutImpl(paramString.getPackageManager());
    ...
    if (this.handler == null) {
      this.handler = new Handler(paramString.getMainLooper());
    }
    for (;;)
    {
  ...
  void start(String paramString, int paramInt, Context paramContext, boolean paramBoolean)
  {
    ...
    if (this.hitStore == null)
    {
      paramContext = new PersistentHitStore(localContext);
      paramContext.setAnonymizeIp(this.anonymizeIp);
      paramContext.setSampleRate(this.sampleRate);
      if (this.dispatcher != null) {
        break label115;
      }
      localObject = new NetworkDispatcher(this.userAgentProduct, this.userAgentVersion);
      ((Dispatcher)localObject).setDryRun(this.dryRun);
    }
    for (;;)
    {
      start(paramString, paramInt, localContext, paramContext, (Dispatcher)localObject, paramBoolean);
      return;
      paramContext = this.hitStore;
      break;
      label115:
      localObject = this.dispatcher;
    }
  }
  ...
  public void trackEvent(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    createEvent(this.accountId, this.lastPagePath, paramString1, paramString2, paramString3, paramInt);
  }
  ...
  public void trackPageView(String paramString)
  {
    ...
    this.lastPagePath = paramString;
    createEvent(this.accountId, paramString, "__##GOOGLEPAGEVIEW##__", null, null, -1);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/bubble blast/com.magmamobile.game.BubbleBlast-23-dex2jar.jar!/com/google/android/apps/analytics/GoogleAnalyticsTracker.class
