...
public class aa
        extends a<d> {
    public aa(RSBaseParams paramRSBaseParams) {
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        Object localObject = (RSNoiseBaseFilterParams) b();
        int i = ((RSNoiseBaseFilterParams) localObject).getMin();
        int j = ((RSNoiseBaseFilterParams) localObject).getMax();
        ...
        for (; ; ) {
            ...
            paramRenderScript.k(j);
            paramRenderScript.aO((Allocation) localObject, paramContext);
            if (this.a != null) {
                this.a.b();
            }
            return paramContext;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/base/aa.class
