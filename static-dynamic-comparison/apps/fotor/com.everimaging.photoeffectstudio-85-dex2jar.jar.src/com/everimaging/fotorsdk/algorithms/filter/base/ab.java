...
public class ab
        extends a<d> {
    public ab(RSBaseParams paramRSBaseParams) {
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        ((d) a()).aP(localAllocation, paramContext);
        if (this.a != null) {
            this.a.b();
        }
        return paramContext;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/base/ab.class
