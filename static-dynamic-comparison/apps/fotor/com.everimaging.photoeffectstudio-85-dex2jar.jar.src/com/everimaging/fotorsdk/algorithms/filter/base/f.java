...
public class f
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        float f = ((RSContrastBaseFilterParams) b()).getContrast();
        ...
        for (; ; ) {
            ...
            paramRenderScript.d(f);
            paramRenderScript.g(localAllocation, paramContext);
            if (this.a != null) {
                this.a.b();
            }
            return paramContext;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/base/f.class
