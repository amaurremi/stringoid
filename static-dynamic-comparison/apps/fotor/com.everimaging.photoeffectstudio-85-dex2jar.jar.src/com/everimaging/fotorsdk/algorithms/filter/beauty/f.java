...
public class f
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        EyebrowPencilParams localEyebrowPencilParams = (EyebrowPencilParams) b();
        ...
        float f1 = localEyebrowPencilParams.getRed();
        float f2 = localEyebrowPencilParams.getGreen();
        float f3 = localEyebrowPencilParams.getBlue();
        locald.t(f1);
        locald.v(f2);
        locald.x(f3);
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/beauty/f.class
