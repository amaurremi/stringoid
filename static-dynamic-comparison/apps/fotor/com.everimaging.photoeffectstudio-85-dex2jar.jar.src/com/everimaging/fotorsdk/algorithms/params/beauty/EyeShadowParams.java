...
public class EyeShadowParams
        extends BaseParams {
    private float blue = 0.0F;
    private float green = 0.0F;
    private float red = 0.0F;

    public EyeShadowParams() {
        super(BaseParams.ParamsType.EYE_SHADOW);
    }
    ...
    public void parseFromJsonStr(String paramString) {
        paramString = (EyeShadowParams) new GsonBuilder().create().fromJson(paramString, getClass());
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/params/beauty/EyeShadowParams.class
