...
public class EyeTintParams
        extends BaseParams {
    private float blue = 0.0F;
    private float green = 0.0F;
    private float red = 0.0F;

    public EyeTintParams() {
        super(BaseParams.ParamsType.EYE_TINT);
    }
    ...
    public void parseFromJsonStr(String paramString) {
        paramString = (EyeTintParams) new GsonBuilder().create().fromJson(paramString, getClass());
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/params/beauty/EyeTintParams.class
