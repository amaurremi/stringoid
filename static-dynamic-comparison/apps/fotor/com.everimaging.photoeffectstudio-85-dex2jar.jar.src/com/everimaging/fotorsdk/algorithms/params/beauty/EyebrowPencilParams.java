...
public class EyebrowPencilParams
        extends BaseParams {
    ...
    public void parseFromJsonStr(String paramString) {
        paramString = (EyebrowPencilParams) new GsonBuilder().create().fromJson(paramString, getClass());
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/params/beauty/EyebrowPencilParams.class
