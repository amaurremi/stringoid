...
public class LipTintParams
        extends BaseParams {
    private float blue = 0.0F;
    private float green = 0.0F;
    private float red = 0.0F;

    public LipTintParams() {
        super(BaseParams.ParamsType.BLUSH);
    }
    ...
    public void parseFromJsonStr(String paramString) {
        paramString = (LipTintParams) new GsonBuilder().create().fromJson(paramString, getClass());
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/params/beauty/LipTintParams.class
