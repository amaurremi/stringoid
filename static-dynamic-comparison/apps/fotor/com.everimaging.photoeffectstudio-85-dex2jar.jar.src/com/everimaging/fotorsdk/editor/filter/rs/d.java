...
public class d
    ...
    public d(a.a parama, Bitmap paramBitmap1, Bitmap paramBitmap2, EffectsParams paramEffectsParams, IAssetLoader paramIAssetLoader) {
    ...
    public void a() {
        a(this.d, this.e, this.j, (EffectsParams) this.f);
    }

    public void a(boolean paramBoolean) {
        if ((paramBoolean) && (this.d != null) && (this.e != null)) {
    ...
    public void c() {
        ...
        try {
            ...
            for (; ; ) {
                m.e(new Object[]{"dispose error:" + localException.getMessage()});
            }
        }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/editor/filter/rs/d.class
