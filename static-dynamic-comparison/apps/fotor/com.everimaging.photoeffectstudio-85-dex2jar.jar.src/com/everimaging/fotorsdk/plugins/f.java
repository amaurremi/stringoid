...
public class f
    ...
    f(Context paramContext, FeatureInternalPack paramFeatureInternalPack) {
    ...
    public InputStream b(String paramString) {
        e.c(new Object[]{"getTexture:" + paramString});
        try {
            paramString = c("" + paramString);
            return paramString;
        } catch (IOException paramString) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/plugins/f.class
