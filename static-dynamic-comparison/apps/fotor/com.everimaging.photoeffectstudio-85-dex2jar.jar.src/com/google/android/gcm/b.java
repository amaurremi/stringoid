...
public final class b {
    ...
    static void a(Context paramContext, int paramInt) {
        paramContext = o(paramContext).edit();
    ...
    public static void a(Context paramContext, boolean paramBoolean) {
        SharedPreferences.Editor localEditor = o(paramContext).edit();
        localEditor.putBoolean("onServer", paramBoolean);
        long l = k(paramContext) + System.currentTimeMillis();
    ...
    static void f(Context paramContext) {
        ...
        //   0: ldc 2
        //   2: monitorenter
        //   3: getstatic 327	com/google/android/gcm/b:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
        //   6: ifnonnull +89 -> 95
        //   9: getstatic 245	com/google/android/gcm/b:b	Ljava/lang/String;
        //   12: ifnonnull +87 -> 99
        //   15: ldc 29
        //   17: ldc_w 342
        //   20: invokestatic 344	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
        //   23: pop
        //   24: new 346	com/google/android/gcm/GCMBroadcastReceiver
        //   27: dup
        //   28: invokespecial 347	com/google/android/gcm/GCMBroadcastReceiver:<init>	()V
        //   31: putstatic 327	com/google/android/gcm/b:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
        //   34: aload_0
        //   35: invokevirtual 126	android/content/Context:getPackageName	()Ljava/lang/String;
        //   38: astore_2
        //   39: new 349	android/content/IntentFilter
        //   42: dup
        //   43: ldc_w 351
        //   46: invokespecial 352	android/content/IntentFilter:<init>	(Ljava/lang/String;)V
        //   49: astore_1
        //   50: aload_1
        //   51: aload_2
        //   52: invokevirtual 355	android/content/IntentFilter:addCategory	(Ljava/lang/String;)V
        ...
        //   83: pop
        //   84: aload_0
        //   85: getstatic 327	com/google/android/gcm/b:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
        //   88: aload_1
        //   89: aload_2
        //   90: aconst_null
        //   91: invokevirtual 361	android/content/Context:registerReceiver	(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
        //   94: pop
        //   95: ldc 2
        //   97: monitorexit
        //   98: return
        //   99: getstatic 245	com/google/android/gcm/b:b	Ljava/lang/String;
        //   102: invokestatic 367	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
        //   105: invokevirtual 370	java/lang/Class:newInstance	()Ljava/lang/Object;
        //   108: checkcast 346	com/google/android/gcm/GCMBroadcastReceiver
        //   111: putstatic 327	com/google/android/gcm/b:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
        //   114: goto -80 -> 34
        //   117: astore_1
        //   118: ldc 29
        ...
        //   133: getstatic 245	com/google/android/gcm/b:b	Ljava/lang/String;
        ...
        //   145: ldc_w 346
        //   148: invokevirtual 377	java/lang/Class:getName	()Ljava/lang/String;
        ...
        //   163: invokestatic 344	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
        //   166: pop
        //   167: new 346	com/google/android/gcm/GCMBroadcastReceiver
        //   170: dup
        //   171: invokespecial 347	com/google/android/gcm/GCMBroadcastReceiver:<init>	()V
        //   174: putstatic 327	com/google/android/gcm/b:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
        //   177: goto -143 -> 34
        //   180: astore_0
        //   181: ldc 2
        //   183: monitorexit
    ...
    public static boolean h(Context paramContext) {
        return g(paramContext).length() > 0;
    }
    ...
    public static long k(Context paramContext) {
        return o(paramContext).getLong("onServerLifeSpan", 604800000L);
    }
    ...
    static int m(Context paramContext) {
        return o(paramContext).getInt("backoff_ms", 3000);
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/google/android/gcm/b.class
