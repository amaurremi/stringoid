    ...
    implements FileProvider.PathStrategy
  {
    ...
    public Uri getUriForFile(File paramFile)
    {
      ...
      for (;;)
      {
        ...
        if ((str1.startsWith(str2)) && ((paramFile == null) || (str2.length() > ((File)paramFile.getValue()).getPath().length()))) {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/content/FileProvider.class
