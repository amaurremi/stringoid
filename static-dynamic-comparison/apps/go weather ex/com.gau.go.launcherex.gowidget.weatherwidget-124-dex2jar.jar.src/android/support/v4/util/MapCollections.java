    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      do
      {
        return false;
        paramObject = (Map.Entry)paramObject;
      } while ((!ContainerHelpers.equal(((Map.Entry)paramObject).getKey(), MapCollections.this.colGetEntry(this.mIndex, 0))) || (!ContainerHelpers.equal(((Map.Entry)paramObject).getValue(), MapCollections.this.colGetEntry(this.mIndex, 1))));
      return true;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/util/MapCollections.class
