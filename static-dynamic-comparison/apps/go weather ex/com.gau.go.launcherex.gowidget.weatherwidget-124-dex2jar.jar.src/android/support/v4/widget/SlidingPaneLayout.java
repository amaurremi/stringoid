    ...
    for (;;)
    {
      ...
      if (localLayoutParams.slideable)
      {
        ...
        if (localLayoutParams.leftMargin + paramInt2 + i1 + n / 2 > j - k)
        {
          ...
          paramInt2 += localLayoutParams.leftMargin + i1;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/widget/SlidingPaneLayout.class
