...
public class Matrix4f
{
  ...
  private float computeCofactor(int paramInt1, int paramInt2)
  {
    ...
    float f = this.mMat[(m * 4 + i)] * (this.mMat[(n * 4 + j)] * this.mMat[(i1 * 4 + k)] - this.mMat[(i1 * 4 + j)] * this.mMat[(n * 4 + k)]) - this.mMat[(n * 4 + i)] * (this.mMat[(m * 4 + j)] * this.mMat[(i1 * 4 + k)] - this.mMat[(i1 * 4 + j)] * this.mMat[(m * 4 + k)]) + this.mMat[(i1 * 4 + i)] * (this.mMat[(m * 4 + j)] * this.mMat[(n * 4 + k)] - this.mMat[(n * 4 + j)] * this.mMat[(m * 4 + k)]);
  ...
  public void loadRotate(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    this.mMat[1] = (paramFloat3 * paramFloat2 + f4);
    ...
    this.mMat[10] = (paramFloat1 * paramFloat1 * paramFloat2 + f3);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v8/renderscript/Matrix4f.class
