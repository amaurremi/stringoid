  ...
  extends AsyncTask
{
  ...
  private Bitmap a(String paramString)
  {
    ...
    //   16: astore 6
    //   18: aload_0
    //   19: getfield 10	com/gau/go/launcherex/gowidget/weather/b/j:a	Lcom/gau/go/launcherex/gowidget/weather/b/g;
    //   22: aload 6
    //   24: aload_1
    //   25: invokestatic 30	com/gau/go/launcherex/gowidget/weather/b/g:a	(Lcom/gau/go/launcherex/gowidget/weather/b/g;Ljava/util/List;Ljava/lang/String;)V
        ...
        if ((localThemeDataBean.e() != null) && (!localThemeDataBean.e().equals("")))
        {
          ...
          if (localBitmap != null)
          {
            if (y.a())
            {
              ...
              localObject = a.a(localBitmap, localThemeDataBean.e() + ".png", ((File)localObject).getPath());
              if (localObject != null)
              {
  ...
  protected void b(ThemeDataBean... paramVarArgs)
  {
    if (g.k(this.a))
    {
      Intent localIntent = new Intent("com.gau.go.launcherex.gowidget.weatherwidget.ACTION_APP_WIDGET_DOWNLOAD_PREVIEW_DONE");
      localIntent.putExtra("com.gau.go.launcherex.gowidget.weatherwidget.EXTRA_APP_WIDGET_DOWNLOAD_PREVIEW_DONE", paramVarArgs[0]);
      g.e(this.a).sendBroadcast(localIntent);
    }
    g.a(this.a, paramVarArgs[0]);
  }
}


/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/b/j.class
