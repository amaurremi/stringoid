  ...
  extends AsyncTask
{
  ...
  private Bitmap a(String paramString)
  {
    ...
    //   16: astore 6
    //   18: aload_0
    //   19: getfield 10	com/gau/go/launcherex/gowidget/weather/b/q:a	Lcom/gau/go/launcherex/gowidget/weather/b/o;
    //   22: aload 6
    //   24: aload_1
    //   25: invokestatic 30	com/gau/go/launcherex/gowidget/weather/b/o:a	(Lcom/gau/go/launcherex/gowidget/weather/b/o;Ljava/util/List;Ljava/lang/String;)V
  ...
  protected void b(ThemeDataBean... paramVarArgs)
  {
    if (o.k(this.a))
    {
      Intent localIntent = new Intent("com.gau.go.launcherex.gowidget.weatherwidget.ACTION_GO_WIDGET_DOWNLOAD_PREVIEW_DONE");
      localIntent.putExtra("com.gau.go.launcherex.gowidget.weatherwidget.EXTRA_GO_WIDGET_DOWNLOAD_PREVIEW_DONE", paramVarArgs[0]);
      o.e(this.a).sendBroadcast(localIntent);
    }
    o.a(this.a, paramVarArgs[0]);
  }
}


/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/b/q.class
