...
public class MediaMetadata
{
  ...
  private final List<WebImage> xJ = new ArrayList();
  ...
  private void a(JSONObject paramJSONObject, String... paramVarArgs)
  {
    try
    {
      ...
      else
      {
        ...
        case 1: 
        case 4: 
          paramJSONObject.put(yq.R(str), this.yr.getString(str));
          break;
        case 2: 
          paramJSONObject.put(yq.R(str), this.yr.getInt(str));
          break;
        case 3: 
          paramJSONObject.put(yq.R(str), this.yr.getDouble(str));
          break;
          paramVarArgs = this.yr.keySet().iterator();
          while (paramVarArgs.hasNext())
          {
            str = (String)paramVarArgs.next();
            if (!str.startsWith("com.google."))
            {
              Object localObject = this.yr.get(str);
  ...
  private void b(JSONObject paramJSONObject, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          Object localObject2 = yq.S((String)localObject1);
          ...
          else
          {
            try
            {
              ...
              if (localObject1 != null) {
                switch (yq.T((String)localObject2))
                {
                case 1: 
                  if ((localObject1 instanceof String)) {
                    this.yr.putString((String)localObject2, (String)localObject1);
                  }
                  break;
                case 4: 
                  if (((localObject1 instanceof String)) && (ew.ac((String)localObject1) != null)) {
                    this.yr.putString((String)localObject2, (String)localObject1);
                  }
                  break;
                case 2: 
                  if ((localObject1 instanceof Integer)) {
                    this.yr.putInt((String)localObject2, ((Integer)localObject1).intValue());
                  }
                  break;
                case 3: 
                  if ((localObject1 instanceof Double))
                  {
                    this.yr.putDouble((String)localObject2, ((Double)localObject1).doubleValue());
                    continue;
                    localObject2 = paramJSONObject.get((String)localObject1);
                    if ((localObject2 instanceof String)) {
                      this.yr.putString((String)localObject1, (String)localObject2);
                    } else if ((localObject2 instanceof Integer)) {
                      this.yr.putInt((String)localObject1, ((Integer)localObject2).intValue());
                    } else if ((localObject2 instanceof Double)) {
                      this.yr.putDouble((String)localObject1, ((Double)localObject2).doubleValue());
                    }
                  }
                  break;
                }
    ...
    throws IllegalArgumentException
  {
    ...
    int i = yq.T(paramString);
    if ((i != paramInt) && (i != 0)) {
      throw new IllegalArgumentException("Value for " + paramString + " must be a " + yp[paramInt]);
    }
  }
  
  public void addImage(WebImage paramWebImage)
  {
    this.xJ.add(paramWebImage);
  }
  ...
  public void c(JSONObject paramJSONObject)
  {
    ...
    try
    {
      this.ys = paramJSONObject.getInt("metadataType");
      ew.a(this.xJ, paramJSONObject);
      switch (this.ys)
      {
      default: 
  ...
  {
    return this.yr.containsKey(paramString);
  }
  ...
  public JSONObject dB()
  {
    ...
    try
    {
      localJSONObject.put("metadataType", this.ys);
      ew.a(localJSONObject, this.xJ);
      switch (this.ys)
      {
      default: 
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((a(this.yr, ((MediaMetadata)paramObject).yr)) && (this.xJ.equals(((MediaMetadata)paramObject).xJ)));
    return false;
  }
  ...
  {
    d(paramString, 4);
    paramString = this.yr.getString(paramString);
    if (paramString != null) {
      return ew.ac(paramString);
    }
    return null;
  }
  ...
  {
    d(paramString, 4);
    return this.yr.getString(paramString);
  }
  
  public double getDouble(String paramString)
  {
    d(paramString, 3);
    return this.yr.getDouble(paramString);
  }
  ...
  {
    d(paramString, 2);
    return this.yr.getInt(paramString);
  }
  ...
  public int hashCode()
  {
    Iterator localIterator = this.yr.keySet().iterator();
    String str;
    for (int i = 17; localIterator.hasNext(); i = this.yr.get(str).hashCode() + i * 31) {
  ...
  {
    d(paramString, 4);
    this.yr.putString(paramString, ew.a(paramCalendar));
  }
  
  public void putDouble(String paramString, double paramDouble)
  {
    d(paramString, 3);
    this.yr.putDouble(paramString, paramDouble);
  }
  
  public void putInt(String paramString, int paramInt)
  {
    d(paramString, 2);
    this.yr.putInt(paramString, paramInt);
  }
  
  public void putString(String paramString1, String paramString2)
  {
    d(paramString1, 1);
    this.yr.putString(paramString1, paramString2);
  }
  ...
  private static class a
  {
    ...
    {
      return (String)this.yt.get(paramString);
    }
    
    public String S(String paramString)
    {
      return (String)this.yu.get(paramString);
    }
    
    public int T(String paramString)
    {
      paramString = (Integer)this.yv.get(paramString);
      if (paramString != null) {
    ...
    {
      this.yt.put(paramString1, paramString2);
      this.yu.put(paramString2, paramString1);
      this.yv.put(paramString1, Integer.valueOf(paramInt));
      return this;
    }
  }
}
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/cast/MediaMetadata.class
