  ...
  extends IInterface
{
  ...
  public abstract String aK(String paramString)
    throws RemoteException;
  
  public abstract String aL(String paramString)
    throws RemoteException;
    ...
    implements IGamesSignInService
  {
      ...
      throws RemoteException
    {
      ...
      case 5001: 
        ...
        paramParcel1 = aK(paramParcel1.readString());
      ...
      case 5003: 
        paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
        a(IGamesSignInCallbacks.Stub.O(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString(), paramParcel1.createStringArray(), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 5004: 
        paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
        a(IGamesSignInCallbacks.Stub.O(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString(), paramParcel1.createStringArray());
        paramParcel2.writeNoException();
        return true;
      case 5005: 
        paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
        a(IGamesSignInCallbacks.Stub.O(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString(), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 5006: 
        paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
        a(IGamesSignInCallbacks.Stub.O(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 5007: 
        paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
        b(IGamesSignInCallbacks.Stub.O(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString(), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 5008: 
        paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
        b(IGamesSignInCallbacks.Stub.O(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString(), paramParcel1.createStringArray());
        paramParcel2.writeNoException();
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.games.internal.IGamesSignInService");
      ...
      implements IGamesSignInService
    {
        ...
        throws RemoteException
      {
        ...
        //   46: aload_0
        //   47: getfield 43	com/google/android/gms/games/internal/IGamesSignInService$Stub$Proxy:kn	Landroid/os/IBinder;
        //   50: sipush 5006
        //   53: aload 4
        //   55: aload 5
        //   57: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   53: aload_0
        //   54: getfield 43	com/google/android/gms/games/internal/IGamesSignInService$Stub$Proxy:kn	Landroid/os/IBinder;
        //   57: sipush 5005
        //   60: aload 5
        //   62: aload 6
        //   64: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   60: aload_0
        //   61: getfield 43	com/google/android/gms/games/internal/IGamesSignInService$Stub$Proxy:kn	Landroid/os/IBinder;
        //   64: sipush 5003
        //   67: aload 6
        //   69: aload 7
        //   71: iconst_0
      ...
      public String aL(String paramString)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInService");
          localParcel1.writeString(paramString);
          this.kn.transact(5002, localParcel1, localParcel2, 0);
          localParcel2.readException();
          paramString = localParcel2.readString();
          return paramString;
        }
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.kn.transact(5009, localParcel1, localParcel2, 0);
          localParcel2.readException();
          paramString = localParcel2.readString();
          return paramString;
        }
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.kn.transact(9001, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/games/internal/IGamesSignInService.class
