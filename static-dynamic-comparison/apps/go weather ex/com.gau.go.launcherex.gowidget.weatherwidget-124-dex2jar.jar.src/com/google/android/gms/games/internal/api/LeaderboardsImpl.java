  ...
  implements Leaderboards
{
  ...
  public PendingResult<Leaderboards.SubmitScoreResult> submitScoreImmediate(GoogleApiClient paramGoogleApiClient, final String paramString1, final long paramLong, String paramString2)
  {
    paramGoogleApiClient.b(new SubmitScoreImpl()
    {
      protected void a(GamesClientImpl paramAnonymousGamesClientImpl)
      {
        paramAnonymousGamesClientImpl.a(this, paramString1, paramLong, this.Kw);
      }
    });
  }
  ...
  {
    public Leaderboards.LeaderboardMetadataResult D(final Status paramStatus)
    {
  ...
  {
    public Leaderboards.LoadPlayerScoreResult E(final Status paramStatus)
    {
  ...
  {
    public Leaderboards.LoadScoresResult F(final Status paramStatus)
    {
  ...
  {
    public Leaderboards.SubmitScoreResult G(final Status paramStatus)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/games/internal/api/LeaderboardsImpl.class
