  ...
  implements TurnBasedMultiplayer
{
  ...
  {
    Games.c(paramGoogleApiClient).aB(paramString);
  }
  ...
  {
    return Games.c(paramGoogleApiClient).gr();
  }
  
  public int getMaxMatchDataSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.c(paramGoogleApiClient).gA();
  }
  ...
  {
    Games.c(paramGoogleApiClient).gu();
  }
    ...
    extends Games.BaseGamesApiMethodImpl<TurnBasedMultiplayer.CancelMatchResult>
  {
    ...
    public TurnBasedMultiplayer.CancelMatchResult R(final Status paramStatus)
    {
  ...
  {
    public TurnBasedMultiplayer.InitiateMatchResult S(final Status paramStatus)
    {
  ...
  {
    public TurnBasedMultiplayer.LeaveMatchResult T(final Status paramStatus)
    {
  ...
  {
    public TurnBasedMultiplayer.LoadMatchResult U(final Status paramStatus)
    {
  ...
  {
    public TurnBasedMultiplayer.LoadMatchesResult V(final Status paramStatus)
    {
  ...
  {
    public TurnBasedMultiplayer.UpdateMatchResult W(final Status paramStatus)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/games/internal/api/TurnBasedMultiplayerImpl.class
