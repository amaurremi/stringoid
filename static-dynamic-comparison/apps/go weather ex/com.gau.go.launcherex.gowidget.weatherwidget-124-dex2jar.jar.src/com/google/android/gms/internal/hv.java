...
public abstract interface hv
  extends IInterface
{
  public abstract void a(hu paramhu, Uri paramUri, Bundle paramBundle, boolean paramBoolean)
  ...
  public static abstract class a
    ...
    implements hv
  {
    public static hv aM(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      hu localhu = hu.a.aL(paramParcel1.readStrongBinder());
      Bundle localBundle;
      ...
      {
        a(localhu, paramParcel2, localBundle, bool);
        return true;
        paramParcel2 = null;
        break;
        localBundle = null;
      ...
      implements hv
    {
      ...
      public void a(hu paramhu, Uri paramUri, Bundle paramBundle, boolean paramBoolean)
        throws RemoteException
      {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/internal/hv.class
