  ...
  implements h
{
  ...
  protected i(Context paramContext, n paramn, o paramo)
  {
    ...
    try
    {
      this.jO = paramContext.getResources().getDisplayMetrics();
      return;
    }
    ...
    throws NoSuchAlgorithmException, UnsupportedEncodingException, IOException
  {
    ...
    for (paramArrayOfByte = ByteBuffer.allocate(240).put((byte)localObject.length).put((byte[])localObject).put(paramArrayOfByte).array();; paramArrayOfByte = ByteBuffer.allocate(240).put((byte)localObject.length).put((byte[])localObject).array())
    {
      ...
      return this.jP.a((byte[])localObject, true);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jN = MotionEvent.obtain(0L, paramInt3, 1, paramInt1 * this.jO.density, paramInt2 * this.jO.density, 0.0F, 0.0F, 0, 0.0F, 0.0F, 0, 0);
  }
  
  protected void a(int paramInt, long paramLong)
    throws IOException
  {
    this.jQ.b(paramInt, paramLong);
  }
  
  protected void a(int paramInt, String paramString)
    throws IOException
  {
    this.jQ.b(paramInt, paramString);
  }
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 1)
    {
      ...
      this.jN = MotionEvent.obtain(paramMotionEvent);
    }
  }
    ...
    throws UnsupportedEncodingException
  {
    ...
    new km(str.getBytes("UTF-8")).m(paramArrayOfByte);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/internal/i.class
