...
public final class ku
{
    ...
    throws IllegalAccessException, InvocationTargetException
  {
    ...
    if ((paramObject instanceof kt))
    {
      ...
      if (paramString != null)
      {
        paramStringBuffer2.append(paramStringBuffer1).append(cg(paramString)).append(" <\n");
  ...
  public static <T extends kt> String e(T paramT)
  {
    if (paramT == null) {
      return "";
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/internal/ku.class
