...
public final class PlusShare
{
  ...
  protected static boolean bd(String paramString)
  {
  ...
  public static Person createPerson(String paramString1, String paramString2)
  {
    ...
    return new ih(paramString2, paramString1, null, 0, null);
  }
  ...
  public static class Builder
  {
    ...
    public Builder(Activity paramActivity, PlusClient paramPlusClient)
    {
      ...
      {
        bool = true;
        fq.a(bool, "PlusClient must not be null.");
        fq.a(paramPlusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
        fq.a(paramPlusClient.iI().bg("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
    ...
    public Builder addCallToAction(String paramString1, Uri paramUri, String paramString2)
    {
      ...
      {
        fq.b(bool, "Must provide a call to action URL");
        Bundle localBundle = new Bundle();
        if (!TextUtils.isEmpty(paramString1)) {
        ...
        if (!TextUtils.isEmpty(paramString2))
        {
          fq.a(PlusShare.bd(paramString2), "The specified deep-link ID was malformed.");
    ...
    public Builder addStream(Uri paramUri)
    {
      ...
      this.Ua.add(localUri);
      this.Ua.add(paramUri);
      return this;
    }
    ...
    public Intent getIntent()
    {
      ...
      if ((this.Ua != null) && (this.Ua.size() > 1))
      {
        ...
        bool1 = true;
        label59:
        fq.a(bool1, "Call-to-action buttons are only available for URLs.");
        if ((bool4) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label312;
        }
        bool1 = true;
        label84:
        fq.a(bool1, "The content URL is required for interactive posts.");
        bool1 = bool2;
        if (bool4)
        {
          bool1 = bool2;
        ...
        label125:
        fq.a(bool1, "Must set content URL or content deep-link ID to use a call-to-action button.");
        if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
    ...
    public Builder setContentDeepLinkId(String paramString1, String paramString2, String paramString3, Uri paramUri)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        fq.b(bool, "The deepLinkId parameter is required.");
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/plus/PlusShare.class
