...
public abstract interface b
  extends IInterface
{
  public abstract void Z(Status paramStatus)
  ...
  public abstract void a(int paramInt, Bundle paramBundle, gg paramgg)
    throws RemoteException;
  
  public abstract void a(int paramInt, ih paramih)
    throws RemoteException;
    ...
    implements b
  {
      ...
      throws RemoteException
    {
      ...
      case 5: 
        ...
        {
          if (paramParcel1.readInt() != 0) {
            localgg = gg.CREATOR.x(paramParcel1);
          }
          a(paramInt1, (Bundle)localObject1, localgg);
          paramParcel2.writeNoException();
          return true;
        }
      case 6: 
      ...
      case 9: 
        ...
        if (paramParcel1.readInt() != 0) {
          localObject1 = ih.CREATOR.aN(paramParcel1);
        }
        a(paramInt1, (ih)localObject1);
        paramParcel2.writeNoException();
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
      ...
      implements b
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/plus/internal/b$a$a:kn	Landroid/os/IBinder;
        //   33: bipush 10
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
      ...
      public void a(int paramInt, Bundle paramBundle, gg paramgg)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        for (;;)
        {
          try
          {
            ...
            if (paramBundle != null)
            {
              ...
              {
                localParcel1.writeInt(1);
                paramgg.writeToParcel(localParcel1, 0);
      ...
      /* Error */
      public void a(int paramInt, ih paramih)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 29	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   30: aload_3
        //   31: iconst_0
        //   32: invokevirtual 74	com/google/android/gms/internal/ih:writeToParcel	(Landroid/os/Parcel;I)V
        //   35: aload_0
        //   36: getfield 18	com/google/android/gms/plus/internal/b$a$a:kn	Landroid/os/IBinder;
        //   39: bipush 9
        //   41: aload_3
        //   42: aload 4
        //   44: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   25: aload_3
        //   26: iconst_0
        //   27: invokevirtual 78	com/google/android/gms/common/data/DataHolder:writeToParcel	(Landroid/os/Parcel;I)V
        //   30: aload_3
        //   31: aload_2
        //   32: invokevirtual 81	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   35: aload_0
        //   36: getfield 18	com/google/android/gms/plus/internal/b$a$a:kn	Landroid/os/IBinder;
        //   39: iconst_4
        //   40: aload_3
        ...
        throws RemoteException
      {
        ...
        //   28: aload 4
        //   30: iconst_0
        //   31: invokevirtual 78	com/google/android/gms/common/data/DataHolder:writeToParcel	(Landroid/os/Parcel;I)V
        //   34: aload 4
        //   36: aload_2
        //   37: invokevirtual 81	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   40: aload 4
        //   42: aload_3
        //   43: invokevirtual 81	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   46: aload_0
        //   47: getfield 18	com/google/android/gms/plus/internal/b$a$a:kn	Landroid/os/IBinder;
        //   50: bipush 6
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/plus/internal/b.class
