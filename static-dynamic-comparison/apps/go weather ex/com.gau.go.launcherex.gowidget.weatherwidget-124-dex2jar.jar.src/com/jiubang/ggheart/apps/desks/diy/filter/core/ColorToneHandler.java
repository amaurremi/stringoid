  ...
  extends AbsFilterHandler
{
  ...
  public native void doFilt(int[] paramArrayOfInt, int paramInt1, int paramInt2, int paramInt3, int paramInt4);
  ...
  public Bitmap handler(FilterParameter paramFilterParameter)
  {
    ...
    do
    {
      ...
      doFilt((int[])localObject, i, j, paramFilterParameter.getDiyColor(), 192);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/jiubang/ggheart/apps/desks/diy/filter/core/ColorToneHandler.class
