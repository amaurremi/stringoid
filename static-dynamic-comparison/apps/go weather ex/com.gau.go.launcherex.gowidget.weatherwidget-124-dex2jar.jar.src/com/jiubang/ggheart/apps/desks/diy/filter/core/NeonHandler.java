  ...
  extends AbsFilterHandler
{
  ...
  public native void doFilt(int[] paramArrayOfInt, int paramInt1, int paramInt2, int paramInt3);
  ...
  public Bitmap handler(FilterParameter paramFilterParameter)
  {
    ...
    do
    {
      ...
      doFilt((int[])localObject, i, j, -65536);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/jiubang/ggheart/apps/desks/diy/filter/core/NeonHandler.class
