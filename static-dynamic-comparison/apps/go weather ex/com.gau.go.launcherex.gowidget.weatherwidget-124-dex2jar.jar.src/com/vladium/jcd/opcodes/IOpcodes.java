...
public abstract interface IOpcodes
{
  ...
  static
  {
    CONDITIONAL_BRANCHES = clinit._CONDITIONAL_BRANCHES;
    COMPOUND_CONDITIONAL_BRANCHES = clinit._COMPOUND_CONDITIONAL_BRANCHES;
    UNCONDITIONAL_BRANCHES = clinit._UNCONDITIONAL_BRANCHES;
  }
  ...
  public static final class clinit
  {
    ...
    static
    {
      int j = IOpcodes.MNEMONICS.length;
      _CONDITIONAL_BRANCHES = new boolean[j];
      ...
      _CONDITIONAL_BRANCHES[''] = true;
      _CONDITIONAL_BRANCHES[''] = true;
      _CONDITIONAL_BRANCHES['Æ'] = true;
      _CONDITIONAL_BRANCHES['Ç'] = true;
      _CONDITIONAL_BRANCHES[''] = true;
      _CONDITIONAL_BRANCHES[' '] = true;
      _CONDITIONAL_BRANCHES['¡'] = true;
      _CONDITIONAL_BRANCHES['£'] = true;
      ...
      _CONDITIONAL_BRANCHES['¥'] = true;
      _CONDITIONAL_BRANCHES['¦'] = true;
      _COMPOUND_CONDITIONAL_BRANCHES = new boolean[j];
      _COMPOUND_CONDITIONAL_BRANCHES['ª'] = true;
      _COMPOUND_CONDITIONAL_BRANCHES['«'] = true;
      _UNCONDITIONAL_BRANCHES = new boolean[j];
      _UNCONDITIONAL_BRANCHES['§'] = true;
      _UNCONDITIONAL_BRANCHES['È'] = true;
      _UNCONDITIONAL_BRANCHES['¨'] = true;
      _UNCONDITIONAL_BRANCHES['É'] = true;
      _UNCONDITIONAL_BRANCHES['©'] = true;
      _UNCONDITIONAL_BRANCHES['¬'] = true;
      _UNCONDITIONAL_BRANCHES['­'] = true;
      _UNCONDITIONAL_BRANCHES['®'] = true;
      ...
      _UNCONDITIONAL_BRANCHES['±'] = true;
      _UNCONDITIONAL_BRANCHES['¿'] = true;
      _BRANCHES = new boolean[j];
      int i = 0;
      while (i < j)
      {
        if (_CONDITIONAL_BRANCHES[i] != 0) {
          _BRANCHES[i] = true;
        }
        i += 1;
      }
      ...
      while (i < j)
      {
        if (_COMPOUND_CONDITIONAL_BRANCHES[i] != 0) {
          _BRANCHES[i] = true;
        }
        i += 1;
      }
      ...
      while (i < j)
      {
        if (_UNCONDITIONAL_BRANCHES[i] != 0) {
          _BRANCHES[i] = true;
        }
        i += 1;
      }
      _NARROW_SIZE = new int[j];
      i = 0;
      while (i < j)
      {
        _NARROW_SIZE[i] = 1;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/vladium/jcd/opcodes/IOpcodes.class
