...
public abstract class FragmentStatePagerAdapter
    ...
    public FragmentStatePagerAdapter(q paramq) {
        this.mFragmentManager = paramq;
    }
        ...
        if (paramParcelable != null) {
            ...
            while (paramClassLoader.hasNext()) {
                ...
                if (str.startsWith("f")) {
                    ...
                    Fragment localFragment = this.mFragmentManager.a(paramParcelable, str);
                    if (localFragment != null) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v4/app/FragmentStatePagerAdapter.class
