...
public class ac {
    ...
    private void c(MotionEvent paramMotionEvent) {
        int i2 = as.c(paramMotionEvent);
        int i1 = 0;
        while (i1 < i2) {
            int i3 = as.b(paramMotionEvent, i1);
            float f1 = as.c(paramMotionEvent, i1);
            float f2 = as.d(paramMotionEvent, i1);
            this.f[i3] = f1;
            this.g[i3] = f2;
            i1 += 1;
        }
    ...
    private void h() {
        ...
        a(a(ay.a(this.l, this.c), this.n, this.m), a(ay.b(this.l, this.c), this.n, this.m));
    }
    ...
    public boolean a(int paramInt1, int paramInt2) {
        ...
        return a(paramInt1, paramInt2, (int) ay.a(this.l, this.c), (int) ay.b(this.l, this.c));
    }

    public boolean a(MotionEvent paramMotionEvent) {
        int i2 = as.a(paramMotionEvent);
    ...
    public void b(MotionEvent paramMotionEvent) {
        ...
        switch (i4) {
            ...
            case 5:
                do {
                    do {
                        ...
                        this.r.a(i2 & this.p, i1);
                        return;
                        i1 = as.b(paramMotionEvent, i3);
                        f1 = as.c(paramMotionEvent, i3);
                        f2 = as.d(paramMotionEvent, i3);
                        a(f1, f2, i1);
                        if (this.a != 0) {
                            break;
                        }
            ...
            case 2:
                if (this.a == 1) {
                    i1 = as.a(paramMotionEvent, this.c);
                    f1 = as.c(paramMotionEvent, i1);
                    f2 = as.d(paramMotionEvent, i1);
            ...
            case 6:
                label461:
                i2 = as.b(paramMotionEvent, i3);
                if ((this.a == 1) && (i2 == this.c)) {
                    i3 = as.c(paramMotionEvent);
                    if (i1 >= i3) {
                        break label669;
                    }
                    i4 = as.b(paramMotionEvent, i1);
                    if (i4 == this.c) {
                    }
                    do {
                        i1 += 1;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v4/widget/ac.class
