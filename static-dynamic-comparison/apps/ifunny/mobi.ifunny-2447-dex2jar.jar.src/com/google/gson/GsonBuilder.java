...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String paramString, int paramInt1, int paramInt2, List<TypeAdapterFactory> paramList) {
        ...
        for (paramString = new a(paramString); ; paramString = new a(paramInt1, paramInt2)) {
            paramList.add(o.a(TypeToken.get(java.util.Date.class), paramString));
            paramList.add(o.a(TypeToken.get(Timestamp.class), paramString));
            paramList.add(o.a(TypeToken.get(java.sql.Date.class), paramString));
            do {
                return;
    ...
    public GsonBuilder registerTypeAdapter(Type paramType, Object paramObject) {
        ...
        for (boolean bool = true; ; bool = false) {
            ...
            if (((paramObject instanceof JsonSerializer)) || ((paramObject instanceof JsonDeserializer))) {
                ...
                this.factories.add(o.b(localTypeToken, paramObject));
            }
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class<?> paramClass, Object paramObject) {
        ...
        for (boolean bool = true; ; bool = false) {
            ...
            if (((paramObject instanceof JsonDeserializer)) || ((paramObject instanceof JsonSerializer))) {
                this.hierarchyFactories.add(0, o.a(paramClass, paramObject));
            }
            if ((paramObject instanceof TypeAdapter)) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/google/gson/GsonBuilder.class
