...
public class AdDatabaseHelper
    ...
    public void onCreate(SQLiteDatabase paramSQLiteDatabase) {
        Log.internal("[InMobi]-4.5.1", "CREATE TABLE IF NOT EXISTS ad (adid INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, timestamp INTEGER NOT NULL, appid VARCHAR NOT NULL, content VARCHAR NOT NULL, adtype VARCHAR NOT NULL);");
    ...
    public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2) {
        Log.internal("[InMobi]-4.5.1", "Upgrading database from version " + paramInt1 + " to " + paramInt2 + ", which will destroy all old data");
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/inmobi/commons/ads/cache/AdDatabaseHelper.class
