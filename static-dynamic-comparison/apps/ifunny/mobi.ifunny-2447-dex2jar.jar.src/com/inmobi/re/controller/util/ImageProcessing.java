...
public class ImageProcessing {
    ...
    public static Bitmap getCompressedBitmap(String paramString, Context paramContext) {
        try {
            ...
            for (; ; ) {
                paramContext.close();
                Log.debug("[InMobi]-[RE]-4.5.1", "bitmap size - width: " + paramString.getWidth() + ", height: " + paramString.getHeight());
                return paramString;
                paramString = BitmapFactory.decodeStream(paramContext);
            }
            return null;
        } catch (IOException paramString) {
            Log.debug("[InMobi]-[RE]-4.5.1", paramString.getMessage(), paramString);
        }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/inmobi/re/controller/util/ImageProcessing.class
