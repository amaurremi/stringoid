...
public class MraidView
    ...
    public MraidView(Context paramContext, AdConfiguration paramAdConfiguration) {
        this(paramContext, paramAdConfiguration, MraidView.ExpansionStyle.ENABLED, MraidView.NativeCloseButtonStyle.AD_CONTROLLED, MraidView.PlacementType.INLINE);
    }

    public MraidView(Context paramContext, AdConfiguration paramAdConfiguration, MraidView.ExpansionStyle paramExpansionStyle, MraidView.NativeCloseButtonStyle paramNativeCloseButtonStyle, MraidView.PlacementType paramPlacementType) {
        super(paramContext);
    ...
    private void initialize(MraidView.ExpansionStyle paramExpansionStyle, MraidView.NativeCloseButtonStyle paramNativeCloseButtonStyle) {
        setScrollContainer(false);
        setBackgroundColor(0);
        setVerticalScrollBarEnabled(false);
        setHorizontalScrollBarEnabled(false);
        setOnTouchListener(new MraidView .1 (this));
        ...
        this.mWebViewClient = new MraidView.MraidWebViewClient(this, null);
        setWebViewClient(this.mWebViewClient);
        this.mListenerInfo = new MraidView.MraidListenerInfo();
    }

    private void notifyOnFailureListener() {
        if (MraidView.MraidListenerInfo.access$200(this.mListenerInfo) != null) {
            MraidView.MraidListenerInfo.access$200(this.mListenerInfo).onFailure(this);
        }
    }
    ...
    private boolean tryCommand(URI paramURI) {
        ...
        paramURI = MraidCommandFactory.create(str, paramURI, this);
        if (paramURI == null) {
            fireNativeCommandCompleteEvent(str);
            return false;
        }
        if ((paramURI.isCommandDependentOnUserClick(this.mPlacementType)) && (!wasClicked())) {
            return false;
        }
        paramURI.execute();
        fireNativeCommandCompleteEvent(str);
    ...
    protected void fireChangeEventForProperty(MraidProperty paramMraidProperty) {
        paramMraidProperty = "{" + paramMraidProperty.toString() + "}";
        injectJavaScript("window.mraidbridge.fireChangeEvent(" + paramMraidProperty + ");");
        Log.d("MraidView", "Fire change: " + paramMraidProperty);
    }

    protected void fireErrorEvent(MraidCommandFactory.MraidJavascriptCommand paramMraidJavascriptCommand, String paramString) {
        paramMraidJavascriptCommand = paramMraidJavascriptCommand.getCommand();
    ...
    public MraidView.MraidListener getMraidListener() {
        return MraidView.MraidListenerInfo.access$200(this.mListenerInfo);
    }
    ...
    public MraidView.OnCloseButtonStateChangeListener getOnCloseButtonStateChangeListener() {
        return MraidView.MraidListenerInfo.access$300(this.mListenerInfo);
    }
    ...
    public void loadHtmlData(String paramString) {
        ...
        if (!paramString.contains("<html>")) {
            str = "<html><head></head><body style='margin:0;padding:0;'>" + paramString + "</body></html>";
        }
    ...
    public void loadUrl(String paramString) {
        ...
        Object localObject = HttpClientFactory.create();
        String str = "";
        try {
            localObject = ((HttpClient) localObject).execute(new HttpGet(paramString)).getEntity();
            if (localObject != null) {
                str = Strings.fromStream(((HttpEntity) localObject).getContent());
            }
            loadHtmlData(str);
            return;
        } catch (IllegalArgumentException localIllegalArgumentException) {
            MoPubLog.d("Mraid loadUrl failed (IllegalArgumentException): " + paramString);
    ...
    @Deprecated
    void setHasFiredReadyEvent(boolean paramBoolean) {
        this.mHasFiredReadyEvent = paramBoolean;
    }

    @Deprecated
    void setMraidDisplayController(MraidDisplayController paramMraidDisplayController) {
        this.mDisplayController = paramMraidDisplayController;
    }

    public void setMraidListener(MraidView.MraidListener paramMraidListener) {
        MraidView.MraidListenerInfo.access$202(this.mListenerInfo, paramMraidListener);
    }

    public void setOnCloseButtonStateChange(MraidView.OnCloseButtonStateChangeListener paramOnCloseButtonStateChangeListener) {
        MraidView.MraidListenerInfo.access$302(this.mListenerInfo, paramOnCloseButtonStateChangeListener);
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/mopub/mobileads/MraidView.class
