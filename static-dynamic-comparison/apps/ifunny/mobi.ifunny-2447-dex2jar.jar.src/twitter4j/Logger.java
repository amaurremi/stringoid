...
public abstract class Logger {
    ...
    static {
        ...
        if (localObject1 == null) {
            localObject2 = getLoggerFactoryIfAvailable("org.slf4j.impl.StaticLoggerBinder", "twitter4j.SLF4JLoggerFactory");
        }
        localObject1 = localObject2;
        if (localObject2 == null) {
            localObject1 = getLoggerFactoryIfAvailable("org.apache.commons.logging.Log", "twitter4j.CommonsLoggingLoggerFactory");
        }
        localObject2 = localObject1;
        if (localObject1 == null) {
            localObject2 = getLoggerFactoryIfAvailable("org.apache.log4j.Logger", "twitter4j.Log4JLoggerFactory");
        }
        localObject1 = localObject2;
        if (localObject2 == null) {
            localObject1 = getLoggerFactoryIfAvailable("com.google.appengine.api.urlfetch.URLFetchService", "twitter4j.JULLoggerFactory");
        }
        localObject2 = localObject1;
        if (localObject1 == null) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/twitter4j/Logger.class
