...
public class APIStatisticsOpenMBean
    ...
    public AttributeList getAttributes(String[] paramArrayOfString) {
        ...
        while (i < j) {
            ...
            try {
                localAttributeList.add(new Attribute(str, getAttribute(str)));
                i += 1;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/twitter4j/management/APIStatisticsOpenMBean.class
