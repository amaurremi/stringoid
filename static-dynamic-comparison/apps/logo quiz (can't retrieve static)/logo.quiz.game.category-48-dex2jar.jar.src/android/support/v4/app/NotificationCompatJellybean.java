...
class NotificationCompatJellybean
{
  ...
  {
    paramCharSequence1 = new Notification.BigPictureStyle(this.b).setBigContentTitle(paramCharSequence1).bigPicture(paramBitmap);
    if (paramBoolean) {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/android/support/v4/app/NotificationCompatJellybean.class
