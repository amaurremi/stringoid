  ...
  extends Button
{
  ...
  public MagicButton(Context paramContext)
  {
    super(paramContext);
    init(null);
  }
  
  public MagicButton(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    init(paramAttributeSet);
  }
  
  public MagicButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public void init(AttributeSet paramAttributeSet)
  {
    ...
    if (paramAttributeSet != null)
    {
      ...
      String str2 = localTypedArray.getString(8);
      String str1 = localTypedArray.getString(9);
      paramAttributeSet = str1;
      if (TextUtils.isEmpty(str1)) {
        paramAttributeSet = "ttf";
      }
      if ((!isInEditMode()) && (str2 != null)) {
        setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/" + str2 + "." + paramAttributeSet));
      }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/bluebird/mobile/tools/font/MagicButton.class
