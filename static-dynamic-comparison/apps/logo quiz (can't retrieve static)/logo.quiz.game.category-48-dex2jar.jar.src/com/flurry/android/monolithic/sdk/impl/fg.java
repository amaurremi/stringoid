...
public class fg
{
    ...
    throws IOException
  {
    ...
    ja.a(3, a, "File version: " + i);
    if (i > 2)
    {
      ja.a(6, a, "Unknown agent file version: " + i);
      throw new IOException("Unknown agent file version: " + i);
    }
    if (i >= 2)
    {
      Object localObject = paramDataInputStream.readUTF();
      ja.a(3, a, "Loading API key: " + a(paramString));
      if (((String)localObject).equals(paramString))
      {
        ...
        ja.a(3, a, "Loading session reports");
        i = 0;
        for (;;)
        {
          ...
          if (j == 0)
          {
            ja.a(3, a, "Persistent file loaded");
            a(bool);
            a(l);
            a(paramString);
            return true;
          ...
          paramString.add(0, new ez((byte[])localObject));
          localObject = a;
          StringBuilder localStringBuilder = new StringBuilder().append("Session report added: ");
          i += 1;
          ja.a(3, (String)localObject, i);
        }
      }
      ja.a(3, a, "Api keys do not match, old: " + a(paramString) + ", new: " + a((String)localObject));
      return false;
    }
    ja.a(5, a, "Deleting old file version: " + i);
    return false;
  }
    ...
    throws IOException
  {
    ...
    //   21: aload_1
    //   22: aload_0
    //   23: getfield 151	com/flurry/android/monolithic/sdk/impl/fg:b	Z
    //   26: invokevirtual 154	java/io/DataOutputStream:writeBoolean	(Z)V
    //   29: aload_1
    //   30: aload_0
    //   31: getfield 31	com/flurry/android/monolithic/sdk/impl/fg:d	J
    //   34: invokevirtual 157	java/io/DataOutputStream:writeLong	(J)V
    //   37: aload_0
    //   38: getfield 159	com/flurry/android/monolithic/sdk/impl/fg:c	Ljava/util/List;
    ...
    //   52: iflt +67 -> 119
    //   55: aload_0
    //   56: getfield 159	com/flurry/android/monolithic/sdk/impl/fg:c	Ljava/util/List;
    //   59: iload 4
    //   61: invokeinterface 166 2 0
    //   66: checkcast 119	com/flurry/android/monolithic/sdk/impl/ez
    //   69: invokevirtual 169	com/flurry/android/monolithic/sdk/impl/ez:a	()[B
    //   72: astore_2
    //   73: aload_2
    //   74: arraylength
    //   75: istore 5
    ...
    //   88: if_icmple +41 -> 129
    //   91: bipush 6
    //   93: getstatic 23	com/flurry/android/monolithic/sdk/impl/fg:a	Ljava/lang/String;
    ...
    //   116: invokestatic 73	com/flurry/android/monolithic/sdk/impl/ja:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   119: aload_1
    //   120: iconst_0
    //   121: invokevirtual 146	java/io/DataOutputStream:writeShort	(I)V
    //   124: aload_1
    //   125: invokestatic 178	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   128: return
    //   129: aload_1
    //   130: iload 5
    ...
    //   149: astore_2
    //   150: bipush 6
    //   152: getstatic 23	com/flurry/android/monolithic/sdk/impl/fg:a	Ljava/lang/String;
    //   155: ldc -73
    //   157: aload_2
    //   158: invokestatic 186	com/flurry/android/monolithic/sdk/impl/ja:a	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    //   173: astore_2
    //   174: aload_1
    //   175: invokestatic 178	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   178: aload_2
    //   179: athrow
  ...
  public void a(List<ez> paramList)
  {
    this.c = paramList;
  }
    ...
    throws IOException
  {
    ...
    //   7: istore_3
    //   8: iconst_4
    //   9: getstatic 23	com/flurry/android/monolithic/sdk/impl/fg:a	Ljava/lang/String;
    ...
    //   31: invokestatic 73	com/flurry/android/monolithic/sdk/impl/ja:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   34: iload_3
    //   35: ldc -116
    //   37: if_icmpne +18 -> 55
    //   40: aload_0
    //   41: aload_2
    //   42: aload_1
    //   43: invokespecial 196	com/flurry/android/monolithic/sdk/impl/fg:a	(Ljava/lang/String;Ljava/io/DataInputStream;)Z
    //   46: istore 4
    //   48: aload_1
    //   49: invokestatic 178	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   52: iload 4
    //   54: ireturn
    //   55: iconst_3
    //   56: getstatic 23	com/flurry/android/monolithic/sdk/impl/fg:a	Ljava/lang/String;
    //   59: ldc -58
    //   61: invokestatic 73	com/flurry/android/monolithic/sdk/impl/ja:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   64: goto -16 -> 48
    //   67: astore_2
    //   68: bipush 6
    //   70: getstatic 23	com/flurry/android/monolithic/sdk/impl/fg:a	Ljava/lang/String;
    //   73: ldc -56
    //   75: aload_2
    //   76: invokestatic 186	com/flurry/android/monolithic/sdk/impl/ja:a	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    //   91: astore_2
    //   92: aload_1
    //   93: invokestatic 178	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   96: aload_2
    //   97: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/flurry/android/monolithic/sdk/impl/fg.class
