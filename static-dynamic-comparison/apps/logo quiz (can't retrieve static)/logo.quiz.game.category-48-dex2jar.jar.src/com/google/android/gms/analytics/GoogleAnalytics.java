  ...
  extends TrackerHandler
{
  ...
  {
    this(paramContext, s.B(paramContext), q.ea());
  }
  ...
  void a(v paramv)
  {
    ...
    if (paramv.eA()) {
      this.Ax.setLocalDispatchPeriod(paramv.eB());
    }
    if (paramv.eC()) {
      setDryRun(paramv.eD());
    }
  ...
  void u(Map<String, String> paramMap)
  {
    ...
    aj.a(paramMap, "&sr", ad.eR());
    paramMap.put("&_u", t.eq().es());
    t.eq().er();
    this.ye.u(paramMap);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/analytics/GoogleAnalytics.class
