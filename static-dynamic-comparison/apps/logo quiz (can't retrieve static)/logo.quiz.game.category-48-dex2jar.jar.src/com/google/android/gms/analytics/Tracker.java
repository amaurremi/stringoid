...
public class Tracker
{
  ...
  void a(ai paramai)
  {
    ...
    if (this.Bt.fc())
    {
      paramai = Double.toString(this.Bt.fd());
      set("&sf", paramai);
  ...
  public void send(Map<String, String> paramMap)
  {
    ...
    if ((!paramMap.equals("transaction")) && (!paramMap.equals("item")) && (!this.Bn.eK()))
    {
    ...
    implements GoogleAnalytics.a
  {
    ...
    private void eX()
    {
      GoogleAnalytics localGoogleAnalytics = GoogleAnalytics.eE();
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/analytics/Tracker.class
