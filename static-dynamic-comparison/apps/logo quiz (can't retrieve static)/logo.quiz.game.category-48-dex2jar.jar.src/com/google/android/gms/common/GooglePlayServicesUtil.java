...
public final class GooglePlayServicesUtil
{
  ...
  private static Dialog a(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    for (Object localObject1 = new AlertDialog.Builder(paramActivity, 5);; localObject1 = null)
    {
      ...
      for (paramFragment = new com.google.android.gms.common.internal.b(paramActivity, paramOnCancelListener, paramInt2);; paramFragment = new com.google.android.gms.common.internal.b(paramFragment, paramOnCancelListener, paramInt2))
      {
  ...
  private static byte[] a(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (paramPackageInfo = b.fZ(); paramPackageInfo.contains(arrayOfByte); paramPackageInfo = b.ga()) {
      return arrayOfByte;
    }
  ...
  public static boolean b(PackageManager paramPackageManager)
  {
    synchronized (Ig)
    {
      ...
      try
      {
        if (a(paramPackageManager.getPackageInfo("com.google.android.gms", 64), new byte[][] { b.HZ[1] }) != null) {}
        for (If = 1; If != 0; If = 0) {
          return true;
        }
      }
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          ...
          i = 0;
          if (a(localPackageInfo1, new byte[][] { b.HH[i], b.HM[i] }) != null) {
            break;
          }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/common/GooglePlayServicesUtil.class
