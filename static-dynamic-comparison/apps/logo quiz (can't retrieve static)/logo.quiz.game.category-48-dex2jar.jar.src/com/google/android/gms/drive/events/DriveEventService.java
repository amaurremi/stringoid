  ...
  implements ChangeListener, CompletionListener
{
          ...
          if (this.NO == null)
          {
            ...
            new Thread()
            {
              public void run()
              {
                ...
                {
                  Looper.prepare();
                  DriveEventService.this.NO = new DriveEventService.a(DriveEventService.this);
  ...
  public void onDestroy()
  {
    ...
    //   9: aload_0
    //   10: getfield 160	com/google/android/gms/drive/events/DriveEventService:NO	Lcom/google/android/gms/drive/events/DriveEventService$a;
    //   13: ifnull +44 -> 57
    //   16: aload_0
    //   17: getfield 160	com/google/android/gms/drive/events/DriveEventService:NO	Lcom/google/android/gms/drive/events/DriveEventService$a;
    ...
    //   23: astore_1
    //   24: aload_0
    //   25: getfield 160	com/google/android/gms/drive/events/DriveEventService:NO	Lcom/google/android/gms/drive/events/DriveEventService$a;
    //   28: aload_1
    //   29: invokevirtual 209	com/google/android/gms/drive/events/DriveEventService$a:sendMessage	(Landroid/os/Message;)Z
    //   32: pop
    //   33: aload_0
    //   34: aconst_null
    //   35: putfield 160	com/google/android/gms/drive/events/DriveEventService:NO	Lcom/google/android/gms/drive/events/DriveEventService$a;
    //   38: aload_0
    //   39: getfield 113	com/google/android/gms/drive/events/DriveEventService:NN	Ljava/util/concurrent/CountDownLatch;
    //   42: ldc2_w 172
    ...
    //   52: aload_0
    //   53: aconst_null
    //   54: putfield 113	com/google/android/gms/drive/events/DriveEventService:NN	Ljava/util/concurrent/CountDownLatch;
    //   57: aload_0
    ...
    extends ad.a
  {
      ...
      throws RemoteException
    {
      synchronized (DriveEventService.this)
      {
        ...
        paramOnEventResponse = DriveEventService.a.a(DriveEventService.this.NO, paramOnEventResponse);
        DriveEventService.this.NO.sendMessage(paramOnEventResponse);
        return;
      }
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/drive/events/DriveEventService.class
