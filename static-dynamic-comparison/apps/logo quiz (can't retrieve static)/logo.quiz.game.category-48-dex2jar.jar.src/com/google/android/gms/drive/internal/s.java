  ...
  implements DriveFile
{
  ...
  public PendingResult<DriveApi.DriveContentsResult> open(GoogleApiClient paramGoogleApiClient, final int paramInt, DriveFile.DownloadProgressListener paramDownloadProgressListener)
  {
    ...
    paramGoogleApiClient.a(new o.d()
    {
      ...
      {
        paramAnonymousq.hY().a(new OpenContentsRequest(s.this.getDriveId(), paramInt, 0), new av(this, this.OG));
      }
    });
  }
  ...
  public PendingResult<DriveApi.ContentsResult> openContents(GoogleApiClient paramGoogleApiClient, final int paramInt, DriveFile.DownloadProgressListener paramDownloadProgressListener)
  {
    ...
    paramGoogleApiClient.a(new o.b()
    {
      protected void a(q paramAnonymousq)
        throws RemoteException
      {
        paramAnonymousq.hY().a(new OpenContentsRequest(s.this.getDriveId(), paramInt, 0), new s.b(this, this.OG));
      }
    });
  }
    ...
    implements DriveFile.DownloadProgressListener
  {
    ...
    public void onProgress(final long paramLong1, long paramLong2)
    {
      this.OI.a(new c.b()
      {
        ...
        {
          paramAnonymousDownloadProgressListener.onProgress(paramLong1, this.OK);
        }
    ...
    extends c
  {
    ...
    {
      this.De = paramb;
      this.OM = paramDownloadProgressListener;
    }
      ...
      throws RemoteException
    {
      ...
      for (Status localStatus = new Status(-1);; localStatus = Status.Jo)
      {
    ...
    {
      if (this.OM != null) {
        this.OM.onProgress(paramOnDownloadProgressResponse.jdMethod_if(), paramOnDownloadProgressResponse.ig());
      }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/drive/internal/s.class
