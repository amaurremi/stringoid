  ...
  implements Parcelable.Creator<DataPoint>
{
  static void a(DataPoint paramDataPoint, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 4, paramDataPoint.getStartTimeNanos());
    b.a(paramParcel, 5, paramDataPoint.iC(), paramInt, false);
    b.a(paramParcel, 6, paramDataPoint.getOriginalDataSource(), paramInt, false);
    b.a(paramParcel, 7, paramDataPoint.iD());
    b.a(paramParcel, 8, paramDataPoint.iE());
    b.H(paramParcel, i);
  }
  ...
  public DataPoint[] cC(int paramInt)
  {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/data/e.class
