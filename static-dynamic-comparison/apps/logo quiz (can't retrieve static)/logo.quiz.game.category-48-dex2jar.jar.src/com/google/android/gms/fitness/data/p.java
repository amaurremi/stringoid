  ...
  implements Parcelable.Creator<Session>
{
  static void a(Session paramSession, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramSession.getStartTimeMillis());
    b.c(paramParcel, 1000, paramSession.getVersionCode());
    b.a(paramParcel, 2, paramSession.getEndTimeMillis());
    ...
    b.c(paramParcel, 7, paramSession.getActivity());
    b.a(paramParcel, 8, paramSession.iH(), paramInt, false);
    b.H(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/data/p.class
