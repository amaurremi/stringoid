  ...
  implements Parcelable.Creator<SessionReadRequest>
{
  static void a(SessionReadRequest paramSessionReadRequest, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramSessionReadRequest.ju(), false);
    b.c(paramParcel, 1000, paramSessionReadRequest.getVersionCode());
    b.a(paramParcel, 2, paramSessionReadRequest.getSessionId(), false);
    b.a(paramParcel, 3, paramSessionReadRequest.getStartTimeMillis());
    b.a(paramParcel, 4, paramSessionReadRequest.getEndTimeMillis());
    ...
    b.a(paramParcel, 7, paramSessionReadRequest.jv());
    b.a(paramParcel, 8, paramSessionReadRequest.jg());
    b.b(paramParcel, 9, paramSessionReadRequest.jw(), false);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/request/s.class
