  ...
  implements Parcelable.Creator<ExtendedGameEntity>
{
  static void a(ExtendedGameEntity paramExtendedGameEntity, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramExtendedGameEntity.kY(), paramInt, false);
    b.c(paramParcel, 1000, paramExtendedGameEntity.getVersionCode());
    b.c(paramParcel, 2, paramExtendedGameEntity.kP());
    b.a(paramParcel, 3, paramExtendedGameEntity.kQ());
    b.c(paramParcel, 4, paramExtendedGameEntity.kR());
    b.a(paramParcel, 5, paramExtendedGameEntity.kS());
    b.a(paramParcel, 6, paramExtendedGameEntity.kT());
    b.a(paramParcel, 7, paramExtendedGameEntity.kU(), false);
    b.a(paramParcel, 8, paramExtendedGameEntity.kV());
    b.a(paramParcel, 9, paramExtendedGameEntity.kW(), false);
    b.c(paramParcel, 10, paramExtendedGameEntity.kO(), false);
    b.a(paramParcel, 11, paramExtendedGameEntity.kX(), paramInt, false);
    b.H(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/games/internal/game/ExtendedGameEntityCreator.class
