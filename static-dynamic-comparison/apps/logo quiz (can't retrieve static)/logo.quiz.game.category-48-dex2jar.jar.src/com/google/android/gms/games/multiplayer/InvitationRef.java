  ...
  implements Invitation
{
  ...
  InvitationRef(DataHolder paramDataHolder, int paramInt1, int paramInt2)
  {
    ...
    this.abR = new ArrayList(paramInt2);
    String str = getString("external_inviter_id");
    paramInt1 = 0;
    paramDataHolder = null;
    while (paramInt1 < paramInt2)
    {
      ParticipantRef localParticipantRef = new ParticipantRef(this.IC, this.JQ + paramInt1);
      if (localParticipantRef.getParticipantId().equals(str)) {
        paramDataHolder = localParticipantRef;
      }
      this.abR.add(localParticipantRef);
      paramInt1 += 1;
    }
    this.abU = ((ParticipantRef)n.b(paramDataHolder, "Must have a valid inviter!"));
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/games/multiplayer/InvitationRef.class
