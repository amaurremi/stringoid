  ...
  implements TurnBasedMatch
{
  ...
  public ArrayList<Participant> getParticipants()
  {
    ...
    while (i < this.aaz)
    {
      localArrayList.add(new ParticipantRef(this.IC, this.JQ + i));
      i += 1;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/games/multiplayer/turnbased/TurnBasedMatchRef.class
