  ...
  implements GameRequest
{
  ...
  {
    int i = this.JQ;
    while (i < this.JQ + this.aaz)
    {
      int j = this.IC.ar(i);
      if (this.IC.c("recipient_external_player_id", i, j).equals(paramString)) {
        return this.IC.b("recipient_status", i, j);
      }
      i += 1;
    }
    return -1;
  ...
  public List<Player> getRecipients()
  {
    ...
    while (i < this.aaz)
    {
      localArrayList.add(new PlayerRef(this.IC, this.JQ + i, "recipient_"));
      i += 1;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/games/request/GameRequestRef.class
