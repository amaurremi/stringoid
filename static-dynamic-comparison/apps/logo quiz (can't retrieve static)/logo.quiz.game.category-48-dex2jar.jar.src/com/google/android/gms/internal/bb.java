...
public final class bb
{
  ...
  public bb(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (this.oj = q(paramAttributeSet);; this.oj = q(str))
    {
      this.ok = paramContext.getString(R.styleable.AdsAttrs_adUnitId);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/bb.class
