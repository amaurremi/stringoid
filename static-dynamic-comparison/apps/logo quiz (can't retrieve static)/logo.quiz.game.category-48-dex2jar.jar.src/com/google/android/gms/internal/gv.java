  ...
  implements DownloadListener
{
  ...
  public void b(String paramString, JSONObject paramJSONObject)
  {
    ...
    ((StringBuilder)localObject).append(paramJSONObject);
    ((StringBuilder)localObject).append(");");
    gs.V("Dispatching AFMA event: " + localObject);
    X(((StringBuilder)localObject).toString());
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/gv.class
