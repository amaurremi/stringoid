  ...
  implements SafeParcelable
{
  ...
  {
    this(1, a(paramString1, paramIntent), System.currentTimeMillis(), 0, null, a(paramIntent, paramString2, paramUri, paramString3, paramList).fk());
  }
  ...
  {
    return new hi(paramString, new hq.a("title").P(1).F(true).au("name").fn(), "text1");
  }
  
  private static hi b(List<AppIndexApi.AppIndexingLink> paramList)
  {
    lk.a locala = new lk.a();
    lk.a.a[] arrayOfa = new lk.a.a[paramList.size()];
    int i = 0;
    while (i < arrayOfa.length)
    {
      arrayOfa[i] = new lk.a.a();
      AppIndexApi.AppIndexingLink localAppIndexingLink = (AppIndexApi.AppIndexingLink)paramList.get(i);
      arrayOfa[i].adv = localAppIndexingLink.appIndexingUrl.toString();
      arrayOfa[i].adw = localAppIndexingLink.webUrl.toString();
      arrayOfa[i].viewId = localAppIndexingLink.viewId;
      i += 1;
    }
    locala.adt = arrayOfa;
    return new hi(pm.f(locala), new hq.a("outlinks").E(true).au(".private:outLinks").at("blob").fn());
  }
  
  private static hi f(Uri paramUri)
  {
    return new hi(paramUri.toString(), new hq.a("web_url").P(4).E(true).au("url").fn());
  }
  ...
  {
    return new hi(paramString2, new hq.a(paramString1).E(true).fn(), paramString1);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/hs.class
