  ...
  extends d<in>
{
    ...
    throws RemoteException
  {
    ...
    this.Gw = new c(null);
    paramk.a(parame, 6111000, getContext().getPackageName(), this.Gw.asBinder(), localBundle);
  }
    ...
    extends io.a
  {
    ...
    {
      ij.fI().b("Deprecated callback: \"onStatusreceived\"", new Object[0]);
    }
    ...
    public void ac(int paramInt)
    {
      ...
      {
        return;
        ij.fI().b("ICastDeviceControllerListener.onDisconnected: %d", new Object[] { Integer.valueOf(paramInt) });
      } while (paramInt == 0);
      ij.this.aA(2);
    }
    ...
    public void b(final ig paramig)
    {
      ...
      ij.fI().b("onApplicationStatusChanged", new Object[0]);
    ...
    public void b(final il paramil)
    {
      ...
      ij.fI().b("onDeviceStatusChanged", new Object[0]);
      ij.f(ij.this).post(new Runnable()
      {
        public void run()
        {
    ...
    public void b(String paramString, byte[] paramArrayOfByte)
    {
      ...
      ij.fI().b("IGNORING: Receive (type=binary, ns=%s) <%d bytes>", new Object[] { paramString, Integer.valueOf(paramArrayOfByte.length) });
    }
    ...
    public void k(final String paramString1, final String paramString2)
    {
      ...
      ij.fI().b("Receive (type=text, ns=%s) %s", new Object[] { paramString1, paramString2 });
      ij.f(ij.this).post(new Runnable()
      {
        public void run()
        {
          ...
          ij.fI().b("Discarded message for unknown namespace '%s'", new Object[] { paramString1 });
        }
      });
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/ij.class
