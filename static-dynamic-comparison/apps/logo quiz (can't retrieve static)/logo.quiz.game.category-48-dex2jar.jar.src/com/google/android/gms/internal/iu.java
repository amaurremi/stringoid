  ...
  public static void a(JSONObject paramJSONObject, List<WebImage> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext()) {
        localJSONArray.put(((WebImage)paramList.next()).bL());
      }
    }
    try
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/iu.class
