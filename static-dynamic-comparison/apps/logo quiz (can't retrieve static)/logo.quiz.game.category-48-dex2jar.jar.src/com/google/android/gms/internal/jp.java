  ...
  implements SafeParcelable
{
  ...
  {
    this.BR = paramInt;
    this.MF = ((Parcel)n.i(paramParcel));
    this.MG = 2;
    this.My = paramjm;
    if (this.My == null) {}
    for (this.mClassName = null;; this.mClassName = this.My.hv())
    {
      this.MH = 2;
      return;
    }
  ...
  private jp(SafeParcelable paramSafeParcelable, jm paramjm, String paramString)
  {
    ...
    paramSafeParcelable.writeToParcel(this.MF, 0);
    this.MG = 1;
    this.My = ((jm)n.i(paramjm));
    this.mClassName = ((String)n.i(paramString));
    this.MH = 2;
  }
  ...
  public String toString()
  {
    ...
    a(localStringBuilder, this.My.be(this.mClassName), localParcel);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/jp.class
