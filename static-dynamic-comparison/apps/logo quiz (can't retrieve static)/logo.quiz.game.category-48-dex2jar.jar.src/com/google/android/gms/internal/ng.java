    ...
    implements ng
  {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        ...
        for (paramParcel2 = nl.CREATOR.cY(paramParcel1);; paramParcel2 = null)
        {
          if (paramParcel1.readInt() != 0) {
            localObject1 = nh.CREATOR.cX(paramParcel1);
          }
          a(str, paramParcel2, (nh)localObject1);
          return true;
        }
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.playlog.internal.IPlayLogService");
        ...
        paramParcel2 = str;
        if (paramParcel1.readInt() != 0) {
          paramParcel2 = nl.CREATOR.cY(paramParcel1);
        }
        a((String)localObject1, paramParcel2, paramParcel1.createTypedArrayList(nh.CREATOR));
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.playlog.internal.IPlayLogService");
      localObject1 = paramParcel1.readString();
      ...
      implements ng
    {
      ...
      public void a(String paramString, nl paramnl, nh paramnh)
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramnl != null)
            {
              ...
              paramnl.writeToParcel(localParcel, 0);
              if (paramnh != null)
              {
                localParcel.writeInt(1);
                paramnh.writeToParcel(localParcel, 0);
      ...
      /* Error */
      public void a(String paramString, nl paramnl, List<nh> paramList)
        throws RemoteException
      {
        // Byte code:
        ...
        //   29: aload 4
        //   31: iconst_0
        //   32: invokevirtual 47	com/google/android/gms/internal/nl:writeToParcel	(Landroid/os/Parcel;I)V
        //   35: aload 4
        //   37: aload_3
        //   38: invokevirtual 65	android/os/Parcel:writeTypedList	(Ljava/util/List;)V
        //   41: aload_0
        //   42: getfield 18	com/google/android/gms/internal/ng$a$a:lb	Landroid/os/IBinder;
        //   45: iconst_3
        //   46: aload 4
        //   48: aconst_null
        //   49: iconst_1
      ...
      /* Error */
      public void a(String paramString, nl paramnl, byte[] paramArrayOfByte)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 28	android/os/Parcel:obtain	()Landroid/os/Parcel;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/ng.class
