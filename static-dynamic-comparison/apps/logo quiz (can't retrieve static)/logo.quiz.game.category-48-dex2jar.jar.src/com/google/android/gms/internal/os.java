  ...
  extends IInterface
{
  ...
  public static abstract class a
    ...
    implements os
  {
    public static os bL(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        {
          a(paramParcel2, (Bundle)localObject, ov.a.bO(paramParcel1.readStrongBinder()));
          return true;
          paramParcel2 = null;
          break;
        }
      ...
      case 3: 
        ...
        {
          a((String)localObject, str, paramParcel2, ov.a.bO(paramParcel1.readStrongBinder()));
          return true;
        }
      case 4: 
        paramParcel1.enforceInterface("com.google.android.gms.wallet.internal.IOwService");
      ...
      case 5: 
        ...
        for (paramParcel2 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; paramParcel2 = null)
        {
          a(paramParcel2, ov.a.bO(paramParcel1.readStrongBinder()));
          return true;
        }
      case 6: 
        paramParcel1.enforceInterface("com.google.android.gms.wallet.internal.IOwService");
      ...
      case 7: 
        ...
        for (localObject = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject = null)
        {
          a(paramParcel2, (Bundle)localObject, ou.a.bN(paramParcel1.readStrongBinder()));
          return true;
          paramParcel2 = null;
          break;
        }
      case 8: 
        ...
        if (paramParcel1.readInt() != 0)
        {
          paramParcel2 = (om)om.CREATOR.createFromParcel(paramParcel1);
          if (paramParcel1.readInt() == 0) {
            break label644;
          }
        }
      ...
      implements os
    {
      ...
      /* Error */
      public void a(Bundle paramBundle, ov paramov)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
        ...
        //   50: aload_0
        //   51: getfield 18	com/google/android/gms/internal/os$a$a:lb	Landroid/os/IBinder;
        //   54: iconst_5
        //   55: aload 4
        //   57: aconst_null
        //   58: iconst_1
      ...
      public void a(om paramom, Bundle paramBundle, ov paramov)
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramom != null)
            {
              ...
              paramom.writeToParcel(localParcel, 0);
              if (paramBundle != null)
              {
                localParcel.writeInt(1);
                paramBundle.writeToParcel(localParcel, 0);
                paramom = (om)localObject;
                if (paramov != null) {
                  paramom = paramov.asBinder();
                }
                localParcel.writeStrongBinder(paramom);
      ...
      public void a(FullWalletRequest paramFullWalletRequest, Bundle paramBundle, ov paramov)
        throws RemoteException
      {
        Object localObject = null;
        Parcel localParcel = Parcel.obtain();
          ...
          try
          {
            ...
            if (paramFullWalletRequest != null)
            {
              ...
              if (paramBundle != null)
              {
                ...
                if (paramov != null) {
                  paramFullWalletRequest = paramov.asBinder();
                }
      ...
      public void a(MaskedWalletRequest paramMaskedWalletRequest, Bundle paramBundle, ou paramou)
        throws RemoteException
      {
        Object localObject = null;
        Parcel localParcel = Parcel.obtain();
          ...
          try
          {
            ...
            if (paramMaskedWalletRequest != null)
            {
              ...
              if (paramBundle != null)
              {
                ...
                if (paramou != null) {
                  paramMaskedWalletRequest = paramou.asBinder();
                }
      ...
      public void a(d paramd, Bundle paramBundle, ov paramov)
        throws RemoteException
      {
        Object localObject = null;
        Parcel localParcel = Parcel.obtain();
      ...
      /* Error */
      public void a(String paramString1, String paramString2, Bundle paramBundle, ov paramov)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
        ...
        //   66: aload_0
        //   67: getfield 18	com/google/android/gms/internal/os$a$a:lb	Landroid/os/IBinder;
        //   70: iconst_3
        //   71: aload 6
        //   73: aconst_null
        //   74: iconst_1
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/os$a$a:lb	Landroid/os/IBinder;
        //   29: bipush 9
        //   31: aload_2
        //   32: aconst_null
        //   33: iconst_1
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/os.class
