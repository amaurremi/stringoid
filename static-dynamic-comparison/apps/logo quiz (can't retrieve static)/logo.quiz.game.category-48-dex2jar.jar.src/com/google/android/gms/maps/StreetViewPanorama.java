...
public class StreetViewPanorama
{
  ...
  public Point orientationToPoint(StreetViewPanoramaOrientation paramStreetViewPanoramaOrientation)
  {
    try
    {
      paramStreetViewPanoramaOrientation = this.aiQ.orientationToPoint(paramStreetViewPanoramaOrientation);
  ...
  public StreetViewPanoramaOrientation pointToOrientation(Point paramPoint)
  {
    try
    {
      paramPoint = this.aiQ.pointToOrientation(e.k(paramPoint));
      return paramPoint;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/maps/StreetViewPanorama.class
