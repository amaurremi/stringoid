  ...
  implements at
{
  ...
  private SQLiteDatabase al(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.apL.getWritableDatabase();
  ...
  public List<ap> G(int paramInt)
  {
    ...
    //   421: invokevirtual 313	com/google/android/gms/tagmanager/ap:eH	()J
    ...
    //   538: astore 5
    //   540: aload 8
    //   542: invokevirtual 331	com/google/android/gms/tagmanager/ap:os	()Ljava/lang/String;
  ...
  int eO()
  {
    ...
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(this.yD.currentTimeMillis() - 2592000000L) });
    Object localObject = this.apN;
    if (eP() == 0) {}
    for (;;)
    {
    ...
    implements db.a
  {
    ...
    {
      cb.a(cb.this, paramap.eH());
    }
    
    public void b(ap paramap)
    {
      cb.a(cb.this, paramap.eH());
      bh.V("Permanent failure dispatching hitId: " + paramap.eH());
    }
    ...
    public void c(ap paramap)
    {
      long l = paramap.or();
      if (l == 0L) {
        cb.a(cb.this, paramap.eH(), cb.a(cb.this).currentTimeMillis());
      }
      while (l + 14400000L >= cb.a(cb.this).currentTimeMillis()) {
        return;
      }
      cb.a(cb.this, paramap.eH());
      bh.V("Giving up on failed hitId: " + paramap.eH());
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/tagmanager/cb.class
