  ...
  extends dg
{
  ...
  private static final String arS = b.bj.toString();
  private static final String arT = b.bs.toString();
  private static final String arU = b.cE.toString();
  private static final String arV = b.cz.toString();
  private static final String arW = b.cy.toString();
  private static final String arX = b.br.toString();
  private static final String arY = b.eN.toString();
  private static final String arZ = b.eQ.toString();
  private static final String asa = b.eS.toString();
  private static final List<String> asb = Arrays.asList(new String[] { "detail", "checkout", "checkout_option", "click", "add", "remove", "purchase", "refund" });
  ...
  private void a(Tracker paramTracker, Map<String, d.a> paramMap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = p((d.a)paramMap.get(arX));
        ((Map)localObject1).put("&t", "transaction");
        localObject2 = O(paramMap).entrySet().iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (Map.Entry)((Iterator)localObject2).next();
          b((Map)localObject1, (String)((Map.Entry)localObject3).getValue(), cZ((String)((Map.Entry)localObject3).getKey()));
        }
      ...
      Object localObject1 = da("transactionProducts");
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          localObject3 = p((d.a)paramMap.get(arX));
  ...
  private void b(Tracker paramTracker, Map<String, d.a> paramMap)
  {
    ...
    Object localObject1 = p((d.a)paramMap.get(arX));
    localScreenViewBuilder.setAll((Map)localObject1);
    if (f(paramMap, arV))
    {
      paramMap = this.anS.get("ecommerce");
    ...
    for (;;)
    {
        ...
        if ((localObject1 instanceof List))
        {
          ...
          for (;;)
          {
            if (((Iterator)localObject1).hasNext())
            {
              ...
              continue;
              paramMap = di.o((d.a)paramMap.get(arW));
              if (!(paramMap instanceof Map)) {
                break label717;
              }
              paramMap = (Map)paramMap;
      ...
      for (;;)
      {
        ...
        for (int i = 0;; i = 1)
        {
          ...
          Iterator localIterator = asb.iterator();
          do
          {
  ...
  private String cZ(String paramString)
  {
    paramString = this.anS.get(paramString);
    if (paramString == null) {
      return null;
    }
  ...
  private List<Map<String, String>> da(String paramString)
  {
    paramString = this.anS.get(paramString);
    if (paramString == null) {
      return null;
  ...
  {
    Tracker localTracker = this.asf.cR("_GTM_DEFAULT_TRACKER_");
    if (f(paramMap, arU))
    {
    ...
    if (f(paramMap, arT))
    {
      localTracker.send(p((d.a)paramMap.get(arX)));
      return;
    }
    if (f(paramMap, arY))
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/tagmanager/dj.class
