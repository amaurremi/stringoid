  ...
  implements Parcelable.Creator<LoyaltyWalletObject>
{
  static void a(LoyaltyWalletObject paramLoyaltyWalletObject, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 3, paramLoyaltyWalletObject.asI, false);
    b.a(paramParcel, 4, paramLoyaltyWalletObject.asJ, false);
    b.a(paramParcel, 5, paramLoyaltyWalletObject.asK, false);
    b.a(paramParcel, 6, paramLoyaltyWalletObject.Dv, false);
    b.a(paramParcel, 7, paramLoyaltyWalletObject.asL, false);
    b.a(paramParcel, 8, paramLoyaltyWalletObject.asM, false);
    b.a(paramParcel, 9, paramLoyaltyWalletObject.asN, false);
    b.a(paramParcel, 10, paramLoyaltyWalletObject.asO, false);
    b.a(paramParcel, 11, paramLoyaltyWalletObject.asP, false);
    b.c(paramParcel, 12, paramLoyaltyWalletObject.state);
    b.c(paramParcel, 13, paramLoyaltyWalletObject.asQ, false);
    b.a(paramParcel, 14, paramLoyaltyWalletObject.asR, paramInt, false);
    b.c(paramParcel, 15, paramLoyaltyWalletObject.asS, false);
    b.a(paramParcel, 17, paramLoyaltyWalletObject.asU, false);
    b.a(paramParcel, 16, paramLoyaltyWalletObject.asT, false);
    b.a(paramParcel, 19, paramLoyaltyWalletObject.asW);
    b.c(paramParcel, 18, paramLoyaltyWalletObject.asV, false);
    b.c(paramParcel, 21, paramLoyaltyWalletObject.asY, false);
    b.c(paramParcel, 20, paramLoyaltyWalletObject.asX, false);
    b.a(paramParcel, 23, paramLoyaltyWalletObject.ata, paramInt, false);
    b.c(paramParcel, 22, paramLoyaltyWalletObject.asZ, false);
    b.H(paramParcel, i);
  }
  ...
  public LoyaltyWalletObject[] fv(int paramInt)
  {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/wallet/j.class
