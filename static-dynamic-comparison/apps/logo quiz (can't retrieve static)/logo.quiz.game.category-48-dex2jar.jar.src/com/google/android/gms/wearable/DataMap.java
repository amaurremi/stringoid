...
public class DataMap
{
  ...
  public static DataMap fromByteArray(byte[] paramArrayOfByte)
  {
    try
    {
      paramArrayOfByte = pb.a(new pb.a(pc.n(paramArrayOfByte), new ArrayList()));
  ...
  {
    return (T)this.auL.get(paramString);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/wearable/DataMap.class
