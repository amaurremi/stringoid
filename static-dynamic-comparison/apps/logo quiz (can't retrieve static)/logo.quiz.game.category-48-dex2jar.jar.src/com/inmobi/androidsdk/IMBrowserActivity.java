  ...
  extends Activity
{
      ...
      catch (Exception localException)
      {
        ...
        for (;;)
        {
          ...
          while (paramString1 != null)
          {
            ...
            {
              Log.internal("IMRE_3.7.1", "UTF-8 encoding not supported? What sorcery is this?", paramString1);
            }
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    catch (Exception paramIntent)
    {
      for (;;)
      {
        Log.internal("IMRE_3.7.1", "onActivityResult failed", paramIntent);
      }
    }
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    Log.debug("IMRE_3.7.1", "IMBrowserActivity-> onCreate");
  ...
  protected void onDestroy()
  {
    ...
    {
      Log.debug("IMRE_3.7.1", "Exception in onDestroy ", localException);
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/androidsdk/IMBrowserActivity.class
