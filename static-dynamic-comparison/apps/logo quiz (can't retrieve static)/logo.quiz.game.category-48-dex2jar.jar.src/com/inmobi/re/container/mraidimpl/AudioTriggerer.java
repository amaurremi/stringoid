...
public class AudioTriggerer
{
  ...
  private static void a(double paramDouble)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        Log.internal("IMRE_3.7.1", "AudioTriggerer: One of the mic listeners has a problem.");
      }
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/re/container/mraidimpl/AudioTriggerer.class
