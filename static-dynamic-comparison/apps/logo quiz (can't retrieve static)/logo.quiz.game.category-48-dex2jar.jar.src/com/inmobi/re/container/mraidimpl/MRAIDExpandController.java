...
public class MRAIDExpandController
{
  ...
  private FrameLayout a(JSController.ExpandProperties paramExpandProperties)
  {
    ...
    localFrameLayout2.setOnTouchListener(new a());
    ...
    for (;;)
    {
      ...
      catch (Exception ???)
      {
        synchronized (this.a.mutex)
        {
          ...
          continue;
          ??? = ???;
          Log.debug("IMRE_3.7.1", "Exception in doexpand ", ???);
          this.a.setState(IMWebView.ViewState.DEFAULT);
          synchronized (this.a.mutex)
          {
            this.a.isMutexAquired.set(false);
  ...
  public void handleOrientationFor2Piece()
  {
    ...
    {
      Log.internal("IMRE_3.7.1", "IMWebview Handle orientation for 2 piece ", localException);
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/re/container/mraidimpl/MRAIDExpandController.class
