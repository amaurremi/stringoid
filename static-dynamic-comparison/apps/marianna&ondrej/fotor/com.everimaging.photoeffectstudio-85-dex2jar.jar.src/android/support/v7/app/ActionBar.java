...
public abstract class ActionBar {
    ...
    public abstract void setSubtitle(@Nullable CharSequence paramCharSequence);
    ...
    private static @interface DisplayOptions {
    }
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({0L, 1L, 2L})
    private static @interface NavigationMode {
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/android/support/v7/app/ActionBar.class
