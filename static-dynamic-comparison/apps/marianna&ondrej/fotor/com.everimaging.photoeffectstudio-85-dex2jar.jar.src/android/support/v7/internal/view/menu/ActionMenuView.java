...
public class ActionMenuView
    ...
    private void onMeasureExactFormat(int paramInt1, int paramInt2) {
        ...
        int i9;
        for (int i3 = View.MeasureSpec.makeMeasureSpec(i7 - i5, 1073741824); ; i3 = View.MeasureSpec.makeMeasureSpec(Math.min(this.mMaxItemHeight, i7 - i5), Integer.MIN_VALUE)) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/android/support/v7/internal/view/menu/ActionMenuView.class
