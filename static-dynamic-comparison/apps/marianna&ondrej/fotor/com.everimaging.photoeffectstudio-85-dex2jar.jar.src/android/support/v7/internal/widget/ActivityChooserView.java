...
public class ActivityChooserView
    ...
    public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.ActivityChooserView, paramInt, 0);
            ...
            switch (getItemViewType(paramInt)) {
                ...
                case 1:
                    if (paramView != null) {
                        ...
                        localObject = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abc_activity_chooser_view_list_item, paramViewGroup, false);
                        ((View) localObject).setId(1);
                        ((TextView) ((View) localObject).findViewById(R.id.title)).setText(ActivityChooserView.this.getContext().getString(R.string.abc_activity_chooser_view_see_all));
                    }
                    break;
            }
            View localView;
            do {
                do {
                    do {
                        ...
                        ((TextView) localView.findViewById(R.id.title)).setText(((ResolveInfo) localObject).loadLabel(paramView));
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/android/support/v7/internal/widget/ActivityChooserView.class
