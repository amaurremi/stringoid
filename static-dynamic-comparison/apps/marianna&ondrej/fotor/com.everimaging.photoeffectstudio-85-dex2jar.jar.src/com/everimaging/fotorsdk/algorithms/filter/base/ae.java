...
public class ae
        extends a<d> {
    public ae(RSBaseParams paramRSBaseParams) {
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        float f = ((RSShadowsBaseFilterParams) b()).getShadows();
        ...
        for (; ; ) {
            ...
            paramRenderScript.aS(localAllocation, paramContext);
            if (this.a != null) {
                this.a.b();
            }
            return paramContext;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/base/ae.class
