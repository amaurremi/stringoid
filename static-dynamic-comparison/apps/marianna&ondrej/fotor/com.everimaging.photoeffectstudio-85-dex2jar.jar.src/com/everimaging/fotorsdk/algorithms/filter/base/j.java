...
public class j
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        for (; ; ) {
            ...
            paramRenderScript.k(localAllocation, paramContext);
            if (this.a != null) {
                this.a.b();
            }
            return paramContext;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/base/j.class
