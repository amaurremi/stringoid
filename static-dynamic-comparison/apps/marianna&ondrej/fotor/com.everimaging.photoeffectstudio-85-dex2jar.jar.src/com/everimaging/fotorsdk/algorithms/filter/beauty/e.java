...
import com.everimaging.fotorsdk.algorithms.params.beauty.EyeTintParams;
...
public class e
    ...
    protected Allocation c(Context paramContext, RenderScript paramRenderScript) {
        ...
        EyeTintParams localEyeTintParams = (EyeTintParams) b();
        ...
        float f1 = localEyeTintParams.getRed();
        float f2 = localEyeTintParams.getGreen();
        float f3 = localEyeTintParams.getBlue();
        locald.t(f1);
        locald.v(f2);
        locald.x(f3);
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/filter/beauty/e.class
