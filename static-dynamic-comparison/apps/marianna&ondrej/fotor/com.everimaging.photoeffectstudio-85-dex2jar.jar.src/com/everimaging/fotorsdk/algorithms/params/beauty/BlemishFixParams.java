...
public class BlemishFixParams
    ...
    public BlemishFixParams() {
        super(BaseParams.ParamsType.BLEMISH_FIX);
    }
    ...
    public void parseFromJsonStr(String paramString) {
        paramString = (BlemishFixParams) new GsonBuilder().create().fromJson(paramString, getClass());
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/everimaging/fotorsdk/algorithms/params/beauty/BlemishFixParams.class
