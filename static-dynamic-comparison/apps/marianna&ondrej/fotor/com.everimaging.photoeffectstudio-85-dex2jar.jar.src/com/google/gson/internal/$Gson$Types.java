...
public final class $Gson$Types {
    ...
    public static Type canonicalize(Type paramType) {
        ...
        if ((paramType instanceof Class)) {
            ...
            if (paramType.isArray()) {
                localObject = new GenericArrayTypeImpl(canonicalize(paramType.getComponentType()));
            }
        }
        do {
    ...
    private static final class ParameterizedTypeImpl
        ...
        public int hashCode() {
            ...
            Gson.Types.hashCodeOrZero(this.ownerType);
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/fotor/com.everimaging.photoeffectstudio-85-dex2jar.jar!/com/google/gson/internal/$Gson$Types.class
