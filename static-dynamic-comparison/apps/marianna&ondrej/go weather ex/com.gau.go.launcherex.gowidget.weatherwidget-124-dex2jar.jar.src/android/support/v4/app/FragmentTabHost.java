  ...
  private FragmentTransaction doTabChanged(String paramString, FragmentTransaction paramFragmentTransaction)
  {
    ...
    if (this.mLastTab != localObject)
    {
      ...
      if (localObject != null)
      {
        ...
        ((TabInfo)localObject).fragment = Fragment.instantiate(this.mContext, ((TabInfo)localObject).clss.getName(), ((TabInfo)localObject).args);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/app/FragmentTabHost.class
