      ...
      for (;;)
      {
        ...
        else
        {
          if (c == ' ') {
            for (;;)
            {
              if ((paramInt1 + 1 >= paramInt2) || (paramCharSequence.charAt(paramInt1 + 1) != ' '))
              {
                paramStringBuilder.append(' ');
                break;
              }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/app/ShareCompat.class
