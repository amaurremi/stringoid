  ...
  implements RemoteControlClient.OnGetPlaybackPositionListener, RemoteControlClient.OnPlaybackPositionUpdateListener
{
  ...
  public void refreshState(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      localRemoteControlClient.setPlaybackState(i, paramLong, j);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/media/TransportMediatorJellybeanMR2.class
