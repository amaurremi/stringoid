...
public class ViewDragHelper
{
  ...
  public boolean checkTouchSlop(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      return true;
    } while ((paramInt1 == 0) || (Math.abs(f2) <= this.mTouchSlop));
    return true;
  }
  ...
  public View findTopChildUnder(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        if ((paramInt1 < localView.getLeft()) || (paramInt1 >= localView.getRight()) || (paramInt2 < localView.getTop())) {
          break;
        }
  ...
  public void processTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 6: 
      ...
      for (i = j;; i = this.mActivePointerId)
      {
        if (i == -1) {
        ...
        do
        {
          ...
          f1 = MotionEventCompat.getX(paramMotionEvent, i);
          f2 = MotionEventCompat.getY(paramMotionEvent, i);
        } while ((findTopChildUnder((int)f1, (int)f2) != this.mCapturedView) || (!tryCaptureViewForDrag(this.mCapturedView, n)));
      }
    case 1: 
      label564:
      if (this.mDragState == 1) {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/android/support/v4/widget/ViewDragHelper.class
