...
public class a
{
  ...
  public a(Context paramContext, ThemeService paramThemeService)
  {
    this.b = paramContext;
    this.a = paramThemeService;
    this.f = new f(this, paramContext.getContentResolver(), paramContext);
    this.c = new u();
    this.c.a(0L);
  ...
  private void a(ArrayList paramArrayList)
  {
    ...
    {
      Intent localIntent = new Intent("com.gau.go.launcherex.gowidget.weatherwidget.ACTION_APP_NEW_DATA");
      localIntent.putParcelableArrayListExtra("com.gau.go.launcherex.gowidget.weatherwidget.EXTRA_APP_NEW_DATA", paramArrayList);
  ...
  private boolean a(List paramList)
  {
    ...
    //   100: pop
    //   101: aload_0
    //   102: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   105: aload 7
    ...
    //   113: aload_0
    //   114: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   117: aload 7
    ...
    //   125: aload_0
    //   126: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    ...
    //   187: ireturn
    //   188: aload_0
    //   189: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   192: aload 7
    ...
    //   200: aload_0
    //   201: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   204: aload 7
    ...
    //   212: aload_0
    //   213: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   216: aload 7
    ...
    //   224: aload_0
    //   225: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   228: aload 7
    ...
    //   236: aload_0
    //   237: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    //   240: aload 7
    ...
    //   248: aload_0
    //   249: getfield 53	com/gau/go/launcherex/gowidget/weather/b/a:c	Lcom/gau/go/launcherex/gowidget/weather/model/u;
    ...
    //   603: goto +253 -> 856
    //   606: aload_0
    //   607: getfield 61	com/gau/go/launcherex/gowidget/weather/b/a:d	Ljava/util/ArrayList;
    //   610: aload_1
  ...
  private void b()
  {
    ...
    this.f.a(2, null, WeatherContentProvider.g, localContentValues, "setting_key=?", new String[] { "app_theme_data_timestamp" });
  }
        ...
        if (TextUtils.isEmpty(localThemeDataBean.t()))
        {
          ...
          if (!((File)localObject).exists())
          {
            if (!TextUtils.isEmpty(localThemeDataBean.e()))
            {
              ...
              new c(this, null).execute(new ThemeDataBean[] { localThemeDataBean });
            }
          }
          else
          {
            ...
            if (this.h)
            {
              localObject = new Intent("com.gau.go.launcherex.gowidget.weatherwidget.ACTION_APP_DOWNLOAD_PREVIEW_DONE");
              ((Intent)localObject).putExtra("com.gau.go.launcherex.gowidget.weatherwidget.EXTRA_APP_DOWNLOAD_PREVIEW_DONE", localThemeDataBean);
  ...
  private void c(List paramList)
  {
    ...
    paramList.add(new BasicNameValuePair("ty", "2"));
    try
    {
      paramList.add(new BasicNameValuePair("owns", com.gau.go.launcherex.gowidget.d.f.a("", "ISO-8859-1")));
      return;
    }
  ...
  private boolean c()
  {
    ...
    if (localIterator3.hasNext())
    {
      ...
      for (localObject = "";; localObject = localThemeDataBean.r())
      {
        ...
        localContentValues.put("theme_type", Integer.valueOf(2));
  ...
  private boolean d()
  {
    return this.b.getContentResolver().delete(WeatherContentProvider.h, "theme_type=?", new String[] { "2" }) > 0;
  }
  
  public void a()
  {
    com.gtp.a.a.b.c.a("LJL", "appThemeHandler.resetTheme()");
    if (this.a != null) {
      this.a.a();
    }
    this.f.a(5, null, WeatherContentProvider.g, new String[] { "setting_value", "setting_key" }, "setting_key=? or setting_key=?", new String[] { "key_live_wallpaper_theme", "app_theme" }, "_id");
  }
  ...
  public void a(String paramString)
  {
    ...
    this.f.a(4, paramString, WeatherContentProvider.g, new String[] { "setting_value", "setting_key" }, "setting_key=? or setting_key=?", new String[] { "key_live_wallpaper_theme", "app_theme" }, "_id");
  }
  
  public void b(String paramString)
  {
    if (com.gau.go.launcherex.gowidget.weather.globaltheme.a.c(paramString, this.b) != null)
    {
      if (this.a != null) {
        this.a.a();
      }
      this.f.a(7, paramString, WeatherContentProvider.g, new String[] { "setting_value", "setting_key" }, "setting_key=?", new String[] { "key_live_wallpaper_theme" }, "_id");
    }
    while (this.a == null) {
      return;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/b/a.class
