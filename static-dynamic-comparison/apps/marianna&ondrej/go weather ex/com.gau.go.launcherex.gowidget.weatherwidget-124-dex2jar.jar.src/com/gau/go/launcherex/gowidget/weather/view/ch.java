...
class ch
  extends k
{
  ch(WeatherWidget41 paramWeatherWidget41) {}
  
  private void a(int paramInt1, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
  {
    Message localMessage = WeatherWidget41.e(this.a).obtainMessage();
    ...
    WeatherWidget41.e(this.a).sendMessage(localMessage);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/view/ch.class
