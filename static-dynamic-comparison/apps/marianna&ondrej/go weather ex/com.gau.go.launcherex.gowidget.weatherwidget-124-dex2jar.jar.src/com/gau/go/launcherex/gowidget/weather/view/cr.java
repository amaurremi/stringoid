...
class cr
  extends k
{
  cr(WeatherWidget41Style2 paramWeatherWidget41Style2) {}
  
  private void a(int paramInt1, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
  {
    Message localMessage = WeatherWidget41Style2.z(this.a).obtainMessage();
    ...
    WeatherWidget41Style2.z(this.a).sendMessage(localMessage);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/view/cr.class
