...
public class GLWeatherWidget21
  extends GLGoWidgetFrame
  implements e, GLView.OnLongClickListener
{
  private int a = 0;
  private String b;
  private int c;
  ...
  public GLWeatherWidget21(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    a();
  }
  
  private GLWeather21 a(WeatherBean paramWeatherBean)
  {
    GLWeather21 localGLWeather21 = g();
    localGLWeather21.setWeatherBean(paramWeatherBean);
    this.n.addView(localGLWeather21);
    this.n.notifyViewsChanged();
    return localGLWeather21;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    this.d = new a();
    this.d.a = this.e;
    this.d.a("widget_style", String.valueOf(3));
    this.d.a("widget_theme_type", String.valueOf(this.f));
    if (localObject != null) {
      new com.gau.go.launcherex.gowidget.weather.f.c().a((XmlPullParser)localObject, this.d);
    }
    try
    {
      paramString.close();
      try
      {
        ...
        this.d.b = this.g;
        paramString = this.d.a("gw_weather_41_bg");
        paramString = com.gau.go.launcherex.gowidget.weather.f.c.a(this.g, paramString, this.e);
        this.n.setBackgroundDrawable(paramString);
        paramString = this.n.getCitys().iterator();
        while (paramString.hasNext())
        {
          localObject = (GLWeather21)paramString.next();
          if (localObject != null) {
            ((GLWeather21)localObject).onApplyTheme(this.d);
          }
        }
        return true;
      }
  ...
  private void c()
  {
    ...
    while (localIterator.hasNext()) {
      ((GLWeather21)localIterator.next()).updateAllViews();
    }
  }
  ...
  private void e()
  {
    ...
    if (i1 < i3)
    {
      WeatherBean localWeatherBean = ((GLWeather21)this.n.getChildAt(i1)).getWeatherBean();
  ...
  private GLWeather21 g()
  {
    GLWeather21 localGLWeather21 = new GLWeather21(this.mContext);
    localGLWeather21.setTimeManager(this.o);
    localGLWeather21.setOnLongClickListener(this);
    localGLWeather21.setWidgetView(this);
    localGLWeather21.setTip(this.mContext.getString(2131166457));
    if (this.d != null) {
      localGLWeather21.onApplyTheme(this.d);
    }
    return localGLWeather21;
  }
  ...
  private void h()
  {
    ...
    while (localIterator.hasNext())
    {
      GLWeather21 localGLWeather21 = (GLWeather21)localIterator.next();
      if (localGLWeather21.isEmptyCity())
      {
        this.n.removeView(localGLWeather21);
        a(localGLWeather21);
      }
    }
    this.n.notifyViewsChanged();
  ...
  private void i()
  {
    Iterator localIterator = this.n.getCitys().iterator();
    while (localIterator.hasNext()) {
      ((GLWeather21)localIterator.next()).showTemp(this.mSettings.a);
    }
  }
  ...
  private void j()
  {
    ...
    GLWeather21 localGLWeather21;
    do
    {
      if (!localIterator.hasNext()) {
        break;
      }
      localGLWeather21 = (GLWeather21)localIterator.next();
    } while (localGLWeather21.getWeatherBean().e() == 1);
    for (;;)
    {
      if (localGLWeather21 != null)
      {
        if ((localGLWeather21.getMyLocation() != 3) && (((ArrayList)localObject).size() != 1)) {
          break label72;
        }
        localGLWeather21.setMyLocation(1);
      }
      label72:
      int i1;
      do
  ...
  public void onBillingStatusChange(boolean paramBoolean)
  {
    ...
    {
      GLWeather21 localGLWeather21 = (GLWeather21)localArrayList.get(i1);
      if (this.n.getCurScreen() == i1) {
        localGLWeather21.showWeatherInfo(true);
      }
      for (;;)
      {
        i1 += 1;
        break;
        localGLWeather21.showWeatherInfo(false);
      }
    }
  }
  ...
  public void onScrollGroupFinishScroll(GLWidgetScrollGroup paramGLWidgetScrollGroup, int paramInt)
  {
    ...
    {
      this.b = ((GLWeather21)paramGLWidgetScrollGroup).getCityId();
      if (this.q == null) {}
    }
    try
    {
      this.q.a(3, this.a, this.b);
      return;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/view/gl/GLWeatherWidget21.class
