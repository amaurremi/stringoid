...
class ab
  extends k
{
  ab(GLWeatherWidget42 paramGLWeatherWidget42) {}
  
  private void a(int paramInt1, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
  {
    Message localMessage = GLWeatherWidget42.access$500(this.a).obtainMessage();
    ...
    GLWeatherWidget42.access$500(this.a).sendMessage(localMessage);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/view/gl/ab.class
