...
class i
  extends k
{
  i(GLWeatherWidget21 paramGLWeatherWidget21) {}
  
  private void a(int paramInt1, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
  {
    Message localMessage = GLWeatherWidget21.access$400(this.a).obtainMessage();
    ...
    GLWeatherWidget21.access$400(this.a).sendMessage(localMessage);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/view/gl/i.class
