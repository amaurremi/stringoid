...
class w
  extends k
{
  w(GLWeatherWidget41Style2 paramGLWeatherWidget41Style2) {}
  
  private void a(int paramInt1, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
  {
    Message localMessage = GLWeatherWidget41Style2.access$3000(this.a).obtainMessage();
    ...
    GLWeatherWidget41Style2.access$3000(this.a).sendMessage(localMessage);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/gau/go/launcherex/gowidget/weather/view/gl/w.class
