  ...
  implements Requests
{
  ...
  {
    Games.c(paramGoogleApiClient).gv();
  }
  ...
  {
    public Requests.LoadRequestSummariesResult N(final Status paramStatus)
    {
  ...
  {
    public Requests.LoadRequestsResult O(final Status paramStatus)
    {
  ...
  {
    public Requests.SendRequestResult P(final Status paramStatus)
    {
  ...
  {
    public Requests.UpdateRequestsResult Q(final Status paramStatus)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/games/internal/api/RequestsImpl.class
