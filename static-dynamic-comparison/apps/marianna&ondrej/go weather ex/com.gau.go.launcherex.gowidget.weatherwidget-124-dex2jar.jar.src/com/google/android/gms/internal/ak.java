  ...
  implements SafeParcelable
{
  ...
  ak(int paramInt1, String paramString, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, int paramInt5, ak[] paramArrayOfak)
  {
    ...
    this.lU = paramArrayOfak;
  }
  
  public ak(Context paramContext, AdSize paramAdSize)
  {
    this(paramContext, new AdSize[] { paramAdSize });
  }
  
  public ak(Context paramContext, AdSize[] paramArrayOfAdSize)
  {
    ...
    if (this.width == -1)
    {
      ...
      label110:
      this.heightPixels = dv.a(localDisplayMetrics, m);
      if ((i == 0) && (j == 0)) {
        break label254;
      }
    }
    ...
    label245:
    label254:
    for (this.lS = (k + "x" + m + "_as");; this.lS = localAdSize.toString())
    {
      if (paramArrayOfAdSize.length <= 1) {
        break label266;
      }
      this.lU = new ak[paramArrayOfAdSize.length];
      i = n;
      while (i < paramArrayOfAdSize.length)
      {
        this.lU[i] = new ak(paramContext, paramArrayOfAdSize[i]);
        i += 1;
      }
      i = 0;
      break;
      ...
      break label62;
      k = this.width;
      this.widthPixels = dv.a(localDisplayMetrics, this.width);
      break label98;
      m = this.height;
      break label110;
    }
  ...
  {
    this(2, paramak.lS, paramak.height, paramak.heightPixels, paramak.lT, paramak.width, paramak.widthPixels, paramArrayOfak);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/internal/ak.class
