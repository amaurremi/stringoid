...
public final class an
{
  ...
  public an(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (this.lW = f(paramAttributeSet);; this.lW = f(str))
    {
      this.lX = paramContext.getString(2);
  ...
  public AdSize[] e(boolean paramBoolean)
  {
    if ((!paramBoolean) && (this.lW.length != 1)) {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/internal/an.class
