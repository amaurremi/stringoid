  ...
  extends IInterface
{
  ...
  public abstract void a(Status paramStatus, ix paramix, Bundle paramBundle)
    throws RemoteException;
    ...
    implements je
  {
    ...
    public static je aX(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      if (paramParcel1.readInt() != 0)
      {
        ...
        localix = (ix)ix.CREATOR.createFromParcel(paramParcel1);
        label389:
        if (paramParcel1.readInt() == 0) {
          break label436;
        }
      ...
      for (paramParcel1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
      {
        a((Status)localObject, localix, paramParcel1);
        paramParcel2.writeNoException();
        return true;
        localObject = null;
        break;
      ...
      implements je
    {
        ...
        throws RemoteException
      {
        ...
        //   56: aload_0
        //   57: getfield 18	com/google/android/gms/internal/je$a$a:kn	Landroid/os/IBinder;
        //   60: iconst_3
        //   61: aload 5
        //   63: aload 6
        //   65: iconst_0
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramStatus != null)
            {
              ...
              {
                localParcel1.writeInt(1);
                paramix.writeToParcel(localParcel1, 0);
                if (paramBundle == null) {
                  break label131;
                }
                localParcel1.writeInt(1);
        ...
        throws RemoteException
      {
        ...
        //   35: aload_0
        //   36: getfield 18	com/google/android/gms/internal/je$a$a:kn	Landroid/os/IBinder;
        //   39: iconst_4
        //   40: aload_3
        //   41: aload 4
        //   43: iconst_0
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/internal/je.class
