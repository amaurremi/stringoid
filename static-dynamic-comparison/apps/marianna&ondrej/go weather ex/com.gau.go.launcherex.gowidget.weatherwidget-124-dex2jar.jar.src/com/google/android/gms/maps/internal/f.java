  ...
  extends IInterface
{
    ...
    implements f
  {
    ...
    public static f ai(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
      a(d.a.aE(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements f
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/f$a$a:kn	Landroid/os/IBinder;
        //   34: iconst_2
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/maps/internal/f.class
