  ...
  implements DataLayer.c
{
  ...
  {
    this(paramContext, gn.ft(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
  }
  
  v(Context paramContext, gl paramgl, String paramString, int paramInt, Executor paramExecutor)
  {
    this.mContext = paramContext;
    this.Wv = paramgl;
    this.XE = paramInt;
    this.XC = paramExecutor;
    this.XD = new a(this.mContext, paramString);
  }
  ...
  private SQLiteDatabase L(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.XD.getWritableDatabase();
  ...
  private List<DataLayer.a> b(List<b> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new DataLayer.a(localb.Xy, j(localb.XK)));
    }
  ...
  private void b(List<b> paramList, long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 78	com/google/android/gms/tagmanager/v:Wv	Lcom/google/android/gms/internal/gl;
    //   6: invokeinterface 163 1 0
    //   11: lstore 4
    //   13: aload_0
    //   14: lload 4
    //   16: invokespecial 167	com/google/android/gms/tagmanager/v:u	(J)V
    //   19: aload_0
    //   20: aload_1
    //   21: invokeinterface 171 1 0
    //   26: invokespecial 175	com/google/android/gms/tagmanager/v:cb	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    //   34: ladd
    //   35: invokespecial 178	com/google/android/gms/tagmanager/v:c	(Ljava/util/List;J)V
    //   38: aload_0
    //   39: invokespecial 181	com/google/android/gms/tagmanager/v:kv	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 181	com/google/android/gms/tagmanager/v:kv	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  {
    SQLiteDatabase localSQLiteDatabase = L("Error opening database for clearKeysWithPrefix.");
    ...
    try
    {
      ...
      bh.y("Cleared " + i + " items");
      return;
    }
    catch (SQLiteException localSQLiteException)
    {
      bh.z("Error deleting entries with key prefix: " + paramString + " (" + localSQLiteException + ").");
      return;
    }
    finally
    {
  ...
  private List<b> c(List<DataLayer.a> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new b(locala.Xy, j(locala.Xz)));
    }
    return localArrayList;
  }
  ...
  {
    SQLiteDatabase localSQLiteDatabase = L("Error opening database for writeEntryToDatabase.");
    if (localSQLiteDatabase == null) {}
    for (;;)
    {
      return;
      ...
      while (paramList.hasNext())
      {
        ...
        localContentValues.put("key", localb.Xy);
        localContentValues.put("value", localb.XK);
  ...
  {
    paramInt = ku() - this.XE + paramInt;
    if (paramInt > 0)
    {
      List localList = cc(paramInt);
      bh.x("DataLayer store full, deleting " + localList.size() + " entries to make room.");
      g((String[])localList.toArray(new String[0]));
    }
  }
  
  /* Error */
  private List<String> cc(int paramInt)
  {
    // Byte code:
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 288
    //   16: invokestatic 101	com/google/android/gms/tagmanager/bh:z	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 290
    //   26: invokespecial 186	com/google/android/gms/tagmanager/v:L	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   52: astore 4
    //   54: iload_1
    //   55: invokestatic 297	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   58: astore 5
    //   60: aload_3
    //   61: ldc 36
    //   63: iconst_1
    ...
    //   103: aload 4
    //   105: iconst_0
    //   106: invokeinterface 310 2 0
    //   111: invokestatic 313	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   114: invokeinterface 155 2 0
    //   119: pop
    //   120: aload 4
    //   122: astore_3
    //   123: aload 4
    //   125: invokeinterface 316 1 0
    //   130: istore_2
    //   131: iload_2
    //   132: ifne -34 -> 98
    //   135: aload 4
    ...
    //   171: aload 5
    //   173: invokevirtual 324	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   176: invokevirtual 195	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 201	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 101	com/google/android/gms/tagmanager/bh:z	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
    //   192: invokeinterface 319 1 0
    //   197: goto -50 -> 147
    //   200: astore 4
    //   202: aconst_null
    //   203: astore_3
  ...
  private void g(String[] paramArrayOfString)
  {
    ...
    {
      return;
      localSQLiteDatabase = L("Error opening database for deleteEntries.");
    ...
    {
      bh.z("Error deleting entries " + Arrays.toString(paramArrayOfString));
    }
  }
  ...
  {
    // Byte code:
    //   0: new 358	java/io/ByteArrayInputStream
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 361	java/io/ByteArrayInputStream:<init>	([B)V
    //   8: astore_3
    //   9: new 363	java/io/ObjectInputStream
    //   12: dup
    //   13: aload_3
    //   14: invokespecial 366	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   17: astore_1
    //   18: aload_1
    //   19: invokevirtual 369	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: ifnull +7 -> 31
    //   27: aload_1
    //   28: invokevirtual 370	java/io/ObjectInputStream:close	()V
    //   31: aload_3
    //   32: invokevirtual 371	java/io/ByteArrayInputStream:close	()V
    //   35: aload_2
    //   36: areturn
    //   37: astore_1
    //   38: aconst_null
    ...
    //   41: ifnull +7 -> 48
    //   44: aload_1
    //   45: invokevirtual 370	java/io/ObjectInputStream:close	()V
    //   48: aload_3
    //   49: invokevirtual 371	java/io/ByteArrayInputStream:close	()V
    //   52: aconst_null
    //   53: areturn
    //   54: astore_1
    //   55: aconst_null
    ...
    //   61: ifnull +7 -> 68
    //   64: aload_1
    //   65: invokevirtual 370	java/io/ObjectInputStream:close	()V
    //   68: aload_3
    //   69: invokevirtual 371	java/io/ByteArrayInputStream:close	()V
    //   72: aconst_null
    //   73: areturn
    //   74: astore_1
    //   75: aconst_null
    ...
    //   81: ifnull +7 -> 88
    //   84: aload_1
    //   85: invokevirtual 370	java/io/ObjectInputStream:close	()V
    //   88: aload_3
  ...
  {
    // Byte code:
    //   0: new 373	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 374	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore_3
    //   8: new 376	java/io/ObjectOutputStream
    //   11: dup
    //   12: aload_3
    //   13: invokespecial 379	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore_2
    //   17: aload_2
    //   18: aload_1
    //   19: invokevirtual 383	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   22: aload_3
    //   23: invokevirtual 387	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   26: astore_1
    //   27: aload_2
    //   28: ifnull +7 -> 35
    //   31: aload_2
    //   32: invokevirtual 388	java/io/ObjectOutputStream:close	()V
    //   35: aload_3
    //   36: invokevirtual 389	java/io/ByteArrayOutputStream:close	()V
    //   39: aload_1
    //   40: areturn
    //   41: astore_1
    //   42: aconst_null
    ...
    //   45: ifnull +7 -> 52
    //   48: aload_2
    //   49: invokevirtual 388	java/io/ObjectOutputStream:close	()V
    //   52: aload_3
    //   53: invokevirtual 389	java/io/ByteArrayOutputStream:close	()V
    //   56: aconst_null
    //   57: areturn
    //   58: astore_1
    //   59: aconst_null
    ...
    //   65: ifnull +7 -> 72
    //   68: aload_2
    //   69: invokevirtual 388	java/io/ObjectOutputStream:close	()V
    //   72: aload_3
    //   73: invokevirtual 389	java/io/ByteArrayOutputStream:close	()V
    //   76: aload_1
    //   77: athrow
    //   78: astore_2
    //   79: goto -3 -> 76
  ...
  private List<b> kt()
  {
    Object localObject = L("Error opening database for loadSerialized.");
    ArrayList localArrayList = new ArrayList();
    if (localObject == null) {
      return localArrayList;
    }
  ...
  private int ku()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = L("Error opening database for getNumStoredEntries.");
  ...
  {
    SQLiteDatabase localSQLiteDatabase = L("Error opening database for deleteOlderThan.");
    if (localSQLiteDatabase == null) {
      return;
    }
    try
  ...
  public void bx(final String paramString)
  {
    this.XC.execute(new Runnable()
    {
      public void run()
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      //   73: invokestatic 104	com/google/android/gms/tagmanager/bh:z	(Ljava/lang/String;)V
      //   76: aload_2
      //   77: ifnull +9 -> 86
      //   80: aload_2
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(v.kw());
          return;
        }
      }
      finally
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/tagmanager/v.class
