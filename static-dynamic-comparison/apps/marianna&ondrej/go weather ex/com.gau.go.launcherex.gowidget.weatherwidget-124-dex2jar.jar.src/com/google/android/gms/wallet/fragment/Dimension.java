...
public class Dimension
{
  ...
  public static long a(int paramInt, float paramFloat)
  {
    ...
    return f(paramInt, Float.floatToIntBits(paramFloat));
  }
  ...
  public static long a(TypedValue paramTypedValue)
  {
    ...
    case 16: 
      return cz(paramTypedValue.data);
    }
    return f(128, paramTypedValue.data);
  }
  
  public static long cz(int paramInt)
  {
    if (paramInt < 0)
    {
      if ((paramInt == -1) || (paramInt == -2)) {
        return f(129, paramInt);
      }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/google/android/gms/wallet/fragment/Dimension.class
