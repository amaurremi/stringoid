  ...
  extends AbsFilterHandler
{
  ...
  public native void doFilt(int[] paramArrayOfInt, int paramInt1, int paramInt2, double paramDouble1, double paramDouble2);
  ...
  public Bitmap handler(FilterParameter paramFilterParameter)
  {
    ...
    do
    {
      ...
      doFilt((int[])localObject, i, j, 0.800000011920929D, 0.800000011920929D);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/jiubang/ggheart/apps/desks/diy/filter/core/ClothHandler.class
