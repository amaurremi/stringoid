  ...
  extends AbsFilterHandler
{
  ...
  public MilkHandler(Context paramContext)
  {
    try
    {
      this.d = paramContext;
      ...
      Bitmap localBitmap1 = BitmapFactory.decodeStream(paramContext.getAssets().open("milk_background.png"));
      Bitmap localBitmap2 = BitmapFactory.decodeStream(paramContext.getAssets().open("overlay_map.png"));
      paramContext = BitmapFactory.decodeStream(paramContext.getAssets().open("milk_map.png"));
  ...
  private BitmapInfo a()
  {
    ...
    try
    {
      localObject = BitmapFactory.decodeStream(((Context)localObject).getAssets().open("milk_background.png"));
  ...
  private BitmapInfo c()
  {
    ...
    try
    {
      localObject = BitmapFactory.decodeStream(((Context)localObject).getAssets().open("milk_map.png"));
      return new BitmapInfo(a((Bitmap)localObject), ((Bitmap)localObject).getWidth(), ((Bitmap)localObject).getHeight());
    }
    catch (Exception localException)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/jiubang/ggheart/apps/desks/diy/filter/core/MilkHandler.class
