  ...
  extends FrameLayout
{
  ...
  protected void onFinishInflate()
  {
    ...
    this.d = aa.a().b().i();
    this.e = aa.a().b().h();
    this.f = ((LinearLayout)findViewById(f.R));
  }
}


/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/jiubang/playsdk/views/IndicatorView.class
