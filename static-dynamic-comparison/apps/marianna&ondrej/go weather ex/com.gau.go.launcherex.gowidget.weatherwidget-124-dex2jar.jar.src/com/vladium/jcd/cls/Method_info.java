  ...
  implements Cloneable, IAccessFlags
{
  ...
  public Method_info(int paramInt1, int paramInt2, int paramInt3, IAttributeCollection paramIAttributeCollection)
  {
  ...
  public Method_info(IConstantCollection paramIConstantCollection, UDataInputStream paramUDataInputStream)
    throws IOException
  {
  ...
  public Object clone()
  {
    try
    {
      Method_info localMethod_info = (Method_info)super.clone();
      localMethod_info.m_attributes = ((IAttributeCollection)this.m_attributes.clone());
  ...
  public String toString()
  {
    ...
    localStringBuffer.append("method_info: [modifiers: 0x" + Integer.toHexString(this.m_access_flags) + ", name_index = " + this.m_name_index + ", descriptor_index = " + this.m_descriptor_index + "]\n");
    int i = 0;
    while (i < this.m_attributes.size())
    {
      Attribute_info localAttribute_info = this.m_attributes.get(i);
      localStringBuffer.append("\t[" + i + "] attribute: " + localAttribute_info + "\n");
      i += 1;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/vladium/jcd/cls/Method_info.class
