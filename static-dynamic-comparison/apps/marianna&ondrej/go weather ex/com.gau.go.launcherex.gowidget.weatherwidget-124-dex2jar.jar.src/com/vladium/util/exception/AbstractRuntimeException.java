  ...
  implements ICodedException, IThrowableWrapper
{
  ...
  public AbstractRuntimeException(String paramString)
  {
    super(paramString);
    this.m_cause = null;
    this.m_arguments = null;
  ...
  public AbstractRuntimeException(String paramString, Throwable paramThrowable)
  {
    super(paramString);
  ...
  public AbstractRuntimeException(String paramString, Object[] paramArrayOfObject)
  {
    super(paramString);
    this.m_cause = null;
  ...
  public AbstractRuntimeException(String paramString, Object[] paramArrayOfObject, Throwable paramThrowable)
  {
    super(paramString);
    this.m_cause = paramThrowable;
    if (paramArrayOfObject == null) {}
  ...
  public AbstractRuntimeException(Throwable paramThrowable)
  {
    this.m_cause = paramThrowable;
    this.m_arguments = null;
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/go weather ex/com.gau.go.launcherex.gowidget.weatherwidget-124-dex2jar.jar!/com/vladium/util/exception/AbstractRuntimeException.class
