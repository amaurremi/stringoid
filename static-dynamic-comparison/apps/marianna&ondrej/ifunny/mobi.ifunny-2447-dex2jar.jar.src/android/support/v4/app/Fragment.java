...
public class Fragment
    ...
    public static Fragment instantiate(Context paramContext, String paramString, Bundle paramBundle) {
        try {
            ...
            throw new i("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an" + " empty constructor that is public", paramContext);
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.a(this.mActivity, new h(this), this);
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v4/app/Fragment.class
