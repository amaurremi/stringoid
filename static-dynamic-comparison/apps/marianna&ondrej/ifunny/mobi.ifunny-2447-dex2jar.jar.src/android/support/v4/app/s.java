...
final class s
    ...
    public void a(int paramInt1, int paramInt2) {
        ...
        a(new u(this, paramInt1, paramInt2), false);
    }
    ...
    public void a(int paramInt, d paramd) {
        ...
        //   1: monitorenter
        //   2: aload_0
        //   3: getfield 212	android/support/v4/app/s:k	Ljava/util/ArrayList;
        //   6: ifnonnull +14 -> 20
        //   9: aload_0
        //   10: new 206	java/util/ArrayList
        //   13: dup
        //   14: invokespecial 213	java/util/ArrayList:<init>	()V
        //   17: putfield 212	android/support/v4/app/s:k	Ljava/util/ArrayList;
        //   20: aload_0
        //   21: getfield 212	android/support/v4/app/s:k	Ljava/util/ArrayList;
        ...
        //   33: iload 4
        //   35: if_icmpge +56 -> 91
        //   38: getstatic 55	android/support/v4/app/s:a	Z
        //   41: ifeq +37 -> 78
        //   44: ldc -120
        ...
        //   77: pop
        //   78: aload_0
        //   79: getfield 212	android/support/v4/app/s:k	Ljava/util/ArrayList;
        //   82: iload_1
        //   83: aload_2
        ...
        //   93: if_icmpge +81 -> 174
        //   96: aload_0
        //   97: getfield 212	android/support/v4/app/s:k	Ljava/util/ArrayList;
        //   100: aconst_null
        //   101: invokevirtual 229	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   104: pop
        //   105: aload_0
        //   106: getfield 204	android/support/v4/app/s:l	Ljava/util/ArrayList;
        //   109: ifnonnull +14 -> 123
        //   112: aload_0
        //   113: new 206	java/util/ArrayList
        //   116: dup
        //   117: invokespecial 213	java/util/ArrayList:<init>	()V
        //   120: putfield 204	android/support/v4/app/s:l	Ljava/util/ArrayList;
        //   123: getstatic 55	android/support/v4/app/s:a	Z
        //   126: ifeq +29 -> 155
        //   129: ldc -120
        ...
        //   154: pop
        //   155: aload_0
        //   156: getfield 204	android/support/v4/app/s:l	Ljava/util/ArrayList;
        //   159: iload_3
        //   160: invokestatic 382	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        ...
        //   170: istore_3
        //   171: goto -80 -> 91
        //   174: getstatic 55	android/support/v4/app/s:a	Z
        //   177: ifeq +37 -> 214
        //   180: ldc -120
        ...
        //   213: pop
        //   214: aload_0
        //   215: getfield 212	android/support/v4/app/s:k	Ljava/util/ArrayList;
        //   218: aload_2
            ...
            if (paramParcelable.a != null) {
                ...
                while (i1 < paramParcelable.c.length) {
                    ...
                    if (a) {
                        ...
                        paramArrayList.a("  ", new PrintWriter(new e("FragmentManager")), false);
                    }
            ...
            switch (paramFragment.mState) {
                ...
                case 0:
                    ...
                    for (localObject1 = this.q.mChildFragmentManager; ; localObject1 = this.o.b) {
                        paramFragment.mFragmentManager = ((s) localObject1);
                        paramFragment.mCalled = false;
                        paramFragment.onAttach(this.o);
                        if (paramFragment.mCalled) {
                            break;
                        }
                        throw new cs("Fragment " + paramFragment + " did not call through to super.onAttach()");
                    }
                    ...
                    if (paramFragment.mFromLayout) {
                        ...
                        paramFragment.mView = ao.a(paramFragment.mView);
                ...
                case 2:
                    ...
                    for (localObject1 = a(paramFragment, paramInt2, false, paramInt3); ; localObject1 = null) {
                        if (localObject1 != null) {
                            ...
                            paramFragment.mStateAfterAnimating = paramInt1;
                            ((Animation) localObject1).setAnimationListener(new v(this, paramFragment));
                        ...
                        if (!paramFragment.mCalled) {
                            throw new cs("Fragment " + paramFragment + " did not call through to super.onDetach()");
                        }
                        i1 = paramInt1;
                        if (paramBoolean) {
                            break;
    ...
    public void a(k paramk, p paramp, Fragment paramFragment) {
        if (this.o != null) {
    ...
    public String toString() {
        ...
        if (this.q != null) {
            android.support.v4.d.d.a(this.q, localStringBuilder);
        }
        for (; ; ) {
            localStringBuilder.append("}}");
            return localStringBuilder.toString();
            android.support.v4.d.d.a(this.o, localStringBuilder);
        }
    }
}


/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v4/app/s.class
