...
class s
    ...
    public s(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler) {
        ...
        for (this.h = new t(this, paramHandler); ; this.h = new t(this)) {
    ...
    public boolean a(MotionEvent paramMotionEvent) {
        ...
        if ((i6 & 0xFF) == 6) {
            ...
            i3 = as.b(paramMotionEvent);
            i5 = as.c(paramMotionEvent);
            i4 = 0;
            f1 = 0.0F;
            f2 = 0.0F;
            label66:
        ...
        for (; ; ) {
            ...
            break label53;
            label101:
            f2 += as.c(paramMotionEvent, i4);
            f1 += as.d(paramMotionEvent, i4);
        }
        label122:
        if (i1 != 0) {
            i1 = i5 - 1;
            ...
            case 2:
                do {
                    ...
                    do {
                        ...
                        f3 = ay.a(this.x, i4);
                    } while (ay.b(this.x, i4) * f2 + f3 * f1 >= 0.0F);
                    this.x.clear();
                    return false;
                    if (this.j != null) {
        ...
        for (; ; ) {
            ...
            for (; ; ) {
                ...
                if (this.m) {
                    ...
                    i2 = as.b(paramMotionEvent, 0);
                    localVelocityTracker.computeCurrentVelocity(1000, this.d);
                    f1 = ay.b(localVelocityTracker, i2);
                    f2 = ay.a(localVelocityTracker, i2);
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v4/view/s.class
