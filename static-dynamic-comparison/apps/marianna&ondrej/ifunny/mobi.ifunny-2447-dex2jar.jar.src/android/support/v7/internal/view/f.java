...
public class f
            ...
            case 3:
                for (; ; ) {
                    ...
                    if (i == 0) {
                        ...
                        if (str.equals("group")) {
                            localh.a(paramAttributeSet);
                        } else if (str.equals("item")) {
                            localh.b(paramAttributeSet);
                        } else if (str.equals("menu")) {
                            a(paramXmlPullParser, paramAttributeSet, localh.c());
                        } else {
                            paramMenu = str;
                            i = 1;
                            continue;
                            ...
                            if ((i != 0) && (str.equals(paramMenu))) {
                                ...
                                if (!localh.d()) {
                                    if ((h.a(localh) != null) && (h.a(localh).g())) {
                                        localh.c();
                                    } else {
                                        localh.b();
                                    }
    ...
    public void inflate(int paramInt, Menu paramMenu) {
        ...
        //   20: astore 4
        //   22: aload_0
        //   23: getfield 32	android/support/v7/internal/view/f:e	Landroid/content/Context;
        ...
        //   54: aload_2
        //   55: invokespecial 100	android/support/v7/internal/view/f:a	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
        //   58: aload 6
        //   60: ifnull -47 -> 13
        //   63: aload 6
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/internal/view/f.class
