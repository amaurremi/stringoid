...
public class ActionMenuView
    ...
    public ActionMenuView(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        this.f = ((int) (56.0F * f1));
        this.g = ((int) (f1 * 4.0F));
        paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, android.support.v7.b.k.ActionBar, c.actionBarStyle, 0);
        ...
        for (; ; ) {
            if (m < i12) {
                ...
                if (((View) localObject).getVisibility() == 8) {
                    ...
                    localk = (k) ((View) localObject).getLayoutParams();
                    localk.f = false;
                    localk.c = 0;
                    localk.b = 0;
                    localk.d = false;
                    localk.leftMargin = 0;
                    localk.rightMargin = 0;
            ...
            for (k = 1; ; k = n) {
                ...
                if (i7 == 1) {
                    ...
                    if ((n != 0) && (i3 == 2)) {
                        ...
                        localObject = (k) getChildAt(i6).getLayoutParams();
                        if (((k) localObject).d) {
                            break label541;
                        }
                        i7 = paramInt2;
                    ...
                    for (; ; ) {
                        ...
                        i5 = 0;
                        break;
                        if (((k) localObject).b < paramInt1) {
                            paramInt2 = ((k) localObject).b;
                            l2 = 1 << i6;
                            paramInt1 = 1;
                        } else {
                            if (((k) localObject).b != paramInt1) {
                    ...
                    for (; ; ) {
                        ...
                        if ((n == 0) && (i3 == 1)) {
                            ...
                            if ((1L & l1) != 0L) {
                                f1 = f3;
                                if (!((k) getChildAt(0).getLayoutParams()).e) {
                                    f1 = f3 - 0.5F;
                                }
                            }
                            f2 = f1;
                            ...
                            f2 = f1;
                            if (((k) getChildAt(i12 - 1).getLayoutParams()).e) {
                                break label1208;
                            }
                            f1 -= 0.5F;
                            if (f1 <= 0.0F) {
                        ...
                        for (; ; ) {
                            ...
                            if (localk.a) {
                                localk.c = paramInt2;
                                localk.f = true;
                                localk.rightMargin = (-paramInt2 / 2);
                                paramInt1 = 1;
                                break label803;
                            }
                            if (k != 0) {
                                ...
                                if (paramInt1 != 0) {
                                    ...
                                    if (paramInt1 < i12) {
                                        ...
                                        for (; ; ) {
                                            ...
                                            break;
                                            k = localk.b;
                                            ((View) localObject).measure(View.MeasureSpec.makeMeasureSpec(localk.c + k * i11, 1073741824), i4);
                                        }
                                    }
                                }
                                if (i9 != 1073741824) {
    ...
    public k a(AttributeSet paramAttributeSet) {
        return new k(getContext(), paramAttributeSet);
    }

    protected k a(ViewGroup.LayoutParams paramLayoutParams) {
        if ((paramLayoutParams instanceof k)) {
            paramLayoutParams = new k((k) paramLayoutParams);
    ...
    protected boolean a(int paramInt) {
        ...
        if (paramInt < getChildCount()) {
            bool1 = bool2;
            if ((localView1 instanceof j)) {
                bool1 = false | ((j) localView1).d();
            }
        }
        if ((paramInt > 0) && ((localView2 instanceof j))) {
            return ((j) localView2).c() | bool1;
        }
        return bool1;
    }
    ...
    protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        ...
        if (m < i3) {
            ...
            for (; ; ) {
                ...
                if (localk.a) {
                    ...
                    i1 = getWidth() - getPaddingRight() - localk.rightMargin;
                    int i5 = i2 - n / 2;
                    ...
                    i1 = localView.getMeasuredWidth() + localk.leftMargin + localk.rightMargin;
                    n = paramInt4 + i1;
                    paramInt4 = n;
                    if (a(m)) {
                        paramInt4 = n + i4;
        ...
        for (; ; ) {
            ...
            paramInt1 = 0;
            break label436;
            paramInt1 += localk.leftMargin;
            paramInt4 = localView.getMeasuredWidth();
            j = localView.getMeasuredHeight();
            k = i2 - j / 2;
            localView.layout(paramInt1, k, paramInt1 + paramInt4, j + k);
            paramInt1 = localk.rightMargin + paramInt4 + paramInt3 + paramInt1;
        }
    }
    ...
    protected void onMeasure(int paramInt1, int paramInt2) {
        ...
        int j = 0;
        while (j < k) {
            k localk = (k) getChildAt(j).getLayoutParams();
            localk.rightMargin = 0;
            localk.leftMargin = 0;
            j += 1;
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/internal/view/menu/ActionMenuView.class
