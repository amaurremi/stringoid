...
public class ActionBarView
    ...
    public ActionBarView(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        this.k = paramAttributeSet.getText(1);
        ...
        try {
            ...
            try {
                ...
                int i1 = paramAttributeSet.getResourceId(14, android.support.v7.b.h.abc_action_bar_home);
                ...
                this.q.setContentDescription(getResources().getText(android.support.v7.b.i.abc_action_bar_up_description));
    ...
    private void a(android.support.v7.internal.view.menu.q paramq) {
        if (paramq != null) {
            paramq.a(this.b);
            paramq.a(this.R);
        }
    ...
    private void n() {
        ...
        int i1;
        if (this.r == null) {
            this.r = ((LinearLayout) LayoutInflater.from(getContext()).inflate(android.support.v7.b.h.abc_action_bar_title_item, this, false));
    ...
    public void a(android.support.v4.b.a.a parama, ah paramah) {
        if (parama == this.L) {
            return;
        }
        if (this.L != null) {
        ...
        Object localObject = (android.support.v7.internal.view.menu.q) parama;
        this.L = ((android.support.v7.internal.view.menu.q) localObject);
        if (this.a != null) {
        ...
        for (; ; ) {
            ...
            if (this.c != null) {
                ...
                this.c.addView(parama, paramah);
            } else {
                parama.setLayoutParams(paramah);
            }
        }
    }
    ...
    public void l() {
        ...
        for (u localu = null; ; localu = this.R.b) {
            if (localu != null) {
                localu.collapseActionView();
            }
            return;
        }
    }
    ...
    public void setDisplayOptions(int paramInt) {
        ...
        label376:
        if ((paramInt & 0x4) != 0) {
            this.p.setContentDescription(this.o.getResources().getText(android.support.v7.b.i.abc_action_bar_up_description));
            return;
        }
        this.p.setContentDescription(this.o.getResources().getText(android.support.v7.b.i.abc_action_bar_home_description));
    }
    ...
    public void setNavigationMode(int paramInt) {
        ...
        for (; ; ) {
            ...
            break;
            if (this.v == null) {
                this.v = new ak(this.o, null, android.support.v7.b.c.actionDropDownStyle);
                this.w = ((LinearLayout) LayoutInflater.from(this.o).inflate(android.support.v7.b.h.abc_action_bar_view_list_nav_layout, null));
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/internal/widget/ActionBarView.class
