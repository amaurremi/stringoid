...
public class ProgressBarICS
        ...
        for (; ; ) {
            try {
                ...
                if (this.u != null) {
                    af localaf1 = this.u;
                    this.u = null;
                    localaf1.a(paramInt1, paramInt2, paramBoolean);
                    post(localaf1);
                } else {
                    af localaf2 = new af(this, paramInt1, paramInt2, paramBoolean);
                }
            } finally {
            }
        }
    ...
    public int getProgress() {
        ...
        //   1: monitorenter
        //   2: aload_0
        //   3: getfield 109	android/support/v7/internal/widget/ProgressBarICS:l	Z
        //   6: istore_2
        //   7: iload_2
        //   8: ifeq +9 -> 17
        //   11: iconst_0
        ...
        //   16: ireturn
        //   17: aload_0
        //   18: getfield 99	android/support/v7/internal/widget/ProgressBarICS:g	I
        //   21: istore_1
        //   22: goto -9 -> 13
        //   25: astore_3
        //   26: aload_0
    ...
    public int getSecondaryProgress() {
        ...
        //   16: ireturn
        //   17: aload_0
        //   18: getfield 104	android/support/v7/internal/widget/ProgressBarICS:h	I
        //   21: istore_1
        //   22: goto -9 -> 13
        //   25: astore_3
        //   26: aload_0
    ...
    protected void onDraw(android.graphics.Canvas paramCanvas) {
        ...
        //   2: aload_0
        //   3: aload_1
        //   4: invokespecial 451	android/view/View:onDraw	(Landroid/graphics/Canvas;)V
        //   7: aload_0
        //   8: getfield 303	android/support/v7/internal/widget/ProgressBarICS:r	Landroid/graphics/drawable/Drawable;
        //   11: astore 5
        //   13: aload 5
        //   15: ifnull +146 -> 161
        //   18: aload_1
        //   19: invokevirtual 456	android/graphics/Canvas:save	()I
        //   22: pop
        //   23: aload_1
        //   24: aload_0
        //   25: invokevirtual 266	android/support/v7/internal/widget/ProgressBarICS:getPaddingLeft	()I
        //   28: i2f
        //   29: aload_0
        //   30: invokevirtual 272	android/support/v7/internal/widget/ProgressBarICS:getPaddingTop	()I
        //   33: i2f
        //   34: invokevirtual 459	android/graphics/Canvas:translate	(FF)V
        //   37: aload_0
        //   38: invokevirtual 462	android/support/v7/internal/widget/ProgressBarICS:getDrawingTime	()J
        //   41: lstore_3
        //   42: aload_0
        //   43: getfield 331	android/support/v7/internal/widget/ProgressBarICS:o	Landroid/view/animation/AlphaAnimation;
        //   46: ifnull +75 -> 121
        //   49: aload_0
        //   50: getfield 331	android/support/v7/internal/widget/ProgressBarICS:o	Landroid/view/animation/AlphaAnimation;
        //   53: lload_3
        //   54: aload_0
        //   55: getfield 344	android/support/v7/internal/widget/ProgressBarICS:n	Landroid/view/animation/Transformation;
        //   58: invokevirtual 466	android/view/animation/AlphaAnimation:getTransformation	(JLandroid/view/animation/Transformation;)Z
        //   61: pop
        //   62: aload_0
        //   63: getfield 344	android/support/v7/internal/widget/ProgressBarICS:n	Landroid/view/animation/Transformation;
        //   66: invokevirtual 470	android/view/animation/Transformation:getAlpha	()F
        //   69: fstore_2
        //   70: aload_0
        //   71: iconst_1
        //   72: putfield 402	android/support/v7/internal/widget/ProgressBarICS:y	Z
        //   75: aload 5
        //   77: fload_2
        //   78: ldc_w 310
        //   81: fmul
        //   82: f2i
        //   83: invokevirtual 185	android/graphics/drawable/Drawable:setLevel	(I)Z
        //   86: pop
        //   87: aload_0
        //   88: iconst_0
        //   89: putfield 402	android/support/v7/internal/widget/ProgressBarICS:y	Z
        //   92: invokestatic 475	android/os/SystemClock:uptimeMillis	()J
        //   95: aload_0
        //   96: getfield 477	android/support/v7/internal/widget/ProgressBarICS:x	J
        //   99: lsub
        //   100: ldc2_w 478
        //   103: lcmp
        //   104: iflt +17 -> 121
        //   107: aload_0
        //   108: invokestatic 475	android/os/SystemClock:uptimeMillis	()J
        //   111: putfield 477	android/support/v7/internal/widget/ProgressBarICS:x	J
        //   114: aload_0
        //   115: ldc2_w 478
        //   118: invokevirtual 482	android/support/v7/internal/widget/ProgressBarICS:postInvalidateDelayed	(J)V
        //   121: aload 5
        //   123: aload_1
        //   124: invokevirtual 485	android/graphics/drawable/Drawable:draw	(Landroid/graphics/Canvas;)V
        //   127: aload_1
        //   128: invokevirtual 488	android/graphics/Canvas:restore	()V
        //   131: aload_0
        //   132: getfield 329	android/support/v7/internal/widget/ProgressBarICS:w	Z
        //   135: ifeq +26 -> 161
        //   138: aload 5
        //   140: instanceof 327
        //   143: ifeq +18 -> 161
        //   146: aload 5
        //   148: checkcast 327	android/graphics/drawable/Animatable
        //   151: invokeinterface 491 1 0
        //   156: aload_0
        //   157: iconst_0
        //   158: putfield 329	android/support/v7/internal/widget/ProgressBarICS:w	Z
        //   161: aload_0
        //   162: monitorexit
        //   163: return
        //   164: astore_1
        //   165: aload_0
        //   166: iconst_0
        //   167: putfield 402	android/support/v7/internal/widget/ProgressBarICS:y	Z
        //   170: aload_1
        //   171: athrow
        //   172: astore_1
        //   173: aload_0
    ...
    public void setIndeterminate(boolean paramBoolean) {
        ...
        //   1: monitorenter
        //   2: aload_0
        //   3: getfield 115	android/support/v7/internal/widget/ProgressBarICS:m	Z
        //   6: ifeq +10 -> 16
        //   9: aload_0
        //   10: getfield 109	android/support/v7/internal/widget/ProgressBarICS:l	Z
        //   13: ifne +32 -> 45
        //   16: iload_1
        //   17: aload_0
        //   18: getfield 109	android/support/v7/internal/widget/ProgressBarICS:l	Z
        //   21: if_icmpeq +24 -> 45
        //   24: aload_0
        //   25: iload_1
        //   26: putfield 109	android/support/v7/internal/widget/ProgressBarICS:l	Z
        //   29: iload_1
        //   30: ifeq +18 -> 48
        //   33: aload_0
        //   34: aload_0
        //   35: getfield 274	android/support/v7/internal/widget/ProgressBarICS:p	Landroid/graphics/drawable/Drawable;
        //   38: putfield 303	android/support/v7/internal/widget/ProgressBarICS:r	Landroid/graphics/drawable/Drawable;
        //   41: aload_0
        //   42: invokevirtual 439	android/support/v7/internal/widget/ProgressBarICS:a	()V
        //   45: aload_0
        //   46: monitorexit
        //   47: return
        //   48: aload_0
        //   49: aload_0
        //   50: getfield 286	android/support/v7/internal/widget/ProgressBarICS:q	Landroid/graphics/drawable/Drawable;
        //   53: putfield 303	android/support/v7/internal/widget/ProgressBarICS:r	Landroid/graphics/drawable/Drawable;
        //   56: aload_0
        //   57: invokevirtual 442	android/support/v7/internal/widget/ProgressBarICS:b	()V
        //   60: goto -15 -> 45
        //   63: astore_2
        //   64: aload_0
        //   65: monitorexit
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/internal/widget/ProgressBarICS.class
