...
class ak
    ...
    ak(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        this(paramContext, paramAttributeSet, paramInt, -1);
    }

    ak(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2) {
        ...
        for (; ; ) {
            ...
            continue;
            paramContext = new ao(this, paramContext, paramAttributeSet, paramInt1);
    ...
    public void a(SpinnerAdapter paramSpinnerAdapter) {
        ...
        if (this.F != null) {
            this.F.a(new an(paramSpinnerAdapter));
            return;
        }
        this.G = new an(paramSpinnerAdapter);
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/internal/widget/ak.class
