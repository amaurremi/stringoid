...
public class u {
    ...
    private int j() {
        ...
        if (this.e == null) {
            ...
            if (!this.A) {
                bool1 = true;
                this.e = new x((Context) localObject2, bool1);
                if (this.q != null) {
    ...
    public void g(int paramInt) {
        ...
        if ((f()) && (localx != null)) {
            x.a(localx, false);
            localx.setSelection(paramInt);
            if (localx.getChoiceMode() != 0) {
                localx.setItemChecked(paramInt, true);
            }
        }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/internal/widget/u.class
