...
class q
    ...
    public q(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap) {
        super(paramContext, h.abc_search_dropdown_item_icons_2line, null, true);
    ...
    private Drawable a(String paramString) {
        ...
        for (; ; ) {
            ...
            try {
                ...
                if (localDrawable == null) {
                    localObject1 = this.m.getResources().getDrawable(i);
    ...
    private CharSequence b(CharSequence paramCharSequence) {
        if (this.q == null) {
            ...
            this.d.getTheme().resolveAttribute(c.textColorSearchUrl, (TypedValue) localObject, true);
            this.q = this.d.getResources().getColorStateList(((TypedValue) localObject).resourceId);
        }
        Object localObject = new SpannableString(paramCharSequence);
        ((SpannableString) localObject).setSpan(new TextAppearanceSpan(null, 0, 0, this.q, null), 0, paramCharSequence.length(), 33);
    ...
    public View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup) {
        ...
        paramContext.setTag(new r(paramContext));
        return paramContext;
    }
    ...
    public void a(View paramView, Context paramContext, Cursor paramCursor) {
        paramContext = (r) paramView.getTag();
        if (this.w != -1) {
        }
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        try {
            ...
            if (paramViewGroup != null) {
                ((r) paramViewGroup.getTag()).a.setText(paramView.toString());
            }
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/android/support/v7/widget/q.class
