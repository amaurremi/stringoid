...
public final class GooglePlayServicesUtil {
    ...
    public static void D(Context paramContext) {
        ...
        if (i != 0) {
            ...
            throw new g(i, "Google Play Services not available", paramContext);
        }
    }
    ...
    private static Dialog a(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener) {
        ...
        for (Object localObject1 = new AlertDialog.Builder(paramActivity, 5); ; localObject1 = null) {
            ...
            for (paramFragment = new d(paramActivity, paramOnCancelListener, paramInt2); ; paramFragment = new d(paramFragment, paramOnCancelListener, paramInt2)) {
            ...
            return null;
            return ((AlertDialog.Builder) localObject2).create();
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_google_play_services_install_title).create();
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_google_play_services_enable_title).create();
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_google_play_services_update_title).create();
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_android_wear_update_title).create();
            Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_google_play_services_unsupported_title).create();
            Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_google_play_services_network_error_title).create();
            Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
            return ((AlertDialog.Builder) localObject2).create();
            Log.e("GooglePlayServicesUtil", "Developer error occurred. Please see logs for detailed information");
            return ((AlertDialog.Builder) localObject2).create();
            Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
            return ((AlertDialog.Builder) localObject2).setTitle(c.common_google_play_services_invalid_account_title).create();
    ...
    public static boolean a(Resources paramResources) {
        ...
        for (; ; ) {
            ...
            for (int i = 1; ((py.a()) && (i != 0)) || (b(paramResources)); i = 0) {
                return true;
            }
        }
    }
    ...
    private static byte[] a(PackageInfo paramPackageInfo, boolean paramBoolean) {
        ...
        for (paramPackageInfo = k.a(); paramPackageInfo.contains(arrayOfByte); paramPackageInfo = k.b()) {
            return arrayOfByte;
        }
    ...
    public static boolean b(PackageManager paramPackageManager) {
        synchronized (Ig) {
            ...
            try {
                if (a(paramPackageManager.getPackageInfo("com.google.android.gms", 64), new byte[][]{k.s[1]}) != null) {
                }
                for (If = 1; If != 0; If = 0) {
                    return true;
                }
    ...
    public static boolean c(PackageManager paramPackageManager) {
        return (b(paramPackageManager)) || (!gb());
    }
    ...
    public static String d(Context paramContext, int paramInt) {
        ...
        switch (paramInt) {
            default:
                return localResources.getString(c.common_google_play_services_unknown_issue);
            case 1:
                if (a(paramContext.getResources())) {
                    return localResources.getString(c.common_google_play_services_install_text_tablet);
                }
                return localResources.getString(c.common_google_play_services_install_text_phone);
            case 3:
                return localResources.getString(c.common_google_play_services_enable_text);
            case 2:
                return localResources.getString(c.common_google_play_services_update_text);
            case 42:
                return localResources.getString(c.common_android_wear_update_text);
            case 9:
                return localResources.getString(c.common_google_play_services_unsupported_text);
            case 7:
                return localResources.getString(c.common_google_play_services_network_error_text);
        }
        return localResources.getString(c.common_google_play_services_invalid_account_text);
    }
    ...
    public static String f(Context paramContext, int paramInt) {
        ...
        switch (paramInt) {
            default:
                return paramContext.getString(c.common_google_play_services_unknown_issue);
            case 1:
                return paramContext.getString(c.common_google_play_services_notification_needs_installation_title);
            case 2:
                return paramContext.getString(c.common_google_play_services_notification_needs_update_title);
            case 42:
                return paramContext.getString(c.common_android_wear_notification_needs_update_text);
            case 3:
                return paramContext.getString(c.common_google_play_services_needs_enabling_title);
            case 9:
                return paramContext.getString(c.common_google_play_services_unsupported_text);
            case 7:
    ...
    public static int isGooglePlayServicesAvailable(Context paramContext) {
        ...
        for (; ; ) {
            try {
                ...
                try {
                    ...
                    if (!pp.c(localPackageInfo1.versionCode)) {
                        break label208;
                    }
                    if (!gb()) {
                        break label111;
                    ...
                    i = 0;
                    if (a(localPackageInfo1, new byte[][]{k.a[i], k.f[i]}) != null) {
                        break;
                    }
        ...
        label208:
        if (pp.a(paramContext)) {
            if (a(localThrowable, k.a) == null) {
            ...
            try {
                ...
                paramContext = a(paramContext, k.a);
                if (paramContext == null) {
        ...
        label310:
        int i = pp.a(6111000);
        if (pp.a(localThrowable.versionCode) < i) {
            Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 6111000 but found " + localThrowable.versionCode);
            return 2;
        }
        try {
    ...
    public static boolean showErrorDialogFragment(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener) {
        ...
        try {
            boolean bool = paramActivity instanceof android.support.v4.app.k;
            i = bool;
        ...
        if (i != 0) {
            paramActivity = ((android.support.v4.app.k) paramActivity).f();
            h.a(paramFragment, paramOnCancelListener).a(paramActivity, "GooglePlayServicesErrorDialog");
        }
        for (; ; ) {
            return true;
            if (!py.a()) {
            ...
            b.a(paramFragment, paramOnCancelListener).show(paramActivity, "GooglePlayServicesErrorDialog");
        }
        throw new RuntimeException("This Activity does not support Fragments.");
    }

    public static void showErrorNotification(int paramInt, Context paramContext) {
        boolean bool = pp.a(paramContext);
        int i = paramInt;
        if (bool) {
            i = paramInt;
            if (paramInt == 2) {
        ...
        String str2 = ((Resources) localObject).getString(c.common_google_play_services_error_notification_requested_by_msg, new Object[]{F(paramContext)});
        PendingIntent localPendingIntent = getErrorPendingIntent(i, paramContext, 0);
        if (bool) {
            ag.a(py.d());
            localObject = new Notification.Builder(paramContext).setSmallIcon(com.google.android.gms.b.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new Notification.BigTextStyle().bigText(str1 + " " + str2)).addAction(com.google.android.gms.b.common_full_open_on_phone, ((Resources) localObject).getString(c.common_open_on_phone), localPendingIntent).build();
        }
        for (; ; ) {
            ((NotificationManager) paramContext.getSystemService("notification")).notify(39789, (Notification) localObject);
            return;
            localObject = new Notification(17301642, ((Resources) localObject).getString(c.common_google_play_services_notification_ticker), System.currentTimeMillis());
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/google/android/gms/common/GooglePlayServicesUtil.class
