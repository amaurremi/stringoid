...
public final class Gson {
    ...
    private final ThreadLocal<Map<TypeToken<?>, l<?>>> calls = new ThreadLocal();
    private final ConstructorConstructor constructorConstructor;
    final JsonDeserializationContext deserializationContext = new g(this);
    private final List<TypeAdapterFactory> factories;
    private final boolean generateNonExecutableJson;
    private final boolean htmlSafe;
    private final boolean prettyPrinting;
    final JsonSerializationContext serializationContext = new h(this);
    ...
    public <T> T fromJson(JsonReader paramJsonReader, Type paramType) {
        ...
        //   1: istore_3
        //   2: aload_1
        //   3: invokevirtual 407	com/google/gson/stream/JsonReader:isLenient	()Z
        //   6: istore 4
        //   8: aload_1
        //   9: iconst_1
        //   10: invokevirtual 410	com/google/gson/stream/JsonReader:setLenient	(Z)V
        //   13: aload_1
        //   14: invokevirtual 284	com/google/gson/stream/JsonReader:peek	()Lcom/google/gson/stream/JsonToken;
        //   17: pop
        //   18: iconst_0
        //   19: istore_3
        //   20: aload_0
        //   21: aload_2
        //   22: invokestatic 416	com/google/gson/reflect/TypeToken:get	(Ljava/lang/reflect/Type;)Lcom/google/gson/reflect/TypeToken;
        //   25: invokevirtual 420	com/google/gson/Gson:getAdapter	(Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/TypeAdapter;
        //   28: aload_1
        //   29: invokevirtual 426	com/google/gson/TypeAdapter:read	(Lcom/google/gson/stream/JsonReader;)Ljava/lang/Object;
        //   32: astore_2
        //   33: aload_1
        //   34: iload 4
        //   36: invokevirtual 410	com/google/gson/stream/JsonReader:setLenient	(Z)V
        //   39: aload_2
        //   40: areturn
        //   41: astore_2
        //   42: iload_3
        ...
        //   46: aload_1
        //   47: iload 4
        //   49: invokevirtual 410	com/google/gson/stream/JsonReader:setLenient	(Z)V
        //   52: aconst_null
        //   53: areturn
        //   54: new 299	com/google/gson/JsonSyntaxException
        //   57: dup
        //   58: aload_2
        //   59: invokespecial 302	com/google/gson/JsonSyntaxException:<init>	(Ljava/lang/Throwable;)V
        //   62: athrow
        //   63: astore_2
        //   64: aload_1
        //   65: iload 4
        //   67: invokevirtual 410	com/google/gson/stream/JsonReader:setLenient	(Z)V
        //   70: aload_2
        //   71: athrow
        //   72: astore_2
        //   73: new 299	com/google/gson/JsonSyntaxException
        //   76: dup
        //   77: aload_2
        //   78: invokespecial 302	com/google/gson/JsonSyntaxException:<init>	(Ljava/lang/Throwable;)V
        //   81: athrow
        //   82: astore_2
        //   83: new 299	com/google/gson/JsonSyntaxException
        //   86: dup
        //   87: aload_2
        //   88: invokespecial 302	com/google/gson/JsonSyntaxException:<init>	(Ljava/lang/Throwable;)V
        //   91: athrow
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> paramTypeToken) {
        ...
        for (; ; ) {
            Object localObject4 = (l) ((Map) localObject3).get(paramTypeToken);
            ...
            try {
                ...
                for (; ; ) {
                    if (localIterator.hasNext()) {
                        ...
                        if (localObject4 != null) {
                            ((l) localObject1).a((TypeAdapter) localObject4);
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/google/gson/Gson.class
