...
public class AnalyticsSQLiteHelper
    ...
    public static final String TABLE_USER_ATTRIBUTE = "attribute";
    ...
    public static final String USER_ATTRIBUTE_NAME = "attributename";
    public static final String USER_ATTRIBUTE_VALUE = "attributevalue";

    public AnalyticsSQLiteHelper(Context paramContext) {
        super(paramContext, "ltvp.db", null, 2);
    }
    ...
    public void onCreate(SQLiteDatabase paramSQLiteDatabase) {
        ...
        paramSQLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS attribute (_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, attributename VARCHAR, attributevalue VARCHAR)");
    ...
    public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2) {
        ...
        paramSQLiteDatabase.execSQL("DROP TABLE IF EXISTS attribute");
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/inmobi/commons/analytics/db/AnalyticsSQLiteHelper.class
