...
public class GoalList
    ...
    public boolean addGoal(String paramString, int paramInt1, long paramLong, int paramInt2, boolean paramBoolean) {
        ...
        if ((paramString == null) || ("".equals(paramString.trim()))) {
            Log.debug("[InMobi]-[AdTracker]-4.5.1", "GoalName is null");
            return false;
        }
        if ((paramInt1 < 1) || (paramLong < 0L)) {
            Log.internal("[InMobi]-[AdTracker]-4.5.1", "GoalCount cant be 0 or RetryTime cannot be negative");
            return false;
        }
        for (; ; ) {
            try {
        ...
        for (; ; ) {
            ...
            try {
                if ("".equals(paramString.trim())) {
                    Log.internal("[InMobi]-[AdTracker]-4.5.1", "GoalName cannot be null");
                    return false;
                }
                ...
                Log.internal("[InMobi]-[AdTracker]-4.5.1", "Cant increase retry time", paramString);
            }
            return false;
            return true;
            label175:
    ...
    public boolean removeGoal(String paramString, int paramInt) {
        ...
        if (paramInt < 1) {
            Log.internal("[InMobi]-[AdTracker]-4.5.1", "GoalCount cannot be 0 or negative");
            return false;
        }
        Iterator localIterator = iterator();
        Goal localGoal;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/inmobi/commons/analytics/iat/impl/GoalList.class
