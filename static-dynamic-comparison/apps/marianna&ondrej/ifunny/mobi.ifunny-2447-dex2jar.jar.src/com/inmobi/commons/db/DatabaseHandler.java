...
public abstract class DatabaseHandler
    ...
    private void a(SQLiteDatabase paramSQLiteDatabase) {
        ...
        try {
            ...
            Log.internal("[InMobi]-4.5.1", "Exception creating table", paramSQLiteDatabase);
        }
        ...
        for (Object localObject1 = ((StringBuilder) localObject2).substring(0, ((StringBuilder) localObject2).length() - 2); ; localObject1 = ((StringBuilder) localObject2).toString()) {
            ...
            Log.internal("[InMobi]-4.5.1", "Table: " + (String) localObject1);
    ...
    public void close() {
        try {
            ...
            Log.internal("[InMobi]-4.5.1", "Failed to close  db", localException);
        }
    }
    ...
    public int delete(String paramString1, String paramString2, String[] paramArrayOfString) {
        try {
            ...
            for (; ; ) {
                Log.internal("[InMobi]-4.5.1", "Failed to insert to db", paramString1);
                int m = -1;
            }
        } finally {
        }
    ...
    public Cursor executeQuery(String paramString, String[] paramArrayOfString) {
        try {
            ...
            for (; ; ) {
                Log.internal("[InMobi]-4.5.1", "Failed to execute db query", paramString);
                paramString = null;
            }
        } finally {
        }
    ...
    public Cursor getAll(String paramString1, String paramString2) {
        ...
        for (; ; ) {
            try {
                ...
                Log.internal("[InMobi]-4.5.1", "Failed to all rows", paramString1);
    ...
    public int getNoOfRows(String paramString1, String paramString2, String[] paramArrayOfString) {
        ...
        for (; ; ) {
            try {
                ...
                Log.internal("[InMobi]-4.5.1", "Failed to get number of rows", paramString1);
                int m = 0;
                continue;
            } finally {
            }
    ...
    protected int getTableSize(String paramString) {
        try {
            ...
            for (; ; ) {
                Log.internal("[InMobi]-4.5.1", "Failed to table size ", paramString);
                int m = 0;
            }
        } finally {
        }
    ...
    public long insert(String paramString, ContentValues paramContentValues) {
        try {
            ...
            for (; ; ) {
                Log.internal("[InMobi]-4.5.1", "Failed to insert to db", paramString);
                long l1 = -1L;
            }
        } finally {
        }
    ...
    public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2) {
        try {
            ...
            Log.internal("[InMobi]-4.5.1", "Exception Deleting table", paramSQLiteDatabase);
            return;
        }
    }
    ...
    public void open() {
        try {
            ...
            Log.internal("[InMobi]-4.5.1", "Failed to open  db", localException);
        }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/inmobi/commons/db/DatabaseHandler.class
