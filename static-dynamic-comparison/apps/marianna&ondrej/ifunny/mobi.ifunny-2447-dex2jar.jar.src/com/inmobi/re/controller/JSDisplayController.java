...
public class JSDisplayController
    ...
    private JSController.ExpandProperties a(JSController.ExpandProperties paramExpandProperties) {
        ...
        int i = DeviceInfo.getDisplayRotation((Display) localObject);
        int j = i;
        if (DeviceInfo.isDefOrientationLandscape(i, k, m)) {
            j = i + 1;
            i = j;
            if (j > 3) {
                i = 0;
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "Device current rotation: " + j);
        Log.debug("[InMobi]-[RE]-4.5.1", "Density of device: " + this.b);
        ...
        for (paramExpandProperties.portraitHeightRequested = paramExpandProperties.height; ; paramExpandProperties.portraitHeightRequested = paramExpandProperties.width) {
            Log.debug("[InMobi]-[RE]-4.5.1", "Device Width: " + k + " Device height: " + m);
            ...
            if (paramExpandProperties.y < 0) {
                ...
                Log.debug("[InMobi]-[RE]-4.5.1", "topStuff: " + paramExpandProperties.topStuff + " ,bottomStuff: " + paramExpandProperties.bottomStuff);
            }
            Log.debug("[InMobi]-[RE]-4.5.1", "loc 0: " + localObject[0] + " loc 1: " + localObject[1]);
            ...
            Log.debug("[InMobi]-[RE]-4.5.1", "final expanded width after density : " + paramExpandProperties.width + "final expanded height after density " + paramExpandProperties.height + "portrait width requested :" + paramExpandProperties.portraitWidthRequested + "portrait height requested :" + paramExpandProperties.portraitHeightRequested);
    ...
    public void close() {
        ...
        try {
            ...
            Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> close");
            ...
            if (this.imWebView.isExpanded()) {
                localActivity = this.imWebView.getExpandedActivity();
            }
            ...
            Log.internal("[InMobi]-[RE]-4.5.1", "Exception while closing the ad. ", localException);
        }
    }

    @JavascriptInterface
    public void disableCloseRegion(boolean paramBoolean) {
        this.imWebView.setDisableCloseRegion(paramBoolean);
    }
    ...
    public void expand(String paramString) {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> expand: url: " + paramString);
        try {
            if ((this.imWebView.getStateVariable() == IMWebView.ViewState.EXPANDED) || (this.imWebView.getStateVariable() == IMWebView.ViewState.EXPANDING)) {
                Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> Already expanded state");
                return;
            }
            if (this.imWebView.getStateVariable() == IMWebView.ViewState.HIDDEN) {
                Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> Expand cannot be called in hidden state. Doing nothing.");
                return;
            }
        } catch (Exception paramString) {
            Log.debug("[InMobi]-[RE]-4.5.1", "Exception while expanding the ad. ", paramString);
            return;
        }
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> At the time of expand the properties are: Expandable width: " + this.temporaryexpProps.width + " Expandable height: " + this.temporaryexpProps.height + " Expandable orientation: " + this.temporaryexpProps.orientation + " Expandable lock orientation: " + this.temporaryexpProps.lockOrientation + " Expandable Modality: " + this.temporaryexpProps.isModal + " Expandable Use custom close " + this.temporaryexpProps.useCustomClose);
        ...
        for (this.imWebView.mExpandController.orientationValueForExpand = this.c.forceOrientation; ; this.imWebView.mExpandController.orientationValueForExpand = this.temporaryexpProps.orientation) {
            this.imWebView.expand(paramString, a(this.temporaryexpProps));
            return;
            localObject = this.imWebView.mExpandController;
            if (!this.temporaryexpProps.lockOrientation) {
                bool = true;
            }
            ((MRAIDExpandController) localObject).lockOrientationValueForExpand = bool;
        }
    }
    ...
    public String getExpandProperties() {
        ...
        try {
            ...
            for (; ; ) {
                Log.debug("[InMobi]-[RE]-4.5.1", "Failed to get expand props");
            }
        }
    }
    ...
    public String getOrientation() {
        ...
        try {
            ...
            Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> getOrientation: " + str);
            return str;
        } catch (Exception localException) {
            Log.debug("[InMobi]-[RE]-4.5.1", "Error getOrientation: " + "-1", localException);
        }
        return "-1";
    }
    ...
    public String getOrientationProperties() {
        ...
        try {
            ...
            for (; ; ) {
                Log.debug("[InMobi]-[RE]-4.5.1", "Failed to get orientation props");
            }
        }
    }
    ...
    public String getPlacementType() {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> getPlacementType");
    ...
    public String getResizeProperties() {
        ...
        try {
            ...
            for (; ; ) {
                Log.debug("[InMobi]-[RE]-4.5.1", "Failed to get resize properties");
            }
        }
    }
    ...
    public String getState() {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> getState");
    ...
    public boolean isViewable() {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> isViewable" + this.imWebView.isViewable());
    ...
    public void open(String paramString) {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> open: url: " + paramString);
    ...
    public void resize() {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> resize");
        try {
            if (this.imWebView.getStateVariable() == IMWebView.ViewState.RESIZING) {
                Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> Already resize state");
                return;
            }
            if (this.imWebView.getStateVariable() == IMWebView.ViewState.HIDDEN) {
                Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> Resize cannot be called in hidden state. Doing nothing.");
                return;
            }
        } catch (Exception localException) {
            Log.debug("[InMobi]-[RE]-4.5.1", "Exception while expanding the ad. ", localException);
            return;
        }
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> At the time of resize the properties are: Resize width: " + localResizeProperties.width + " Resize height: " + localResizeProperties.height + " Resize offsetX: " + localResizeProperties.offsetX + " Resize offsetY: " + localResizeProperties.offsetY + " customClosePosition: " + localResizeProperties.customClosePosition + " allowOffscreen: " + localResizeProperties.allowOffscreen);
    ...
    public void setExpandProperties(String paramString) {
        ...
        try {
            ...
            Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> ExpandProperties is set: Expandable Width: " + this.expProps.width + " Expandable height: " + this.expProps.height + " Expandable orientation: " + this.expProps.orientation + " Expandable lock orientation: " + this.expProps.lockOrientation + " Expandable Modality: " + this.expProps.isModal + " Expandable Use Custom close: " + this.expProps.useCustomClose);
            this.imWebView.setCustomClose(this.expProps.useCustomClose);
            if (this.d == null) {
                paramString = this.imWebView;
                if (this.expProps.lockOrientation) {
                    break label213;
                }
            }
            label213:
            for (boolean bool = true; ; bool = false) {
                paramString.setOrientationPropertiesForInterstitial(bool, this.expProps.orientation);
                return;
            }
            return;
        } catch (Exception paramString) {
            Log.debug("[InMobi]-[RE]-4.5.1", "Exception while setting the expand properties " + paramString);
        }
    }
    ...
    public void setOrientationProperties(String paramString) {
        ...
        try {
            ...
            Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> OrientationProperties is set: Expandable orientation: " + this.expProps.orientation + " Expandable lock orientation: " + this.expProps.lockOrientation);
    ...
    public void setResizeProperties(String paramString) {
        ...
        try {
            ...
            Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> ResizeProperties is set: Resize Width: " + this.d.width + " Resize height: " + this.d.height + " Resize offsetX: " + this.d.offsetX + " Resize offsetY: " + this.d.offsetY + " customClosePosition: " + this.d.customClosePosition + " allowOffscreen: " + this.d.allowOffscreen);
            return;
        } catch (Exception paramString) {
            Log.debug("[InMobi]-[RE]-4.5.1", "Exception while setting the expand properties " + paramString);
        }
    ...
    public void useCustomClose(boolean paramBoolean) {
        ...
        Log.debug("[InMobi]-[RE]-4.5.1", "JSDisplayController-> useCustomClose" + paramBoolean);
        this.imWebView.setCustomClose(paramBoolean);
    }
}


/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/com/inmobi/re/controller/JSDisplayController.class
