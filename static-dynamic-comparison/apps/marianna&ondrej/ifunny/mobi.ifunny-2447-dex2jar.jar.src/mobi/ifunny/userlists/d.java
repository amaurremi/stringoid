...
public class d
    ...
    protected void a(int paramInt) {
        String str = r.b(getResources(), 2131623948, 2131690179, paramInt);
        a().a(str);
    }
    ...
    protected <K extends ContentAdapterFragment<User, SubscriptionsUserFeed>> boolean a(String paramString1, String paramString2, String paramString3, RestHttpHandler<SubscriptionsUserFeed, K> paramRestHttpHandler) {
        IFunnyRestRequest.Subscriptions.getSubscriptions(this, paramString3, this.b, o(), paramString1, paramString2, paramRestHttpHandler);
        return true;
    }
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        if (paramBundle == null) {
            mobi.ifunny.b.g.a(getActivity(), "Subscriptions");
            return;
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/mobi/ifunny/userlists/d.class
