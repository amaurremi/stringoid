...
public class t
    ...
    public t(al paramal, Class<? extends aj> paramClass) {
        try {
            this.a = paramClass.getConstructor(new Class[]{aj.class});
            this.a.newInstance(new Object[]{new b(paramal)});
            return;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/org/b/d/t.class
