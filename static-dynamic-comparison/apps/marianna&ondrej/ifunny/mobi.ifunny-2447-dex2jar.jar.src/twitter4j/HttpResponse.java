...
public abstract class HttpResponse {
    ...
    public JSONArray asJSONArray() {
        ...
        //   33: astore_1
        //   34: aload_0
        //   35: invokevirtual 75	twitter4j/HttpResponse:asReader	()Ljava/io/Reader;
        //   38: astore_3
        //   39: aload_3
        //   40: astore_2
        //   41: aload_3
        //   42: astore_1
        //   43: aload_0
        //   44: new 77	twitter4j/JSONArray
        //   47: dup
        //   48: new 79	twitter4j/JSONTokener
        //   51: dup
        //   52: aload_3
        //   53: invokespecial 82	twitter4j/JSONTokener:<init>	(Ljava/io/Reader;)V
        //   56: invokespecial 85	twitter4j/JSONArray:<init>	(Ltwitter4j/JSONTokener;)V
        ...
        //   89: iconst_1
        //   90: invokevirtual 95	twitter4j/JSONArray:toString	(I)Ljava/lang/String;
        //   93: invokevirtual 99	twitter4j/Logger:debug	(Ljava/lang/String;)V
        //   96: aload_3
        //   97: ifnull +7 -> 104
        //   100: aload_3
        //   101: invokevirtual 104	java/io/Reader:close	()V
        //   104: aload_0
        //   105: invokespecial 106	twitter4j/HttpResponse:disconnectForcibly	()V
        //   108: aload_0
        ...
        //   118: astore_1
        //   119: aload_0
        //   120: new 77	twitter4j/JSONArray
        //   123: dup
        //   124: aload_0
        //   125: getfield 38	twitter4j/HttpResponse:responseAsString	Ljava/lang/String;
        //   128: invokespecial 108	twitter4j/JSONArray:<init>	(Ljava/lang/String;)V
        ...
        //   143: invokevirtual 111	twitter4j/Logger:isDebugEnabled	()Z
        //   146: ifeq +118 -> 264
        //   149: aload_2
        //   150: astore_1
        //   151: new 113	twitter4j/TwitterException
        //   154: dup
        ...
        //   191: ifnull +7 -> 198
        //   194: aload_1
        //   195: invokevirtual 104	java/io/Reader:close	()V
        //   198: aload_0
        //   199: invokespecial 106	twitter4j/HttpResponse:disconnectForcibly	()V
        //   202: aload_2
        //   203: athrow
        //   204: aload_3
        //   205: astore_2
        ...
        //   238: aload 5
        //   240: aload 4
        //   242: invokevirtual 99	twitter4j/Logger:debug	(Ljava/lang/String;)V
        //   245: goto -149 -> 96
        //   248: aload_3
        //   249: astore_2
        //   250: aload_3
        ...
        //   264: aload_2
        //   265: astore_1
        //   266: new 113	twitter4j/TwitterException
        //   269: dup
        //   270: aload_3
    ...
    public JSONObject asJSONObject() {
        ...
        //   42: astore_1
        //   43: aload_0
        //   44: new 136	twitter4j/JSONObject
        //   47: dup
        //   48: new 79	twitter4j/JSONTokener
        //   51: dup
        //   52: aload_3
        //   53: invokespecial 82	twitter4j/JSONTokener:<init>	(Ljava/io/Reader;)V
        //   56: invokespecial 137	twitter4j/JSONObject:<init>	(Ltwitter4j/JSONTokener;)V
        ...
        //   89: iconst_1
        //   90: invokevirtual 138	twitter4j/JSONObject:toString	(I)Ljava/lang/String;
        //   93: invokevirtual 99	twitter4j/Logger:debug	(Ljava/lang/String;)V
        //   96: aload_3
        //   97: ifnull +7 -> 104
        //   100: aload_3
        ...
        //   118: astore_1
        //   119: aload_0
        //   120: new 136	twitter4j/JSONObject
        //   123: dup
        //   124: aload_0
        //   125: getfield 38	twitter4j/HttpResponse:responseAsString	Ljava/lang/String;
        //   128: invokespecial 139	twitter4j/JSONObject:<init>	(Ljava/lang/String;)V
        ...
        //   147: aload_2
        //   148: astore_1
        //   149: new 113	twitter4j/TwitterException
        //   152: dup
        //   153: aload_3
        ...
        //   164: ifnull +7 -> 171
        //   167: aload_1
        //   168: invokevirtual 104	java/io/Reader:close	()V
        //   171: aload_0
        //   172: invokespecial 106	twitter4j/HttpResponse:disconnectForcibly	()V
        //   175: aload_2
        //   176: athrow
        //   177: aload_3
        //   178: astore_2
        ...
        //   211: aload 5
        //   213: aload 4
        //   215: invokevirtual 99	twitter4j/Logger:debug	(Ljava/lang/String;)V
        //   218: goto -122 -> 96
        //   221: aload_3
        //   222: astore_2
        //   223: aload_3
        ...
        //   229: invokevirtual 140	twitter4j/JSONObject:toString	()Ljava/lang/String;
        //   232: astore 4
        //   234: goto -27 -> 207
        //   237: aload_2
        //   238: astore_1
        //   239: new 113	twitter4j/TwitterException
        //   242: dup
    ...
    public String asString() {
        ...
        //   4: ifnonnull +186 -> 190
        //   7: aload_0
        //   8: invokevirtual 167	twitter4j/HttpResponse:asStream	()Ljava/io/InputStream;
        //   11: astore_1
        //   12: aload_1
        //   13: ifnonnull +29 -> 42
        //   16: aload_1
        //   17: ifnull +7 -> 24
        //   20: aload_1
        //   21: invokevirtual 170	java/io/InputStream:close	()V
        //   24: iconst_0
        //   25: ifeq +11 -> 36
        //   28: new 172	java/lang/NullPointerException
        //   31: dup
        //   32: invokespecial 173	java/lang/NullPointerException:<init>	()V
        //   35: athrow
        //   36: aload_0
        //   37: invokespecial 106	twitter4j/HttpResponse:disconnectForcibly	()V
        //   40: aconst_null
        //   41: areturn
        //   42: new 144	java/io/BufferedReader
        //   45: dup
        //   46: new 146	java/io/InputStreamReader
        //   49: dup
        //   50: aload_1
        //   51: ldc -106
        //   53: invokespecial 153	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
        //   56: invokespecial 154	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
        //   59: astore_3
        //   60: new 115	java/lang/StringBuilder
        //   63: dup
        //   64: invokespecial 116	java/lang/StringBuilder:<init>	()V
        //   67: astore 4
        //   69: aload_3
        ...
        //   97: aload 4
        //   99: astore_3
        //   100: new 113	twitter4j/TwitterException
        //   103: dup
        //   104: aload_3
        //   105: invokevirtual 179	java/io/IOException:getMessage	()Ljava/lang/String;
        //   108: aload_3
        //   109: invokespecial 131	twitter4j/TwitterException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   112: athrow
        //   113: astore 4
        //   115: aload_2
        //   116: astore_3
        ...
        //   121: ifnull +7 -> 128
        //   124: aload_1
        //   125: invokevirtual 170	java/io/InputStream:close	()V
        //   128: aload_3
        //   129: ifnull +7 -> 136
        //   132: aload_3
        //   133: invokevirtual 180	java/io/BufferedReader:close	()V
        //   136: aload_0
        //   137: invokespecial 106	twitter4j/HttpResponse:disconnectForcibly	()V
        //   140: aload_2
        //   141: athrow
        //   142: aload_0
        //   143: aload 4
        //   145: invokevirtual 128	java/lang/StringBuilder:toString	()Ljava/lang/String;
        //   148: putfield 38	twitter4j/HttpResponse:responseAsString	Ljava/lang/String;
        //   151: getstatic 32	twitter4j/HttpResponse:logger	Ltwitter4j/Logger;
        //   154: aload_0
        //   155: getfield 38	twitter4j/HttpResponse:responseAsString	Ljava/lang/String;
        //   158: invokevirtual 99	twitter4j/Logger:debug	(Ljava/lang/String;)V
        //   161: aload_1
        //   162: invokevirtual 170	java/io/InputStream:close	()V
        //   165: aload_0
        //   166: iconst_1
        //   167: putfield 40	twitter4j/HttpResponse:streamConsumed	Z
        //   170: aload_1
        //   171: ifnull +7 -> 178
        //   174: aload_1
        ...
        //   179: ifnull +7 -> 186
        //   182: aload_3
        //   183: invokevirtual 180	java/io/BufferedReader:close	()V
        //   186: aload_0
        //   187: invokespecial 106	twitter4j/HttpResponse:disconnectForcibly	()V
        //   190: aload_0
        //   191: getfield 38	twitter4j/HttpResponse:responseAsString	Ljava/lang/String;
        //   194: areturn
        //   195: astore_1
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/twitter4j/HttpResponse.class
