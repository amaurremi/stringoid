...
public final class OEmbedRequest
    ...
    HttpParameter[] asHttpParameterArray() {
        ...
        if (this.related.length > 0) {
            appendParameter("related", StringUtil.join(this.related), localArrayList);
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/twitter4j/OEmbedRequest.class
