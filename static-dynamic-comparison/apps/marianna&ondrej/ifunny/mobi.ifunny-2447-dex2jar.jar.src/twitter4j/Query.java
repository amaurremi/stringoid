...
public final class Query
    ...
    public static final Query.Unit KILOMETERS = Query.Unit.km;
    public static final Query.Unit MILES = Query.Unit.mi;
    public static final Query.ResultType MIXED = Query.ResultType.mixed;
    public static final Query.ResultType POPULAR = Query.ResultType.popular;
    public static final Query.ResultType RECENT = Query.ResultType.recent;
    ...
    static Query createWithNextPageQuery(String paramString) {
    ...
    HttpParameter[] asHttpParameterArray() {
        ...
        if (this.resultType != null) {
            localArrayList.add(new HttpParameter("result_type", this.resultType.name()));
        }
    ...
    public Query resultType(Query.ResultType paramResultType) {
        setResultType(paramResultType);
        return this;
    }
    ...
    public void setGeoCode(GeoLocation paramGeoLocation, double paramDouble, Query.Unit paramUnit) {
        this.geocode = (paramGeoLocation.getLatitude() + "," + paramGeoLocation.getLongitude() + "," + paramDouble + paramUnit.name());
    }
    ...
    public void setResultType(Query.ResultType paramResultType) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/twitter4j/Query.class
