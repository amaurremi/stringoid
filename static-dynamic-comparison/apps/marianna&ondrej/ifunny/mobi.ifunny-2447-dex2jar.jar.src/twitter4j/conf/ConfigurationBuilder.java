...
public final class ConfigurationBuilder {
    ...
    public ConfigurationBuilder setDaemonEnabled(boolean paramBoolean) {
        checkNotBuilt();
        this.configurationBean.setDaemonEnabled(paramBoolean);
        return this;
    }
    ...
    public ConfigurationBuilder setIncludeEntitiesEnabled(boolean paramBoolean) {
        checkNotBuilt();
        this.configurationBean.setIncludeEntitiesEnabled(paramBoolean);
        return this;
    }
    ...
    public ConfigurationBuilder setOAuth2Scope(String paramString) {
        checkNotBuilt();
        this.configurationBean.setOAuth2Scope(paramString);
        return this;
    }
    ...
    public ConfigurationBuilder setUserStreamWithFollowingsEnabled(boolean paramBoolean) {
        checkNotBuilt();
        this.configurationBean.setUserStreamWithFollowingsEnabled(paramBoolean);
        return this;
    }
}


/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/ifunny/mobi.ifunny-2447-dex2jar.jar!/twitter4j/conf/ConfigurationBuilder.class
