...
public final class AdUtil
{
  ...
  {
    return String.format(Locale.US, "role: 6 producer: 24 historical_role: 1 historical_producer: 12 timestamp: %d latlng < latitude_e7: %d longitude_e7: %d> radius: %d", new Object[] { Long.valueOf(paramLocation.getTime() * 1000L), Long.valueOf((paramLocation.getLatitude() * 1.0E7D)), Long.valueOf((paramLocation.getLongitude() * 1.0E7D)), Long.valueOf((paramLocation.getAccuracy() * 1000.0F)) });
  }
  ...
  public static String i(Context paramContext)
  {
    if (i == null)
    {
      ...
      i = paramContext + " (Mobile; " + "afma-sdk-a-v" + "6.2.1" + ")";
    }
    return i;
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/paper toss/com.bfs.papertoss-7005-dex2jar.jar!/com/google/ads/util/AdUtil.class
