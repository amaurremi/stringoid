    ...
    extends HandlerThread
  {
      ...
      implements Runnable
    {
      ...
      public void run()
      {
        ...
        //   20: invokevirtual 68	java/util/LinkedList:size	()I
        //   23: ifle +133 -> 156
        //   26: lconst_0
        //   27: lstore_2
        //   28: aload_0
        ...
        //   32: invokestatic 252	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$500	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)I
        //   35: sipush 500
        //   38: if_icmpeq +16 -> 54
        //   41: aload_0
        ...
        //   45: invokestatic 252	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$500	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)I
        //   48: sipush 503
        //   51: if_icmpne +78 -> 129
        //   54: invokestatic 258	java/lang/Math:random	()D
        //   57: aload_0
        ...
        //   61: invokestatic 262	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$600	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)J
        //   64: l2d
        //   65: dmul
        //   66: d2l
        //   67: lstore 4
        ...
        //   76: invokestatic 262	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$600	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)J
        //   79: ldc2_w 263
        //   82: lcmp
        //   83: ifge +17 -> 100
        //   86: aload_0
        ...
        //   90: ldc2_w 265
        //   93: invokestatic 270	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$630	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;J)J
        //   96: pop2
        //   97: lload 4
        //   99: lstore_2
        //   100: lload_2
        //   101: ldc2_w 271
        //   104: lmul
        //   105: invokestatic 278	java/lang/Thread:sleep	(J)V
        //   108: aload_0
        //   109: aload_0
        ...
        //   113: invokestatic 116	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$700	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)Lcom/google/android/apps/analytics/NetworkDispatcher;
        //   116: invokevirtual 281	com/google/android/apps/analytics/NetworkDispatcher:isDryRun	()Z
        //   119: invokespecial 283	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread$AsyncDispatchTask:dispatchSomePendingHits	(Z)V
        //   122: iload_1
        //   123: iconst_1
        //   124: iadd
        //   125: istore_1
        ...
        //   133: ldc2_w 265
        //   136: invokestatic 286	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$602	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;J)J
        //   139: pop2
        //   140: goto -40 -> 100
        //   143: astore 6
        //   145: ldc 56
        //   147: ldc_w 288
        //   150: aload 6
        //   152: invokestatic 291	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
        //   155: pop
        //   156: aload_0
        ...
        //   160: invokestatic 226	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$800	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)Lcom/google/android/apps/analytics/PipelinedRequester;
        //   163: invokevirtual 294	com/google/android/apps/analytics/PipelinedRequester:finishedCurrentRequests	()V
        //   166: aload_0
        ...
        //   170: invokestatic 298	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$900	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;)Lcom/google/android/apps/analytics/Dispatcher$Callbacks;
        //   173: invokeinterface 303 1 0
        //   178: aload_0
        ...
        //   182: aconst_null
        //   183: invokestatic 249	com/google/android/apps/analytics/NetworkDispatcher$DispatcherThread:access$402	(Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread;Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread$AsyncDispatchTask;)Lcom/google/android/apps/analytics/NetworkDispatcher$DispatcherThread$AsyncDispatchTask;
        //   186: pop
        //   187: return
        //   188: astore 6
        //   190: ldc 56
        //   192: ldc_w 305
        //   195: aload 6
        //   197: invokestatic 291	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
        //   200: pop
        //   201: goto -45 -> 156
        //   204: astore 6
        //   206: ldc 56
        //   208: ldc_w 307
        //   211: aload 6
        //   213: invokestatic 291	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
        //   216: pop
        //   217: goto -61 -> 156
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/paper toss/com.bfs.papertoss-7005-dex2jar.jar!/com/google/android/apps/analytics/NetworkDispatcher.class
