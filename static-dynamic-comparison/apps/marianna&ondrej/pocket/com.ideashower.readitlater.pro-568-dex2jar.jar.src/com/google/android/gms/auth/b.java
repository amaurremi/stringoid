...
public final class b
{
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, android.os.Bundle paramBundle)
  {
    ...
    //   4: astore 5
    //   6: ldc 75
    //   8: invokestatic 80	com/google/android/gms/internal/an:a	(Ljava/lang/String;)V
    //   11: aload 5
    //   13: invokestatic 83	com/google/android/gms/auth/b:a	(Landroid/content/Context;)V
    //   16: aload_3
    ...
    //   43: aload_3
    //   44: getstatic 29	com/google/android/gms/auth/b:b	Ljava/lang/String;
    //   47: invokevirtual 104	android/os/Bundle:containsKey	(Ljava/lang/String;)Z
    //   50: ifne +11 -> 61
    //   53: aload_3
    //   54: getstatic 29	com/google/android/gms/auth/b:b	Ljava/lang/String;
    //   57: aload_0
    //   58: invokevirtual 100	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: new 106	com/google/android/gms/common/i
    //   64: dup
    //   65: invokespecial 107	com/google/android/gms/common/i:<init>	()V
    //   68: astore_0
    //   69: aload 5
    //   71: getstatic 59	com/google/android/gms/auth/b:e	Landroid/content/Intent;
    //   74: aload_0
    //   75: iconst_1
    //   76: invokevirtual 111	android/content/Context:bindService	(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    //   79: ifeq +156 -> 235
    //   82: aload_0
    //   83: invokevirtual 114	com/google/android/gms/common/i:a	()Landroid/os/IBinder;
    //   86: invokestatic 119	com/google/android/gms/internal/cn:a	(Landroid/os/IBinder;)Lcom/google/android/gms/internal/cm;
    //   89: aload_1
    //   90: aload_2
    //   91: aload_3
    ...
    //   152: astore_1
    //   153: aload_2
    //   154: invokestatic 153	com/google/android/gms/auth/b:b	(Ljava/lang/String;)Z
    //   157: ifeq +42 -> 199
    //   160: new 155	com/google/android/gms/auth/e
    //   163: dup
    //   164: aload_2
    //   165: aload_1
    //   166: invokespecial 158	com/google/android/gms/auth/e:<init>	(Ljava/lang/String;Landroid/content/Intent;)V
    //   169: athrow
    //   170: astore_1
    //   171: ldc -96
    //   173: ldc -94
    ...
    //   198: athrow
    //   199: aload_2
    //   200: invokestatic 176	com/google/android/gms/auth/b:a	(Ljava/lang/String;)Z
    //   203: ifeq +23 -> 226
    ...
    //   214: athrow
    //   215: astore_1
    //   216: new 178	com/google/android/gms/auth/a
    //   219: dup
    //   220: ldc -76
    //   222: invokespecial 181	com/google/android/gms/auth/a:<init>	(Ljava/lang/String;)V
    //   225: athrow
    //   226: new 178	com/google/android/gms/auth/a
    //   229: dup
    //   230: aload_2
    //   231: invokespecial 181	com/google/android/gms/auth/a:<init>	(Ljava/lang/String;)V
    //   234: athrow
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/com/google/android/gms/auth/b.class
