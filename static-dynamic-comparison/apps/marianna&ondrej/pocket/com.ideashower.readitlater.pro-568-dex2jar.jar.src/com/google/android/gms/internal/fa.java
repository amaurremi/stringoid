  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      if (this.g != ((fa)paramObject).g) {
        return false;
      }
      if (this.e != ((fa)paramObject).e) {
        return false;
      }
      if (this.f != ((fa)paramObject).f) {
        return false;
      }
    } while (this.d == ((fa)paramObject).d);
    return false;
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/com/google/android/gms/internal/fa.class
