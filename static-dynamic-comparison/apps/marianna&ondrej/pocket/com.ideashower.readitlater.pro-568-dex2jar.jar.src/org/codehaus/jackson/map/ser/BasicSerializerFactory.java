  ...
  extends SerializerFactory
{
  ...
  protected static JavaType modifySecondaryTypesByAnnotation(SerializationConfig paramSerializationConfig, Annotated paramAnnotated, JavaType paramJavaType)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 250	org/codehaus/jackson/map/SerializationConfig:getAnnotationIntrospector	()Lorg/codehaus/jackson/map/AnnotationIntrospector;
    //   4: astore 4
    //   6: aload_2
    //   7: astore_3
    //   8: aload_2
    //   9: invokevirtual 279	org/codehaus/jackson/type/JavaType:isContainerType	()Z
    //   12: ifeq +93 -> 105
    //   15: aload 4
    //   17: aload_1
    //   18: aload_2
    //   19: invokevirtual 283	org/codehaus/jackson/type/JavaType:getKeyType	()Lorg/codehaus/jackson/type/JavaType;
    //   22: invokevirtual 287	org/codehaus/jackson/map/AnnotationIntrospector:findSerializationKeyType	(Lorg/codehaus/jackson/map/introspect/Annotated;Lorg/codehaus/jackson/type/JavaType;)Ljava/lang/Class;
    //   25: astore_3
    //   26: aload_2
    //   27: astore_0
    //   28: aload_3
    ...
    //   33: instanceof 289
    //   36: ifne +37 -> 73
    //   39: new 274	java/lang/IllegalArgumentException
    //   42: dup
    //   43: new 46	java/lang/StringBuilder
    //   46: dup
    ...
    //   56: aload_2
    //   57: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   60: ldc_w 296
    ...
    //   69: invokespecial 297	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   72: athrow
    //   73: aload_2
    //   74: checkcast 289	org/codehaus/jackson/map/type/MapType
    //   77: aload_3
    //   78: invokevirtual 301	org/codehaus/jackson/map/type/MapType:widenKey	(Ljava/lang/Class;)Lorg/codehaus/jackson/type/JavaType;
    //   81: astore_0
    //   82: aload 4
    //   84: aload_1
    //   85: aload_0
    //   86: invokevirtual 304	org/codehaus/jackson/type/JavaType:getContentType	()Lorg/codehaus/jackson/type/JavaType;
    //   89: invokevirtual 307	org/codehaus/jackson/map/AnnotationIntrospector:findSerializationContentType	(Lorg/codehaus/jackson/map/introspect/Annotated;Lorg/codehaus/jackson/type/JavaType;)Ljava/lang/Class;
    //   92: astore_1
    //   93: aload_0
    //   94: astore_3
    //   95: aload_1
    ...
    //   99: aload_0
    //   100: aload_1
    //   101: invokevirtual 310	org/codehaus/jackson/type/JavaType:widenContentsBy	(Ljava/lang/Class;)Lorg/codehaus/jackson/type/JavaType;
    //   104: astore_3
    //   105: aload_3
    //   106: areturn
    //   107: astore_0
    //   108: new 274	java/lang/IllegalArgumentException
    //   111: dup
    ...
    //   125: aload_2
    //   126: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   129: ldc_w 314
    //   132: invokevirtual 176	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   135: aload_3
    //   136: invokevirtual 29	java/lang/Class:getName	()Ljava/lang/String;
    ...
    //   148: aload_0
    //   149: invokevirtual 319	java/lang/IllegalArgumentException:getMessage	()Ljava/lang/String;
    ...
    //   158: invokespecial 297	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   161: athrow
    //   162: astore_2
    //   163: new 274	java/lang/IllegalArgumentException
    //   166: dup
    ...
    //   180: aload_0
    //   181: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   184: ldc_w 323
    //   187: invokevirtual 176	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   190: aload_1
    //   191: invokevirtual 29	java/lang/Class:getName	()Ljava/lang/String;
    ...
    //   203: aload_2
    //   204: invokevirtual 319	java/lang/IllegalArgumentException:getMessage	()Ljava/lang/String;
    ...
    //   213: invokespecial 297	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   216: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	217	0	paramSerializationConfig	SerializationConfig
    //   0	217	1	paramAnnotated	Annotated
    //   0	217	2	paramJavaType	JavaType
  ...
  public JsonSerializer buildContainerSerializer(SerializationConfig paramSerializationConfig, JavaType paramJavaType, BasicBeanDescription paramBasicBeanDescription, BeanProperty paramBeanProperty, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramJavaType.isMapLikeType())
      {
        ...
        {
          return buildMapSerializer(paramSerializationConfig, (MapType)paramJavaType, paramBasicBeanDescription, paramBeanProperty, paramBoolean, localJsonSerializer2, localTypeSerializer, localJsonSerializer1);
          if (!paramBoolean) {
        ...
        {
          return buildMapLikeSerializer(paramSerializationConfig, paramJavaType, paramBasicBeanDescription, paramBeanProperty, paramBoolean, localJsonSerializer2, localTypeSerializer, localJsonSerializer1);
        }
      }
      else
      {
        if (paramJavaType.isCollectionLikeType())
        {
          ...
          if (paramJavaType.isTrueCollectionType()) {
            return buildCollectionSerializer(paramSerializationConfig, (CollectionType)paramJavaType, paramBasicBeanDescription, paramBeanProperty, paramBoolean, localTypeSerializer, localJsonSerializer1);
          }
          return buildCollectionLikeSerializer(paramSerializationConfig, paramJavaType, paramBasicBeanDescription, paramBeanProperty, paramBoolean, localTypeSerializer, localJsonSerializer1);
        }
  ...
  {
    Object localObject = ((BasicBeanDescription)paramSerializationConfig.introspectClassAnnotations(paramJavaType.getRawClass())).getClassInfo();
    AnnotationIntrospector localAnnotationIntrospector = paramSerializationConfig.getAnnotationIntrospector();
    ...
    return localTypeResolverBuilder.buildTypeSerializer(paramSerializationConfig, paramJavaType, (Collection)localObject, paramBeanProperty);
  }
  ...
  protected JavaType modifyTypeByAnnotation(SerializationConfig paramSerializationConfig, Annotated paramAnnotated, JavaType paramJavaType)
  {
    ...
    try
    {
      localJavaType = paramJavaType.widenBy(localClass);
      return modifySecondaryTypesByAnnotation(paramSerializationConfig, paramAnnotated, localJavaType);
    }
    catch (IllegalArgumentException paramSerializationConfig)
    {
      throw new IllegalArgumentException("Failed to widen type " + paramJavaType + " with concrete-type annotation (value " + localClass.getName() + "), method '" + paramAnnotated.getName() + "': " + paramSerializationConfig.getMessage());
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/org/codehaus/jackson/map/ser/BasicSerializerFactory.class
