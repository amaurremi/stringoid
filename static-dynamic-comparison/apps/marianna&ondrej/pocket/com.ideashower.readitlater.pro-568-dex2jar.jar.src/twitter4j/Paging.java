  ...
  implements Serializable
{
  ...
  private void addPostParameter(char[] paramArrayOfChar, char paramChar, List paramList, String paramString, long paramLong)
  {
    int k = 0;
  ...
  List asPostParameterList(char[] paramArrayOfChar)
  {
    return asPostParameterList(paramArrayOfChar, "count");
  }
  
  List asPostParameterList(char[] paramArrayOfChar, String paramString)
  {
    ArrayList localArrayList = new ArrayList(paramArrayOfChar.length);
    addPostParameter(paramArrayOfChar, 's', localArrayList, "since_id", getSinceId());
    addPostParameter(paramArrayOfChar, 'm', localArrayList, "max_id", getMaxId());
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/Paging.class
