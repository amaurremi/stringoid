  ...
  extends ViewGroup
{
  ...
  private static final i cB = new i();
  ...
  private void a(int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int i = (int)(Math.max(this.bW, Math.min(localb.cH, this.bX)) * f);; i = 0)
    {
      ...
      {
        a(i, 0, paramInt2);
        if ((paramBoolean2) && (this.cv != null)) {
          this.cv.g(paramInt1);
        }
        if ((paramBoolean2) && (this.cw != null)) {
          this.cw.g(paramInt1);
        }
        return;
      }
  ...
  protected void a(int paramInt1, float paramFloat, int paramInt2)
  {
    ...
    if (this.cv != null) {
      this.cv.a(paramInt1, paramFloat, paramInt2);
    }
    if (this.cw != null) {
      this.cw.a(paramInt1, paramFloat, paramInt2);
    }
    if (this.cy != null)
    {
      ...
      if (paramInt1 < i)
      {
        ...
        for (;;)
        {
          ...
          this.cy.a(localView, paramFloat);
        }
      }
    }
    this.ct = true;
  ...
  public void a(l paraml)
  {
    if (this.bL != null)
    {
      this.bL.unregisterDataSetObserver(this.bR);
      this.bL.startUpdate(this);
      int i = 0;
      while (i < this.mItems.size())
      {
    ...
    if (this.bL != null)
    {
      ...
      this.bL.registerDataSetObserver(this.bR);
      this.cb = false;
      bool = this.cr;
      this.cr = true;
    ...
    for (;;)
    {
      if ((this.cx != null) && (localObject != paraml)) {
        this.cx.b((l)localObject, paraml);
      }
      return;
      label260:
      if (!bool) {
  ...
  b c(int paramInt1, int paramInt2)
  {
    b localb = new b();
  ...
  void l(int paramInt)
  {
    ...
    for (int j = i;; j = 2)
    {
      ...
      for (;;)
      {
        ...
        for (Object localObject3 = c(this.bM, paramInt);; localObject3 = localObject1)
        {
          int n;
          label344:
          int i4;
          ...
          for (float f2 = 0.0F;; f2 = getPaddingRight() / i4 + 2.0F)
          {
            ...
            while (paramInt < i)
            {
              ...
              {
                localObject2 = j((View)localObject2);
          ...
          for (;;)
          {
            ...
            if (localObject1 != null) {}
            for (localObject1 = k((View)localObject1);; localObject1 = null)
            {
    ...
    extends View.BaseSavedState
  {
    public static final Parcelable.Creator<SavedState> CREATOR = android.support.v4.a.a.a(new b()
    {
      ...
      public ViewPager.SavedState[] o(int paramAnonymousInt)
      {
    ...
    extends ViewGroup.LayoutParams
  {
    ...
    public c(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, ViewPager.N());
    ...
    extends a
  {
    ...
    public void onInitializeAccessibilityEvent(View paramView, AccessibilityEvent paramAccessibilityEvent)
    {
      ...
      {
        paramView.setItemCount(ViewPager.a(ViewPager.this).getCount());
        paramView.setFromIndex(ViewPager.b(ViewPager.this));
        paramView.setToIndex(ViewPager.b(ViewPager.this));
      }
    }
    ...
    public boolean performAccessibilityAction(View paramView, int paramInt, Bundle paramBundle)
    {
      ...
      case 4096: 
        if (ViewPager.this.canScrollHorizontally(1))
        {
          ViewPager.this.j(ViewPager.b(ViewPager.this) + 1);
          return true;
        }
        return false;
      }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/view/ViewPager.class
