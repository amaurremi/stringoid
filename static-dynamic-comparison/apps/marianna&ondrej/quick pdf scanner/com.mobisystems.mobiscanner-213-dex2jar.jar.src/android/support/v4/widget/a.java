  ...
  implements b.a, Filterable
{
  ...
  void init(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    for (this.mDataSetObserver = new b(null);; this.mDataSetObserver = null)
    {
      if (bool)
      {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/widget/a.class
