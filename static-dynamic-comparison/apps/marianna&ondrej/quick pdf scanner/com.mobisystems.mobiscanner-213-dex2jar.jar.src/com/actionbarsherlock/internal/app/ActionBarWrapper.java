  ...
  implements android.app.ActionBar.OnMenuVisibilityListener, android.app.ActionBar.OnNavigationListener
{
  ...
  public ActionBarWrapper(Activity paramActivity)
  {
    ...
    if (this.mActionBar != null)
    {
      ...
      int i = this.mActionBar.getDisplayOptions();
      paramActivity = this.mActionBar;
      if ((i & 0x4) == 0) {
        break label71;
      }
    }
    ...
    implements android.app.ActionBar.TabListener
  {
    ...
    public void onTabReselected(android.app.ActionBar.Tab paramTab, android.app.FragmentTransaction paramFragmentTransaction)
    {
      if (this.mListener != null)
      {
        ...
        if ((ActionBarWrapper.this.mActivity instanceof FragmentActivity)) {
          paramTab = ((FragmentActivity)ActionBarWrapper.this.mActivity).getSupportFragmentManager().beginTransaction().disallowAddToBackStack();
        }
        this.mListener.onTabReselected(this, paramTab);
    ...
    public void onTabSelected(android.app.ActionBar.Tab paramTab, android.app.FragmentTransaction paramFragmentTransaction)
    {
      if (this.mListener != null)
      {
        if ((ActionBarWrapper.this.mFragmentTransaction == null) && ((ActionBarWrapper.this.mActivity instanceof FragmentActivity))) {
          ActionBarWrapper.access$102(ActionBarWrapper.this, ((FragmentActivity)ActionBarWrapper.this.mActivity).getSupportFragmentManager().beginTransaction().disallowAddToBackStack());
        }
    ...
    public void onTabUnselected(android.app.ActionBar.Tab paramTab, android.app.FragmentTransaction paramFragmentTransaction)
    {
      if (this.mListener != null)
      {
        ...
        this.mListener.onTabUnselected(this, paramTab);
      }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/actionbarsherlock/internal/app/ActionBarWrapper.class
