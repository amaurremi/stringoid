  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mInitialActivityCount = paramAttributeSet.getInt(1, 4);
    ...
    this.mListPopupMaxWidth = Math.max(paramContext.getDisplayMetrics().widthPixels / 2, paramContext.getDimensionPixelSize(R.dimen.abs__config_prefDialogWidth));
  }
    ...
    extends BaseAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      case 1: 
        ...
        {
          localObject = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abs__activity_chooser_view_list_item, paramViewGroup, false);
          ((View)localObject).setId(1);
          ((TextView)((View)localObject).findViewById(R.id.abs__title)).setText(ActivityChooserView.this.mContext.getString(R.string.abs__activity_chooser_view_see_all));
        }
        break;
      }
      View localView;
      do
      {
        ...
        {
          localView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abs__activity_chooser_view_list_item, paramViewGroup, false);
        }
      ...
      } while (!ActivityChooserView.IS_HONEYCOMB);
    ...
    implements View.OnClickListener, View.OnLongClickListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener
  {
    ...
    public void onClick(View paramView)
    {
      if (paramView == ActivityChooserView.this.mDefaultActivityButton)
      {
        ...
        if (paramView != null) {
          ActivityChooserView.this.mContext.startActivity(paramView);
        }
        return;
      }
    ...
    public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
    {
      ...
      for (;;)
      {
        ...
        ActivityChooserView.this.mContext.startActivity(paramAdapterView);
        return;
        paramInt += 1;
      }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/actionbarsherlock/widget/ActivityChooserView.class
