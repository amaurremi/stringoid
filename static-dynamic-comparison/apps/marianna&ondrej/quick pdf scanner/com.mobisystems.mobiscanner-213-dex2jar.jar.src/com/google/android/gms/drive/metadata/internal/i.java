  ...
  extends a<String>
{
  ...
  public static final Collection<String> au(String paramString)
  {
    if (paramString == null) {
      return null;
    }
  ...
  protected Collection<String> a(DataHolder paramDataHolder, int paramInt1, int paramInt2)
  {
    try
    {
      paramDataHolder = au(paramDataHolder.c(getName(), paramInt1, paramInt2));
  ...
  protected Collection<String> h(Bundle paramBundle)
  {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/google/android/gms/drive/metadata/internal/i.class
