...
public final class gk
{
  private static void a(String paramString, Object paramObject, StringBuffer paramStringBuffer1, StringBuffer paramStringBuffer2)
  {
    ...
    if ((paramObject instanceof gj))
    {
      ...
      if (paramString != null)
      {
        paramStringBuffer2.append(paramStringBuffer1).append(bd(paramString)).append(" <\n");
  ...
  public static <T extends gj> String d(T paramT)
  {
    if (paramT == null) {
      return "";
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/google/android/gms/internal/gk.class
