...
{
  private final go Qk;
  private final SecureRandom Tp;
  
  public p(go paramgo, SecureRandom paramSecureRandom)
  {
    this.Qk = paramgo;
    this.Tp = paramSecureRandom;
  }
  
  static void g(byte[] paramArrayOfByte)
  {
    int i = 0;
  ...
  public byte[] bf(String paramString)
  {
    try
    {
      paramString = this.Qk.d(paramString, false);
  ...
  public byte[] c(byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      arrayOfByte = this.Qk.d(paramString, false);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/google/android/gms/internal/p.class
