  ...
  extends FrameLayout
{
  public PlusOneDummyView(Context paramContext, int paramInt)
  {
    ...
    paramContext.setBackgroundDrawable(vs().getDrawable(paramInt));
    Point localPoint = eg(paramInt);
    addView(paramContext, new FrameLayout.LayoutParams(localPoint.x, localPoint.y, 17));
  }
  
  private Point eg(int paramInt)
  {
    int j = 24;
    int i = 20;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/google/android/gms/plus/PlusOneDummyView.class
