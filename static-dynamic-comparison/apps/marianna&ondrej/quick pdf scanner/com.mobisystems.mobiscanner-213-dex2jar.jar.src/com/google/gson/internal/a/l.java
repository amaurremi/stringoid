  ...
  extends m<Time>
{
  public static final n afz = new n()
  {
    ...
    {
      if (paramAnonymousa.zZ() == Time.class) {
        return new l();
      }
      return null;
    }
  };
  private final DateFormat agf = new SimpleDateFormat("hh:mm:ss a");
  
  public void a(b paramb, Time paramTime)
  {
    if (paramTime == null) {}
    for (paramTime = null;; paramTime = this.agf.format(paramTime)) {
      try
      {
        paramb.cM(paramTime);
        return;
  ...
  /* Error */
  public Time l(com.google.gson.stream.a parama)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   20: aload_1
    //   21: areturn
    //   22: new 33	java/sql/Time
    //   25: dup
    //   26: aload_0
    //   27: getfield 29	com/google/gson/internal/a/l:agf	Ljava/text/DateFormat;
    //   30: aload_1
    ...
    //   40: invokespecial 88	java/sql/Time:<init>	(J)V
    //   43: astore_1
    //   44: goto -26 -> 18
    //   47: astore_1
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/google/gson/internal/a/l.class
