...
public class i
{
  public static boolean a(PublicKey paramPublicKey, String paramString1, String paramString2)
  {
    try
    {
      ...
      if (!localSignature.verify(a.dq(paramString2)))
      {
  ...
  public static boolean b(String paramString1, String paramString2, String paramString3)
  {
    ...
    return a(dy(paramString1), paramString2, paramString3);
  }
  
  public static PublicKey dy(String paramString)
  {
    try
    {
      paramString = a.dq(paramString);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/mobisystems/mobiscanner/common/util/i.class
