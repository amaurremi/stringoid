                ...
                Request localRequest = Request.newMeRequest(localSession, new Request.GraphUserCallback() {
                    public void onCompleted(GraphUser paramAnonymousGraphUser, Response paramAnonymousResponse) {
                        if (localSession == UserSettingsFragment.this.getSession()) {
                            UserSettingsFragment.this.user = paramAnonymousGraphUser;
    ...
    private void updateUI() {
        ...
        if (isSessionOpen()) {
            ...
            if (this.user != null) {
                ...
                if (localObject != null) {
                    URL localURL = ((ImageRequest) localObject).getImageUrl();
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/facebook/widget/UserSettingsFragment.class
