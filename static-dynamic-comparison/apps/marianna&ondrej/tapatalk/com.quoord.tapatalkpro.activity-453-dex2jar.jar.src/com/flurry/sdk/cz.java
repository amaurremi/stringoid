    ...
    public Map<String, List<String>> a(String paramString) {
        ...
        if (i < j) {
            ...
            if (localObject2.length != 2) {
                eo.a(5, a, "Invalid referrer Element: " + localObject1[i] + " in referrer tag " + paramString);
            }
            for (; ; ) {
                i += 1;
                break;
        ...
        while (paramString.hasNext()) {
            ...
            eo.a(3, a, "entry: " + (String) ((Map.Entry) localObject1).getKey() + "=" + ((Map.Entry) localObject1).getValue());
        }
        ...
        if (paramString.length() > 0) {
            eo.a(5, a, "Detected missing referrer keys : " + paramString.toString());
        }
        return localHashMap;
    }
}
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/flurry/sdk/cz.class
