...
public class ga {
    ...
    static class a {
        private final gb.a a = this.c.a();
        private final gb.a b = this.d.a();
        private final gb c = new gb(new byte[0], 0, 0);
        private final gb d = new gb(new byte[0], 0, 0);
    }

    static class b {
        private final gb.a a = this.b.a();
        private final gb b = new gb(new byte[0], 0, 0);
    }
}


/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/flurry/sdk/ga.class
