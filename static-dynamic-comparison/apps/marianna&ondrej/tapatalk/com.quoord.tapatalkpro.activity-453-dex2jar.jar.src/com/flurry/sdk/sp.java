...
public final class sp {
    ...
    public void a(char paramChar) {
        ...
        if (this.j >= arrayOfChar2.length) {
            d(1);
            arrayOfChar1 = this.i;
        }
        int m = this.j;
        this.j = (m + 1);
        arrayOfChar1[m] = paramChar;
    }
    ...
    public void a(String paramString, int paramInt1, int paramInt2) {
        ...
        int m = paramInt2;
        if (i1 > 0) {
            paramString.getChars(paramInt1, paramInt1 + i1, arrayOfChar, this.j);
            m = paramInt2 - i1;
            n = paramInt1 + i1;
        }
        d(m);
        paramString.getChars(n, n + m, this.i, 0);
        this.j = m;
    }
    ...
    public char[] n() {
        ...
        for (int m = 262145; ; m = Math.min(262144, (n >> 1) + n)) {
            this.i = e(m);
            System.arraycopy(arrayOfChar, 0, this.i, 0, n);
            return this.i;
        }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/flurry/sdk/sp.class
