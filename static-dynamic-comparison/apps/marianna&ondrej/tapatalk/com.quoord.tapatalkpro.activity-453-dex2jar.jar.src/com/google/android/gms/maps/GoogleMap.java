...
public final class GoogleMap {
    ...
    protected GoogleMap(IGoogleMapDelegate paramIGoogleMapDelegate) {
        this.Rp = ((IGoogleMapDelegate) fq.f(paramIGoogleMapDelegate));
    }

    public final Circle addCircle(CircleOptions paramCircleOptions) {
        try {
            paramCircleOptions = new Circle(this.Rp.addCircle(paramCircleOptions));
    ...
    public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions) {
        try {
            paramGroundOverlayOptions = this.Rp.addGroundOverlay(paramGroundOverlayOptions);
    ...
    public final Marker addMarker(MarkerOptions paramMarkerOptions) {
        try {
            paramMarkerOptions = this.Rp.addMarker(paramMarkerOptions);
    ...
    public final Polygon addPolygon(PolygonOptions paramPolygonOptions) {
        try {
            paramPolygonOptions = new Polygon(this.Rp.addPolygon(paramPolygonOptions));
    ...
    public final Polyline addPolyline(PolylineOptions paramPolylineOptions) {
        try {
            paramPolylineOptions = new Polyline(this.Rp.addPolyline(paramPolylineOptions));
    ...
    public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions) {
        try {
            paramTileOverlayOptions = this.Rp.addTileOverlay(paramTileOverlayOptions);
    ...
    public final void animateCamera(CameraUpdate paramCameraUpdate) {
        try {
            this.Rp.animateCamera(paramCameraUpdate.id());
            return;
    ...
    public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback) {
        // Byte code:
        //   0: aload_0
        //   1: getfield 104	com/google/android/gms/maps/GoogleMap:Rp	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
        //   4: astore 4
        //   6: aload_1
        //   7: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:id	()Lcom/google/android/gms/dynamic/d;
        //   10: astore 5
        //   12: aload_3
        //   13: ifnonnull +17 -> 30
        //   16: aconst_null
    ...
    public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback) {
        ...
        //   4: astore_3
        //   5: aload_1
        //   6: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:id	()Lcom/google/android/gms/dynamic/d;
        //   9: astore 4
        //   11: aload_2
        //   12: ifnonnull +15 -> 27
        //   15: aconst_null
    ...
    public final CameraPosition getCameraPosition() {
        try {
            CameraPosition localCameraPosition = this.Rp.getCameraPosition();
    ...
    public IndoorBuilding getFocusedBuilding() {
        try {
            Object localObject = this.Rp.getFocusedBuilding();
            if (localObject != null) {
    ...
    public final float getMaxZoomLevel() {
        try {
            float f = this.Rp.getMaxZoomLevel();
            return f;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final float getMinZoomLevel() {
        try {
            float f = this.Rp.getMinZoomLevel();
            return f;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final Location getMyLocation() {
        try {
            Location localLocation = this.Rp.getMyLocation();
    ...
    public final Projection getProjection() {
        try {
            Projection localProjection = new Projection(this.Rp.getProjection());
    ...
    public final UiSettings getUiSettings() {
        try {
            ...
            UiSettings localUiSettings = this.Rq;
    ...
    IGoogleMapDelegate jdMethod_if() {
        return this.Rp;
    }

    public final boolean isBuildingsEnabled() {
        try {
            boolean bool = this.Rp.isBuildingsEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final boolean isIndoorEnabled() {
        try {
            boolean bool = this.Rp.isIndoorEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final boolean isMyLocationEnabled() {
        try {
            boolean bool = this.Rp.isMyLocationEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final boolean isTrafficEnabled() {
        try {
            boolean bool = this.Rp.isTrafficEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final void moveCamera(CameraUpdate paramCameraUpdate) {
        try {
            this.Rp.moveCamera(paramCameraUpdate.id());
            return;
        } catch (RemoteException paramCameraUpdate) {
            throw new RuntimeRemoteException(paramCameraUpdate);
        }
    ...
    public final void setBuildingsEnabled(boolean paramBoolean) {
        try {
            this.Rp.setBuildingsEnabled(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final boolean setIndoorEnabled(boolean paramBoolean) {
        try {
            paramBoolean = this.Rp.setIndoorEnabled(paramBoolean);
            return paramBoolean;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
            ...
            public void activate(final h paramAnonymoush) {
                paramLocationSource.activate(new LocationSource.OnLocationChangedListener() {
                    public void onLocationChanged(Location paramAnonymous2Location) {
                        try {
                            paramAnonymoush.j(e.h(paramAnonymous2Location));
                            return;
    ...
    public final void setMyLocationEnabled(boolean paramBoolean) {
        try {
            this.Rp.setMyLocationEnabled(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final void setOnMyLocationChangeListener(final OnMyLocationChangeListener paramOnMyLocationChangeListener) {
        ...
        this.Rp.setOnMyLocationChangeListener(new o.a() {
            public void e(com.google.android.gms.dynamic.d paramAnonymousd) {
                paramOnMyLocationChangeListener.onMyLocationChange((Location) e.d(paramAnonymousd));
            }
        });
    }
    ...
    public final void setPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        try {
            this.Rp.setPadding(paramInt1, paramInt2, paramInt3, paramInt4);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public final void setTrafficEnabled(boolean paramBoolean) {
        try {
            this.Rp.setTrafficEnabled(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
            ...
            try {
                this.Rp.snapshot(new s.a() {
                    public void f(com.google.android.gms.dynamic.d paramAnonymousd)
                            throws RemoteException {
                        paramSnapshotReadyCallback.onSnapshotReady((Bitmap) e.d(paramAnonymousd));
                    }
    ...
    private static final class a
            extends b.a {
        private final GoogleMap.CancelableCallback RH;

        a(GoogleMap.CancelableCallback paramCancelableCallback) {
            this.RH = paramCancelableCallback;
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/google/android/gms/maps/GoogleMap.class
