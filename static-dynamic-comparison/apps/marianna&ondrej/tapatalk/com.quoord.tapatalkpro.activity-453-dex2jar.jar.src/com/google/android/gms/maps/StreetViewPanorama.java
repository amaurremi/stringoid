...
public class StreetViewPanorama {
    ...
    protected StreetViewPanorama(IStreetViewPanoramaDelegate paramIStreetViewPanoramaDelegate) {
        this.Sd = ((IStreetViewPanoramaDelegate) fq.f(paramIStreetViewPanoramaDelegate));
    }

    public void animateTo(StreetViewPanoramaCamera paramStreetViewPanoramaCamera, long paramLong) {
        try {
            this.Sd.animateTo(paramStreetViewPanoramaCamera, paramLong);
            return;
    ...
    public StreetViewPanoramaLocation getLocation() {
        try {
            StreetViewPanoramaLocation localStreetViewPanoramaLocation = this.Sd.getStreetViewPanoramaLocation();
    ...
    public StreetViewPanoramaCamera getPanoramaCamera() {
        try {
            StreetViewPanoramaCamera localStreetViewPanoramaCamera = this.Sd.getPanoramaCamera();
    ...
    public boolean isPanningGesturesEnabled() {
        try {
            boolean bool = this.Sd.isPanningGesturesEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public boolean isStreetNamesEnabled() {
        try {
            boolean bool = this.Sd.isStreetNamesEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public boolean isUserNavigationEnabled() {
        try {
            boolean bool = this.Sd.isUserNavigationEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public boolean isZoomGesturesEnabled() {
        try {
            boolean bool = this.Sd.isZoomGesturesEnabled();
            return bool;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public Point orientationToPoint(StreetViewPanoramaOrientation paramStreetViewPanoramaOrientation) {
        try {
            paramStreetViewPanoramaOrientation = (Point) e.d(this.Sd.orientationToPoint(paramStreetViewPanoramaOrientation));
    ...
    public StreetViewPanoramaOrientation pointToOrientation(Point paramPoint) {
        try {
            paramPoint = this.Sd.pointToOrientation(e.h(paramPoint));
            return paramPoint;
    ...
    public void setPanningGesturesEnabled(boolean paramBoolean) {
        try {
            this.Sd.enablePanning(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public void setPosition(LatLng paramLatLng) {
        try {
            this.Sd.setPosition(paramLatLng);
            return;
    ...
    public void setPosition(LatLng paramLatLng, int paramInt) {
        try {
            this.Sd.setPositionWithRadius(paramLatLng, paramInt);
            return;
        } catch (RemoteException paramLatLng) {
            throw new RuntimeRemoteException(paramLatLng);
        }
    ...
    public void setPosition(String paramString) {
        try {
            this.Sd.setPositionWithID(paramString);
            return;
    ...
    public void setStreetNamesEnabled(boolean paramBoolean) {
        try {
            this.Sd.enableStreetNames(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public void setUserNavigationEnabled(boolean paramBoolean) {
        try {
            this.Sd.enableUserNavigation(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
    ...
    public void setZoomGesturesEnabled(boolean paramBoolean) {
        try {
            this.Sd.enableZoom(paramBoolean);
            return;
        } catch (RemoteException localRemoteException) {
            throw new RuntimeRemoteException(localRemoteException);
        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/google/android/gms/maps/StreetViewPanorama.class
