...
public class ProfilesTitleAdapter
        extends BaseAdapter {
    ...
    public ProfilesTitleAdapter(Activity paramActivity, ArrayList<String> paramArrayList) {
    ...
    public View getDropDownView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        paramView = LayoutInflater.from(this.mActivity).inflate(2130903328, null);
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        paramView = LayoutInflater.from(this.mActivity).inflate(2130903327, null);
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/adapter/forum/conversation/ProfilesTitleAdapter.class
