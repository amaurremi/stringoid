...
public class LikeNotification
    ...
    public static Notification getLikeNotification(Context paramContext, TapatalkForum paramTapatalkForum, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {
        if (mList == null) {
            mList = new ArrayList();
        }
        ...
        for (paramString4 = paramString1 + " " + paramContext.getString(2131100377) + " " + paramString3; ; paramString4 = paramContext.getString(2131100377)) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/alarm/notification/LikeNotification.class
