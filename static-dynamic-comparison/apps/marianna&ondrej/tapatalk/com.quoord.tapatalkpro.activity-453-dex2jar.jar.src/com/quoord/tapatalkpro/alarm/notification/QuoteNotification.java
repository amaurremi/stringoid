...
public class QuoteNotification
    ...
    public static String ACTION = "viewquote";
    public static ArrayList<String> mList = new ArrayList();

    public static Notification getQuoteNotification(Context paramContext, TapatalkForum paramTapatalkForum, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {
        if (mList == null) {
            mList = new ArrayList();
        }
        ...
        localIntent.putExtra("viewQuote", true);
        ...
        for (paramString4 = paramString1 + " " + paramContext.getString(2131100381) + " " + paramString3; ; paramString4 = paramContext.getString(2131100381)) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/alarm/notification/QuoteNotification.class
