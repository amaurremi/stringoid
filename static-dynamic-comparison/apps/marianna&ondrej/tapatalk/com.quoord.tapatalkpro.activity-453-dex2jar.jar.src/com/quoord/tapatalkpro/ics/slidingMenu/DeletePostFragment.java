...
public class DeletePostFragment
    ...
    public static DeletePostFragment newInstance() {
        return new DeletePostFragment();
    }
    ...
    public void onActivityCreated(Bundle paramBundle) {
        ...
        this.deleteAdapter = new DeleteTopicAdapter(this.mActivity, this.forumStatus.getUrl(), this.listView, false, this);
    }
            ...
            public Dialog onCreateDialog(Bundle paramAnonymousBundle) {
                new AlertDialog.Builder(getActivity()).setMessage(2131099971).setPositiveButton(2131099792, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int) {
                        ((LatestTopicAdapter) DeletePostFragment.this.adapter).cleanDatas();
                        new MarkAllReadAdapter(DeletePostFragment.this.mActivity, DeletePostFragment.this.forumstatus.getUrl());
                    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/ics/slidingMenu/DeletePostFragment.class
