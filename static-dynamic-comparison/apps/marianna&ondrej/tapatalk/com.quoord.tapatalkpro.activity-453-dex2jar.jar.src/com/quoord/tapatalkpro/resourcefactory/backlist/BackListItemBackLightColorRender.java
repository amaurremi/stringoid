...
public class BackListItemBackLightColorRender
    ...
    public BackListItemBackLightColorRender(Context paramContext) {
    ...
    private void initBackColorProduct(Context paramContext) {
        ...
        setBackColor(paramContext.getResources().getColor(2131165531));
        setDefaultColor(paramContext.getResources().getColor(2131165531));
        if (j == 0) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/resourcefactory/backlist/BackListItemBackLightColorRender.class
