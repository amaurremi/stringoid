...
public final class StatusUpdate
    ...
    public int hashCode() {
        ...
        for (int i2 = this.mediaBody.hashCode(); ; i2 = 0) {
            ...
            return (((((((i * 31 + i4) * 31 + j) * 31 + k) * 31 + m) * 31 + n) * 31 + i1) * 31 + i2) * 31 + i3;
            i = 0;
            break;
            j = 0;
            break label51;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/StatusUpdate.class
