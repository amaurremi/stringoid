            ...
            if (j < 8) {
                ...
                for (; ; ) {
                    ...
                    if (k + 1 < paramArrayOfByte.length) {
                        i = (char) ((paramArrayOfByte[(k + 1)] & lead2byte) >>> 6 | m);
                        continue;
                        m = (char) ((char) (paramArrayOfByte[k] & last2byte) << '\004');
                        i = m;
                        if (k + 1 < paramArrayOfByte.length) {
                            i = (char) ((paramArrayOfByte[(k + 1)] & lead4byte) >>> 4 | m);
                        }
                    }
                }
            }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/internal/http/BASE64Encoder.class
