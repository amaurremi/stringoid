...
final class HTMLEntity {
    ...
    static String unescapeAndSlideEntityIncdices(String paramString, UserMentionEntity[] paramArrayOfUserMentionEntity, URLEntity[] paramArrayOfURLEntity, HashtagEntity[] paramArrayOfHashtagEntity, MediaEntity[] paramArrayOfMediaEntity) {
        ...
        if (paramArrayOfUserMentionEntity == null) {
            ...
            paramArrayOfURLEntity = paramString.substring(i, m + 1);
            ...
            i1 = 1 - paramArrayOfURLEntity.length();
            n = j;
            i = k;
            if (j < arrayOfEntityIndex.length) {
                ...
                n = j;
                i = k;
                if (arrayOfEntityIndex[j].getStart() == i1 + m) {
        ...
        for (; ; ) {
            ...
            n = j;
            i = k;
            if (arrayOfEntityIndex[j].getEnd() == i1 + m) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/internal/json/HTMLEntity.class
