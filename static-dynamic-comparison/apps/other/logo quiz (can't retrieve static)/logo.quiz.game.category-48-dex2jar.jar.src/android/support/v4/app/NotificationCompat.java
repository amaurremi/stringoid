    ...
    public Notification build(NotificationCompat.Builder paramBuilder)
    {
      ...
      for (;;)
      {
        ...
        else if ((paramBuilder.mStyle instanceof NotificationCompat.BigPictureStyle))
        {
          ...
          localNotificationCompatJellybean.addBigPictureStyle(paramBuilder.mBigContentTitle, paramBuilder.mSummaryTextSet, paramBuilder.mSummaryText, paramBuilder.mPicture);
        }
      }
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/android/support/v4/app/NotificationCompat.class
