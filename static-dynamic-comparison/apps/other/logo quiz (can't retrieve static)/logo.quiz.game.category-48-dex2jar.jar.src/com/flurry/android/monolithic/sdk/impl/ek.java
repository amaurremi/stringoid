...
public final class ek
{
  ...
  public ek(int paramInt, String paramString, Map<String, String> paramMap, long paramLong, boolean paramBoolean)
  {
    this.a = paramInt;
    this.b = paramString;
    this.c = paramMap;
  ...
  public byte[] e()
  {
    ...
    //   17: aload_1
    //   18: aload_0
    //   19: getfield 24	com/flurry/android/monolithic/sdk/impl/ek:a	I
    //   22: invokevirtual 142	java/io/DataOutputStream:writeShort	(I)V
    //   25: aload_1
    //   26: aload_0
    //   27: getfield 26	com/flurry/android/monolithic/sdk/impl/ek:b	Ljava/lang/String;
    //   30: invokevirtual 146	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   33: aload_0
    //   34: getfield 28	com/flurry/android/monolithic/sdk/impl/ek:c	Ljava/util/Map;
    //   37: ifnonnull +39 -> 76
    //   40: aload_1
    //   41: iconst_0
    ...
    //   45: aload_1
    //   46: aload_0
    //   47: getfield 30	com/flurry/android/monolithic/sdk/impl/ek:d	J
    //   50: invokevirtual 149	java/io/DataOutputStream:writeLong	(J)V
    //   53: aload_1
    //   54: aload_0
    //   55: getfield 40	com/flurry/android/monolithic/sdk/impl/ek:g	J
    ...
    //   69: astore_2
    //   70: aload_1
    //   71: invokestatic 160	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   74: aload_2
    //   75: areturn
    //   76: aload_1
    //   77: aload_0
    //   78: getfield 28	com/flurry/android/monolithic/sdk/impl/ek:c	Ljava/util/Map;
    //   81: invokeinterface 76 1 0
    //   86: invokevirtual 142	java/io/DataOutputStream:writeShort	(I)V
    //   89: aload_0
    //   90: getfield 28	com/flurry/android/monolithic/sdk/impl/ek:c	Ljava/util/Map;
    ...
    //   135: invokestatic 163	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   152: invokestatic 163	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/lang/String;)Ljava/lang/String;
    //   155: invokevirtual 146	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   158: goto -54 -> 104
    //   161: astore_2
    //   162: aload_1
    //   163: invokestatic 160	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   166: iconst_0
    ...
    //   174: astore_2
    //   175: aload_3
    //   176: invokestatic 160	com/flurry/android/monolithic/sdk/impl/je:a	(Ljava/io/Closeable;)V
    //   179: aload_2
    //   180: athrow
    //   181: astore_2
    //   182: aload_1
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/flurry/android/monolithic/sdk/impl/ek.class
