  ...
  extends ae
{
  ...
  private void ec()
  {
    this.mHandler = new Handler(this.mContext.getMainLooper(), new Handler.Callback()
    {
      ...
      {
        if ((1 == paramAnonymousMessage.what) && (q.ef().equals(paramAnonymousMessage.obj)))
        {
          t.eq().B(true);
          q.this.dispatchLocalHits();
          t.eq().B(false);
          if ((q.b(q.this) > 0) && (!q.c(q.this))) {
            q.d(q.this).sendMessageDelayed(q.d(q.this).obtainMessage(1, q.ef()), q.b(q.this) * 1000);
          }
        }
        return true;
      }
  ...
  void a(Context paramContext, f paramf)
  {
    ...
    //   54: ifeq -43 -> 11
    //   57: aload_0
    //   58: invokevirtual 131	com/google/android/gms/analytics/q:dO	()V
    //   61: aload_0
    //   62: iconst_0
  ...
  void dispatchLocalHits()
  {
    ...
    //   20: monitorexit
    //   21: return
    //   22: invokestatic 166	com/google/android/gms/analytics/t:eq	()Lcom/google/android/gms/analytics/t;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/analytics/q.class
