...
public final class MediaInfo
{
      ...
      try
      {
        ...
        default: 
          ...
          if (this.Fj != null)
          {
            ...
            {
              ((JSONArray)localObject).put(((MediaTrack)localIterator.next()).bL());
              continue;
            }
  ...
  public int hashCode()
  {
    return m.hashCode(new Object[] { this.Fe, Integer.valueOf(this.Ff), this.Fg, this.Fh, Long.valueOf(this.Fi), String.valueOf(this.Fl) });
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/cast/MediaInfo.class
