  ...
  implements Parcelable.Creator<Contents>
{
  static void a(Contents paramContents, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 2, paramContents.Kx, paramInt, false);
    b.c(paramParcel, 3, paramContents.uQ);
    b.c(paramParcel, 4, paramContents.MN);
    b.a(paramParcel, 5, paramContents.MO, paramInt, false);
    b.a(paramParcel, 7, paramContents.MP);
    b.H(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/drive/a.class
