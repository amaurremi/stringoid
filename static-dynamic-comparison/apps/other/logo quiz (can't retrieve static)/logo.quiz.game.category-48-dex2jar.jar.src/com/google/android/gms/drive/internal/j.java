  ...
  implements Parcelable.Creator<CreateFileRequest>
{
  static void a(CreateFileRequest paramCreateFileRequest, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 2, paramCreateFileRequest.Of, paramInt, false);
    b.a(paramParcel, 3, paramCreateFileRequest.Od, paramInt, false);
    b.a(paramParcel, 4, paramCreateFileRequest.NX, paramInt, false);
    b.a(paramParcel, 5, paramCreateFileRequest.Oe, false);
    b.a(paramParcel, 6, paramCreateFileRequest.Og);
    b.a(paramParcel, 7, paramCreateFileRequest.Nf, false);
    b.c(paramParcel, 8, paramCreateFileRequest.Oh);
    b.c(paramParcel, 9, paramCreateFileRequest.Oi);
    b.H(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/drive/internal/j.class
