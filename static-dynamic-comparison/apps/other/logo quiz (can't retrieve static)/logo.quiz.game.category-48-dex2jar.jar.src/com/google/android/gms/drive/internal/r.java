  ...
  implements DriveContents
{
  ...
  {
    this.Op = ((Contents)n.i(paramContents));
  }
  ...
  private PendingResult<Status> a(GoogleApiClient paramGoogleApiClient, final MetadataChangeSet paramMetadataChangeSet, final ExecutionOptions paramExecutionOptions)
  {
    ...
    if ((ExecutionOptions.aV(paramExecutionOptions.hQ())) && (!this.Op.hL())) {
    ...
    for (;;)
    {
      ...
      paramMetadataChangeSet = MetadataChangeSet.Nl;
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/drive/internal/r.class
