  ...
  implements Parcelable.Creator<DataDeleteRequest>
{
  static void a(DataDeleteRequest paramDataDeleteRequest, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramDataDeleteRequest.getStartTimeMillis());
    b.c(paramParcel, 1000, paramDataDeleteRequest.getVersionCode());
    b.a(paramParcel, 2, paramDataDeleteRequest.getEndTimeMillis());
    ...
    b.a(paramParcel, 6, paramDataDeleteRequest.iX());
    b.a(paramParcel, 7, paramDataDeleteRequest.iY());
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/request/d.class
