  ...
  implements Parcelable.Creator<DataReadRequest>
{
  static void a(DataReadRequest paramDataReadRequest, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 3, paramDataReadRequest.getStartTimeMillis());
    b.a(paramParcel, 4, paramDataReadRequest.getEndTimeMillis());
    b.c(paramParcel, 5, paramDataReadRequest.ja(), false);
    b.c(paramParcel, 6, paramDataReadRequest.jb(), false);
    b.c(paramParcel, 7, paramDataReadRequest.getBucketType());
    b.a(paramParcel, 8, paramDataReadRequest.jc());
    b.a(paramParcel, 9, paramDataReadRequest.jd(), paramInt, false);
    b.c(paramParcel, 10, paramDataReadRequest.je());
    b.a(paramParcel, 11, paramDataReadRequest.jf());
    b.a(paramParcel, 12, paramDataReadRequest.jh());
    b.a(paramParcel, 13, paramDataReadRequest.jg());
    b.H(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/request/f.class
