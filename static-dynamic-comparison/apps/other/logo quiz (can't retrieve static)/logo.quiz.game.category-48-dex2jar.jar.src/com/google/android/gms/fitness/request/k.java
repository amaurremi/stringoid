  ...
  extends IInterface
{
    ...
    implements k
  {
    ...
    public static k ay(IBinder paramIBinder)
    {
      ...
      implements k
    {
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/fitness/request/k$a$a:lb	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/request/k.class
