  ...
  implements Parcelable.Creator<FitnessSensorServiceRequest>
{
  static void a(FitnessSensorServiceRequest paramFitnessSensorServiceRequest, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 2, paramFitnessSensorServiceRequest.jq(), false);
    b.a(paramParcel, 3, paramFitnessSensorServiceRequest.getSamplingRateMicros());
    b.a(paramParcel, 4, paramFitnessSensorServiceRequest.getBatchIntervalMicros());
    b.H(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/fitness/service/a.class
