  ...
  implements TurnBasedMultiplayer
{
  ...
  {
    Games.c(paramGoogleApiClient).bv(paramString);
  }
  ...
  {
    return Games.c(paramGoogleApiClient).kd();
  }
  
  public int getMaxMatchDataSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.c(paramGoogleApiClient).kn();
  }
  ...
  {
    Games.c(paramGoogleApiClient).kg();
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/games/internal/api/TurnBasedMultiplayerImpl.class
