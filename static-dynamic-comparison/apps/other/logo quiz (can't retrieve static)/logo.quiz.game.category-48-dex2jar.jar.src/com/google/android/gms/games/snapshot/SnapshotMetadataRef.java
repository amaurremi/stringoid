  ...
  implements SnapshotMetadata
{
  ...
  public SnapshotMetadataRef(DataHolder paramDataHolder, int paramInt)
  {
    ...
    this.abm = new GameRef(paramDataHolder, paramInt);
    this.adj = new PlayerRef(paramDataHolder, paramInt);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/games/snapshot/SnapshotMetadataRef.class
