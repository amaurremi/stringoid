...
public class dc
{
  ...
  public void execute()
  {
    ...
    localBuilder.setPositiveButton(gb.c(R.string.accept, "Accept"), new DialogInterface.OnClickListener()
    {
      ...
      {
        paramAnonymousDialogInterface = dc.this.bH();
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/dc.class
