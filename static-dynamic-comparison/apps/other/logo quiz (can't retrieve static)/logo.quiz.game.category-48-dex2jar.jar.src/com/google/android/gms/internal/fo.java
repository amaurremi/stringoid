    ...
    paramah.a("/nativeAdPreProcess", new by()
    {
      public void a(gv paramAnonymousgv, Map<String, String> paramAnonymousMap)
      {
        ...
        try
        {
          ...
          {
            localgk.a(new JSONObject(paramAnonymousgv).getJSONArray("ads").getJSONObject(0));
            return;
          }
        }
        catch (JSONException paramAnonymousgv)
        {
          ...
          fo.this.s(0);
          n.a(fo.this.cI(), "Unable to set the ad state error!");
          localgk.a(null);
        }
      }
    });
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/fo.class
