  ...
  extends fm.a
{
  ...
  private static fk a(Context paramContext, final bm parambm, final ci paramci, fx paramfx, final fi paramfi)
  {
    ...
    try
    {
      paramci = (fv)localft.cL().get(10L, TimeUnit.SECONDS);
      if (paramci == null) {
        return new fk(0);
      }
    }
    ...
    catch (IOException paramContext)
    {
      try
      {
        for (;;)
        {
          ...
          if ((paramfv != null) && (!TextUtils.isEmpty(paramfv.cN())))
          {
            localHttpURLConnection.setDoOutput(true);
            localObject = paramfv.cN().getBytes();
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/fr.class
