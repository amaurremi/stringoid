  ...
  extends d<id>
{
  ...
  public ib(Context paramContext, Looper paramLooper, GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener, String paramString, String[] paramArrayOfString)
  {
    ...
    this.Dd = ((String)n.i(paramString));
  }
  ...
  {
    paramk.a(parame, 6111000, getContext().getPackageName(), this.Dd, gR());
  }
  ...
  protected void c(String... paramVarArgs)
  {
    ...
    n.a(bool, String.format("App State APIs requires %s to function.", new Object[] { "https://www.googleapis.com/auth/appstate" }));
  }
    ...
    extends ia
  {
    ...
    {
      this.De = ((BaseImplementation.b)n.b(paramb, "Result holder must not be null"));
    }
    ...
    extends ia
  {
    ...
    {
      this.De = ((BaseImplementation.b)n.b(paramb, "Holder must not be null"));
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/ib.class
