  ...
  extends IInterface
{
    ...
    implements kl
  {
    ...
    public static kl ap(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      for (paramParcel1 = (DataReadResult)DataReadResult.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
      {
        a(paramParcel1);
        return true;
      }
      ...
      implements kl
    {
        ...
        throws RemoteException
      {
        ...
        //   20: aload_2
        //   21: iconst_0
        //   22: invokevirtual 44	com/google/android/gms/fitness/result/DataReadResult:writeToParcel	(Landroid/os/Parcel;I)V
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/kl$a$a:lb	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/internal/kl.class
