  ...
  implements Parcelable.Creator<ActivityRecognitionResult>
{
  ...
  static void a(ActivityRecognitionResult paramActivityRecognitionResult, Parcel paramParcel, int paramInt)
  {
    ...
    b.c(paramParcel, 1, paramActivityRecognitionResult.adQ, false);
    b.c(paramParcel, 1000, paramActivityRecognitionResult.getVersionCode());
    b.a(paramParcel, 2, paramActivityRecognitionResult.adR);
    b.a(paramParcel, 3, paramActivityRecognitionResult.adS);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/location/ActivityRecognitionResultCreator.class
