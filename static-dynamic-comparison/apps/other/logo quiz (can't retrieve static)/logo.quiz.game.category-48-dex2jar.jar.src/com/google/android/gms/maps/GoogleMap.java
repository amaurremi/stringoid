...
public final class GoogleMap
{
  ...
  public final Circle addCircle(CircleOptions paramCircleOptions)
  {
    try
    {
      paramCircleOptions = new Circle(this.aic.addCircle(paramCircleOptions));
  ...
  public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions)
  {
    try
    {
      paramGroundOverlayOptions = this.aic.addGroundOverlay(paramGroundOverlayOptions);
  ...
  public final Marker addMarker(MarkerOptions paramMarkerOptions)
  {
    try
    {
      paramMarkerOptions = this.aic.addMarker(paramMarkerOptions);
  ...
  public final Polygon addPolygon(PolygonOptions paramPolygonOptions)
  {
    try
    {
      paramPolygonOptions = new Polygon(this.aic.addPolygon(paramPolygonOptions));
  ...
  public final Polyline addPolyline(PolylineOptions paramPolylineOptions)
  {
    try
    {
      paramPolylineOptions = new Polyline(this.aic.addPolyline(paramPolylineOptions));
  ...
  public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions)
  {
    try
    {
      paramTileOverlayOptions = this.aic.addTileOverlay(paramTileOverlayOptions);
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 104	com/google/android/gms/maps/GoogleMap:aic	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
    //   4: astore 4
    //   6: aload_1
    //   7: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:mm	()Lcom/google/android/gms/dynamic/d;
    //   10: astore 5
    //   12: aload_3
    //   13: ifnonnull +17 -> 30
    //   16: aconst_null
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback)
  {
    ...
    //   4: astore_3
    //   5: aload_1
    //   6: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:mm	()Lcom/google/android/gms/dynamic/d;
    //   9: astore 4
    //   11: aload_2
    //   12: ifnonnull +15 -> 27
    //   15: aconst_null
  ...
  public IndoorBuilding getFocusedBuilding()
  {
    try
    {
      Object localObject = this.aic.getFocusedBuilding();
      if (localObject != null)
      {
  ...
  public final boolean setIndoorEnabled(boolean paramBoolean)
  {
    try
    {
      paramBoolean = this.aic.setIndoorEnabled(paramBoolean);
      return paramBoolean;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setInfoWindowAdapter(final InfoWindowAdapter paramInfoWindowAdapter)
  {
    ...
    this.aic.setInfoWindowAdapter(new d.a()
    {
  ...
  public final void setOnCameraChangeListener(final OnCameraChangeListener paramOnCameraChangeListener)
  {
    ...
    this.aic.setOnCameraChangeListener(new e.a()
    {
  ...
  public final void setOnIndoorStateChangeListener(final OnIndoorStateChangeListener paramOnIndoorStateChangeListener)
  {
    ...
    this.aic.setOnIndoorStateChangeListener(new f.a()
    {
  ...
  public final void setOnMyLocationButtonClickListener(final OnMyLocationButtonClickListener paramOnMyLocationButtonClickListener)
  {
    ...
    this.aic.setOnMyLocationButtonClickListener(new n.a()
    {
    ...
    extends b.a
  {
    ...
    {
      this.aiu = paramCancelableCallback;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/maps/GoogleMap.class
