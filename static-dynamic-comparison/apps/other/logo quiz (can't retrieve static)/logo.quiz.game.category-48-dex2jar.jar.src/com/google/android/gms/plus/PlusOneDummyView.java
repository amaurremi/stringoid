  ...
  extends FrameLayout
{
  ...
  public PlusOneDummyView(Context paramContext, int paramInt)
  {
    ...
    paramContext.setBackgroundDrawable(mY().getDrawable(paramInt));
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/plus/PlusOneDummyView.class
