  ...
  implements bm
{
  ...
  public InputStream cA(String paramString)
    throws IOException
  {
    this.apk = cB(paramString);
    return a(this.apk);
  }
  
  HttpURLConnection cB(String paramString)
    throws IOException
  {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/tagmanager/aw.class
