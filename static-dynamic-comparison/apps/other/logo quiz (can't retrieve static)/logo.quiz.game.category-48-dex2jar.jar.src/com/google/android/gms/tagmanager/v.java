...
{
  private static final String aoF = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' STRING NOT NULL, '%s' BLOB NOT NULL, '%s' INTEGER NOT NULL);", new Object[] { "datalayer", "ID", "key", "value", "expires" });
  ...
  v(Context paramContext, ju paramju, String paramString, int paramInt, Executor paramExecutor)
  {
    ...
    this.yD = paramju;
    this.aoI = paramInt;
    this.aoG = paramExecutor;
    this.aoH = new a(this.mContext, paramString);
  }
  ...
  private SQLiteDatabase al(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.aoH.getWritableDatabase();
  ...
  private void b(List<b> paramList, long paramLong)
  {
    ...
    //   26: invokespecial 135	com/google/android/gms/tagmanager/v:ff	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    ...
    //   38: aload_0
    //   39: invokespecial 141	com/google/android/gms/tagmanager/v:oj	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 141	com/google/android/gms/tagmanager/v:oj	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  private void c(List<b> paramList, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localContentValues.put("key", localb.JH);
        localContentValues.put("value", localb.aoO);
  ...
  {
    paramInt = oi() - this.aoI + paramInt;
    if (paramInt > 0)
    {
      List localList = fg(paramInt);
  ...
  /* Error */
  private List<String> fg(int paramInt)
  {
    // Byte code:
  ...
  private List<DataLayer.a> h(List<b> paramList)
  {
    ...
    {
      b localb = (b)paramList.next();
      localArrayList.add(new DataLayer.a(localb.JH, j(localb.aoO)));
    }
  ...
  private List<b> i(List<DataLayer.a> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new b(locala.JH, m(locala.wq)));
    }
    return localArrayList;
  }
  ...
  public void cu(final String paramString)
  {
    this.aoG.execute(new Runnable()
    {
      public void run()
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/google/android/gms/tagmanager/v.class
