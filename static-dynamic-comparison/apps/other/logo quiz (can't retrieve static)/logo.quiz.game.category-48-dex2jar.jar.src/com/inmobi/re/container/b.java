  ...
  extends WebViewClient
{
  ...
  {
    Log.debug("IMRE_3.7.1", "IMWebView-> onLoadResource:" + paramString);
    try
    {
      ...
      {
        Log.debug("IMRE_3.7.1", "IMWebView-> onLoadResource:Hippy, Mraid ad alert!...injecting mraid and mraidview object at " + paramWebView.getUrl());
    ...
    {
      Log.internal("IMRE_3.7.1", "Cannot load resource", paramWebView);
    }
  }
  
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    Log.debug("IMRE_3.7.1", "IMWebView-> onPageFinished, url: " + paramString);
    if (IMWebView.a(this.a) != null) {
    ...
    try
    {
      ...
      Log.debug("IMRE_3.7.1", "IMWebView-> Current State:" + IMWebView.b(this.a));
      if (IMWebView.b(this.a) == IMWebView.ViewState.LOADING)
      {
        this.a.injectJavaScript("window.mraid.broadcastEvent('ready');");
        Log.debug("IMRE_3.7.1", "IMWebView-> Firing ready event at " + paramWebView);
    ...
    {
      Log.debug("IMRE_3.7.1", "Exception in onPageFinished ", paramWebView);
    }
  }
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    Log.debug("IMRE_3.7.1", "IMWebView-> onPageStarted url: " + paramString + " p " + this.a.getParent());
  ...
  {
    Log.debug("IMRE_3.7.1", "IMWebView-> error: " + paramString1);
    if (IMWebView.a(this.a) != null) {
    ...
    {
      Log.debug("IMRE_3.7.1", "Exception in webview loading ", paramWebView);
    }
  }
  ...
  {
    Log.debug("IMRE_3.7.1", "IMWebView-> shouldOverrideUrlLoading, url:" + paramString + "webview id" + paramWebView);
    try
    {
    ...
    {
      Log.internal("IMRE_3.7.1", "Should override exception", paramWebView);
      return false;
    }
    IMWebView.a(this.a, paramString);
    return true;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/re/container/b.class
