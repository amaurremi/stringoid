  ...
  public void open(final String paramString)
  {
    try
    {
      ...
      if ((paramString.startsWith("http://")) || ((paramString.contains("https")) && (!paramString.contains("play.google.com")) && (!paramString.contains("market.android.com")) && (!paramString.contains("market%3A%2F%2F"))))
      {
        ...
        Log.debug("IMRE_3.7.1", "IMWebView-> open:" + paramString);
    ...
    catch (ActivityNotFoundException paramString)
    {
      ...
      Log.debug("IMRE_3.7.1", "Failed to perform mraid Open");
      return;
    }
    catch (Exception paramString)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/re/container/mraidimpl/MRAIDBasic.class
