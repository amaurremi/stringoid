  ...
  implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener
{
  ...
  private void d()
  {
    ...
    {
      Log.internal("IMRE_3.7.1", "IMAVPlayer: unable to remove view");
    }
  }
  ...
  public void hide()
  {
    ...
    {
      Log.internal("IMRE_3.7.1", "IMAVPlayer: unable to hide video");
    }
  }
  ...
  public void mute()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        Log.internal("IMRE_3.7.1", "IMAVPlayer: unable to set volume (mute)");
      }
    }
  }
  ...
  {
    Log.debug("IMRE_3.7.1", "AVPlayer-> onCompletion");
    ...
    {
      Log.internal("IMRE_3.7.1", "IMAvplayer onCompletion exception ", paramMediaPlayer);
      return;
    }
    releasePlayer(false);
  }
  ...
  {
    Log.debug("IMRE_3.7.1", "AVPlayer-> Player error : " + paramInt1);
    f();
    releasePlayer(false);
    if (this.b != null) {
      this.b.onError(this);
  ...
  {
    Log.debug("IMRE_3.7.1", "AVPlayer-> onIMVisibilityChanged: " + paramBoolean);
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    {
      this.s.setVolume(0.0F, 0.0F);
      Log.debug("IMRE_3.7.1", "AVPlayer-> onPrepared");
      f();
      if (this.b != null) {
    ...
    catch (Exception paramMediaPlayer)
    {
      for (;;)
      {
        Log.internal("IMRE_3.7.1", "IMAVPlayer: unable to set volume");
      }
    }
  }
  ...
  protected void onWindowVisibilityChanged(int paramInt)
  {
    ...
    {
      Log.internal("IMRE_3.7.1", "IMAVPlayer: onWindowVisibilityChanged: Something went wrong");
    }
  }
  ...
  public void setPlayData(JSController.PlayerProperties paramPlayerProperties, String paramString)
  {
    ...
    {
      Log.internal("IMRE_3.7.1", "IMAVPlayer: unable to get video bitmap");
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/re/controller/util/AVPlayer.class
