...
public class ImageProcessing
{
  ...
  public static Bitmap getCompressedBitmap(String paramString, Context paramContext)
  {
    try
    {
      ...
      {
        paramContext.close();
        Log.debug("IMRE_3.7.1", "bitmap size - width: " + paramString.getWidth() + ", height: " + paramString.getHeight());
        return paramString;
    ...
    {
      Log.debug("IMRE_3.7.1", paramString.getMessage(), paramString);
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/inmobi/re/controller/util/ImageProcessing.class
