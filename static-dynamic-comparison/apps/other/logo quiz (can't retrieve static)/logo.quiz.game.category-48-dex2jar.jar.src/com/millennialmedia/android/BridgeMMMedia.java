  ...
  extends MMJSObject
{
    ...
    extends MMBaseActivity
  {
    ...
    protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
    {
      ...
      //   180: aload 4
      //   182: monitorenter
      //   183: invokestatic 106	com/millennialmedia/android/BridgeMMMedia:access$000	()Ljava/lang/Object;
      //   186: invokevirtual 111	java/lang/Object:notify	()V
      //   189: aload 4
      //   191: monitorexit
      //   192: aload_0
      //   193: invokevirtual 114	com/millennialmedia/android/BridgeMMMedia$PickerActivity:finish	()V
      //   196: return
      //   197: iconst_0
      //   198: ifeq +11 -> 209
      //   201: new 98	java/lang/NullPointerException
      //   204: dup
      //   205: invokespecial 99	java/lang/NullPointerException:<init>	()V
      //   208: athrow
      //   209: aload_3
      //   210: ifnull +7 -> 217
      //   213: aload_3
      //   214: invokevirtual 102	java/io/OutputStream:close	()V
      //   217: goto -42 -> 175
      //   220: astore_3
      //   221: goto -46 -> 175
      //   224: astore_3
      ...
      //   229: iconst_0
      //   230: ifeq +11 -> 241
      //   233: new 98	java/lang/NullPointerException
      //   236: dup
      //   237: invokespecial 99	java/lang/NullPointerException:<init>	()V
      //   240: athrow
      //   241: aload 4
      //   243: ifnull +8 -> 251
      //   246: aload 4
      //   248: invokevirtual 102	java/io/OutputStream:close	()V
      //   251: aload_3
      //   252: athrow
      //   253: astore_3
      //   254: new 116	java/lang/StringBuilder
      //   257: dup
      //   258: invokespecial 117	java/lang/StringBuilder:<init>	()V
      //   261: ldc 119
      //   263: invokevirtual 123	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
      //   266: aload_3
      //   267: invokevirtual 126	java/lang/Exception:getMessage	()Ljava/lang/String;
      ...
      //   276: invokestatic 134	com/millennialmedia/android/MMSDK$Log:e	(Ljava/lang/String;)V
      //   279: goto -104 -> 175
      //   282: aload 10
      //   284: ifnull -109 -> 175
      //   287: aload_0
      //   288: invokevirtual 138	com/millennialmedia/android/BridgeMMMedia$PickerActivity:getContentResolver	()Landroid/content/ContentResolver;
      //   291: astore_3
      //   292: aload_3
      //   293: ifnull -118 -> 175
      //   296: aload_3
      //   297: aload 10
      //   299: iconst_1
      //   300: anewarray 140	java/lang/String
      //   303: dup
      //   304: iconst_0
      //   305: ldc -114
      //   307: aastore
      ...
      //   309: aconst_null
      //   310: aconst_null
      //   311: invokevirtual 148	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
      //   314: astore 8
      //   316: aload 8
      //   318: ifnull -143 -> 175
      //   321: aload 8
      //   323: ldc -114
      //   325: invokeinterface 154 2 0
      //   330: istore_1
      //   331: iload_1
      //   332: iconst_m1
      //   333: if_icmpeq -158 -> 175
      //   336: aload 8
      //   338: invokeinterface 158 1 0
      //   343: pop
      //   344: new 46	java/io/File
      //   347: dup
      //   348: aload 8
      //   350: iload_1
      //   351: invokeinterface 162 2 0
      //   356: invokespecial 59	java/io/File:<init>	(Ljava/lang/String;)V
      //   359: astore_3
      //   360: aload 8
      //   362: invokeinterface 163 1 0
      //   367: new 46	java/io/File
      //   370: dup
      //   371: aload_0
      //   372: invokevirtual 50	com/millennialmedia/android/BridgeMMMedia$PickerActivity:getIntent	()Landroid/content/Intent;
      //   375: invokevirtual 30	android/content/Intent:getData	()Landroid/net/Uri;
      //   378: invokevirtual 56	android/net/Uri:getPath	()Ljava/lang/String;
      //   381: invokespecial 59	java/io/File:<init>	(Ljava/lang/String;)V
      //   384: astore 8
      //   386: new 165	java/io/FileInputStream
      //   389: dup
      //   390: aload_3
      //   391: invokespecial 166	java/io/FileInputStream:<init>	(Ljava/io/File;)V
      //   394: astore_3
      //   395: new 83	java/io/FileOutputStream
      //   398: dup
      //   399: aload 8
      //   401: invokespecial 86	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
      //   404: astore 4
      //   406: sipush 1024
      ...
      //   413: aload_3
      //   414: aload 5
      //   416: invokevirtual 169	java/io/InputStream:read	([B)I
      //   419: istore_1
      //   420: iload_1
      //   421: ifle +42 -> 463
      //   424: aload 4
      ...
      //   428: iconst_0
      //   429: iload_1
      //   430: invokevirtual 96	java/io/OutputStream:write	([BII)V
      //   433: goto -20 -> 413
      //   436: astore 5
      //   438: aload_3
      //   439: ifnull +7 -> 446
      //   442: aload_3
      //   443: invokevirtual 170	java/io/InputStream:close	()V
      //   446: aload 4
      //   448: ifnull -273 -> 175
      //   451: aload 4
      //   453: invokevirtual 102	java/io/OutputStream:close	()V
      //   456: goto -281 -> 175
      //   459: astore_3
      //   460: goto -285 -> 175
      //   463: aload_3
      //   464: ifnull +7 -> 471
      //   467: aload_3
      //   468: invokevirtual 170	java/io/InputStream:close	()V
      //   471: aload 4
      //   473: ifnull +8 -> 481
      //   476: aload 4
      //   478: invokevirtual 102	java/io/OutputStream:close	()V
      //   481: goto -306 -> 175
      //   484: astore_3
      //   485: goto -310 -> 175
      //   488: astore_3
      ...
      //   501: ifnull +8 -> 509
      //   504: aload 5
      //   506: invokevirtual 102	java/io/OutputStream:close	()V
      //   509: aload_3
      //   510: athrow
      //   511: astore_3
      //   512: aload 4
      ...
      // Local variable table:
      //   start	length	slot	name	signature
      //   0	595	0	this	PickerActivity
      //   0	595	1	paramInt1	int
      //   0	595	2	paramInt2	int
      //   0	595	3	paramIntent	Intent
      //   12	119	4	localObject1	Object
      //   153	1	4	localException1	Exception
      //   178	335	4	localObject2	Object
      //   517	1	4	localException2	Exception
      //   525	30	4	localObject3	Object
      //   559	1	4	localException3	Exception
      //   563	1	4	localObject4	Object
      //   568	1	4	localException4	Exception
      //   576	1	4	localIntent	Intent
      //   24	403	5	localObject5	Object
      //   436	69	5	localException5	Exception
      //   537	1	5	localObject6	Object
      //   573	6	5	localObject7	Object
      //   21	1	6	localObject8	Object
      //   522	6	6	localObject9	Object
      //   533	29	6	localObject10	Object
      //   15	535	7	localObject11	Object
      //   18	382	8	localObject12	Object
      //   27	563	9	localObject13	Object
      //   33	265	10	localUri	Uri
      // Exception table:
      //   from	to	target	type
      //   123	130	153	java/lang/Exception
      //   130	138	153	java/lang/Exception
      //   142	150	153	java/lang/Exception
      //   201	209	220	java/lang/Exception
      //   213	217	220	java/lang/Exception
      //   61	123	224	finally
      //   29	35	253	java/lang/Exception
      //   40	61	253	java/lang/Exception
      //   251	253	253	java/lang/Exception
      //   287	292	253	java/lang/Exception
      //   296	316	253	java/lang/Exception
      //   321	331	253	java/lang/Exception
      //   336	367	253	java/lang/Exception
      //   509	511	253	java/lang/Exception
      //   406	413	436	java/lang/Exception
      //   413	420	436	java/lang/Exception
      //   424	433	436	java/lang/Exception
      //   442	446	459	java/lang/Exception
      //   451	456	459	java/lang/Exception
      //   467	471	484	java/lang/Exception
      //   476	481	484	java/lang/Exception
      //   367	395	488	finally
      //   183	192	511	finally
      //   512	515	511	finally
      //   494	499	517	java/lang/Exception
      //   504	509	517	java/lang/Exception
      //   395	406	522	finally
      //   406	413	533	finally
      //   413	420	533	finally
      //   424	433	533	finally
      //   367	395	548	java/lang/Exception
      //   395	406	559	java/lang/Exception
      //   233	241	568	java/lang/Exception
      //   246	251	568	java/lang/Exception
      //   123	130	573	finally
      //   130	138	573	finally
      //   142	150	573	finally
      //   159	167	584	java/lang/Exception
      //   171	175	584	java/lang/Exception
      //   61	123	588	java/lang/Exception
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/logo quiz/logo.quiz.game.category-48-dex2jar.jar!/com/millennialmedia/android/BridgeMMMedia.class
