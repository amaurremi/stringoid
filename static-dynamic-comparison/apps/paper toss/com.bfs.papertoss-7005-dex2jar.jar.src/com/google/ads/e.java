...
public class e
{
  ...
  public static boolean a(c paramc, d paramd)
  {
    ...
    paramd = ((com.google.ads.internal.h)paramd.h().k.a()).b();
    if (paramc.j().a())
    {
  ...
  {
    synchronized (new h(this, (com.google.ads.internal.h)this.a.h().k.a(), paramf, paramString, ???, paramHashMap))
    {
      ???.a(paramActivity);
      try
      {
        ...
        for (;;)
        {
          synchronized (this.e)
          {
            ...
            if (paramc.a())
            {
              ...
              localObject3 = (Activity)this.a.h().e.a();
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/paper toss/com.bfs.papertoss-7005-dex2jar.jar!/com/google/ads/e.class
