    ...
    for (;;)
    {
      ...
      for (localObject2 = (NetworkExtras)this.c.getNetworkExtras((Class)localObject2);; localObject2 = null)
      {
        ...
        for (;;)
        {
          ...
          ((MediationBannerAdapter)paramMediationAdapter).requestBannerAd(new j(this.a), localActivity, (MediationServerParameters)localObject1, this.a.a.b(), localMediationAdRequest, (NetworkExtras)localObject2);
        }
      }
      localObject1 = null;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/paper toss/com.bfs.papertoss-7005-dex2jar.jar!/com/google/ads/i.class
