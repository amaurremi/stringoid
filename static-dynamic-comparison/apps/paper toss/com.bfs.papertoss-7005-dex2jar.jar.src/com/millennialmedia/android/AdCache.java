...
final class AdCache
{
  ...
  static boolean downloadComponent(String paramString1, String paramString2, File paramFile)
  {
    ...
    //   482: iconst_1
    //   483: aload 12
    //   485: invokevirtual 222	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   488: aastore
    //   489: invokestatic 189	com/millennialmedia/android/MMAdViewSDK$Log:e	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   492: aload_0
    //   493: ifnull +7 -> 500
    //   496: aload_0
    //   497: invokevirtual 194	java/io/InputStream:close	()V
    //   500: aload 11
    //   502: ifnull +8 -> 510
    //   505: aload 11
    //   507: invokevirtual 215	java/io/FileOutputStream:close	()V
    //   510: aload 15
    //   512: ifnull +9 -> 521
    //   515: aload 15
    //   517: invokevirtual 205	java/io/File:delete	()Z
    //   520: pop
    //   521: iconst_0
    //   522: ireturn
    //   523: ldc -32
    //   525: invokestatic 226	com/millennialmedia/android/MMAdViewSDK$Log:e	(Ljava/lang/String;)V
    //   528: aload_0
    //   529: ifnull +7 -> 536
    //   532: aload_0
    //   533: invokevirtual 194	java/io/InputStream:close	()V
    //   536: aload 11
    //   538: ifnull +8 -> 546
    //   541: aload 11
    //   543: invokevirtual 215	java/io/FileOutputStream:close	()V
    //   546: goto -36 -> 510
    //   549: astore_2
    //   550: ldc -35
    //   552: iconst_2
    ...
    //   561: iconst_1
    //   562: aload_2
    //   563: invokevirtual 227	java/lang/SecurityException:getMessage	()Ljava/lang/String;
    //   566: aastore
    //   567: invokestatic 189	com/millennialmedia/android/MMAdViewSDK$Log:e	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   570: goto -42 -> 528
    //   573: astore_1
    //   574: aload 11
    //   576: astore 9
    ...
    //   579: ifnull +7 -> 586
    //   582: aload_0
    //   583: invokevirtual 194	java/io/InputStream:close	()V
    //   586: aload 9
    //   588: ifnull +8 -> 596
    //   591: aload 9
    //   593: invokevirtual 215	java/io/FileOutputStream:close	()V
    //   596: aload_1
    //   597: athrow
    //   598: astore_0
    //   599: ldc -57
    ...
    //   606: iconst_0
    //   607: aload_0
    //   608: invokevirtual 202	java/io/IOException:getMessage	()Ljava/lang/String;
    //   611: aastore
    //   612: invokestatic 189	com/millennialmedia/android/MMAdViewSDK$Log:e	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   615: aload 15
    //   617: ifnull +9 -> 626
    //   620: aload 15
    //   622: invokevirtual 205	java/io/File:delete	()Z
    //   625: pop
    //   626: iconst_0
    //   627: ireturn
    //   628: astore_0
    ...
    //   636: iconst_0
    //   637: aload_0
    //   638: invokevirtual 202	java/io/IOException:getMessage	()Ljava/lang/String;
    //   641: aastore
    //   642: invokestatic 189	com/millennialmedia/android/MMAdViewSDK$Log:e	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   645: aload 15
    //   647: ifnull +9 -> 656
    //   650: aload 15
    ...
    //   666: iconst_0
    //   667: aload_0
    //   668: invokevirtual 202	java/io/IOException:getMessage	()Ljava/lang/String;
    //   671: aastore
    //   672: invokestatic 189	com/millennialmedia/android/MMAdViewSDK$Log:e	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   675: aload 15
    //   677: ifnull +9 -> 686
    //   680: aload 15
    //   682: invokevirtual 205	java/io/File:delete	()Z
    //   685: pop
    //   686: iconst_0
    //   687: ireturn
    //   688: astore_1
    ...
    //   0	706	0	paramString1	String
    //   0	706	1	paramString2	String
    //   0	706	2	paramFile	File
    //   365	92	3	i	int
    //   69	332	4	bool	boolean
    //   89	302	5	l1	long
    //   380	3	7	l2	long
    //   93	499	9	localObject1	Object
    //   100	601	10	localObject2	Object
    //   81	618	11	localObject3	Object
    //   78	171	12	str	String
    //   463	21	12	localException1	Exception
    //   694	1	12	localException2	Exception
    //   84	613	13	localObject4	Object
    //   75	132	14	localObject5	Object
    //   9	672	15	localFile	File
    ...
    //   523	528	463	java/lang/Exception
    //   550	570	463	java/lang/Exception
    //   375	382	549	java/lang/SecurityException
    //   523	528	549	java/lang/SecurityException
    //   354	360	573	finally
    //   360	366	573	finally
    //   375	382	573	finally
    //   452	460	573	finally
    //   523	528	573	finally
    //   550	570	573	finally
    //   532	536	598	java/io/IOException
    //   541	546	598	java/io/IOException
    //   496	500	628	java/io/IOException
    //   505	510	628	java/io/IOException
    //   582	586	658	java/io/IOException
    //   591	596	658	java/io/IOException
    //   102	111	688	finally
    //   122	126	688	finally
    //   137	146	688	finally
    //   157	165	688	finally
    ...
    //   343	354	688	finally
    //   471	492	688	finally
    //   102	111	694	java/lang/Exception
    //   122	126	694	java/lang/Exception
    //   137	146	694	java/lang/Exception
    //   157	165	694	java/lang/Exception
    //   176	183	694	java/lang/Exception
    //   194	199	694	java/lang/Exception
    //   210	216	694	java/lang/Exception
    //   225	234	694	java/lang/Exception
    //   248	255	694	java/lang/Exception
    //   268	281	694	java/lang/Exception
    //   343	354	694	java/lang/Exception
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/paper toss/com.bfs.papertoss-7005-dex2jar.jar!/com/millennialmedia/android/AdCache.class
