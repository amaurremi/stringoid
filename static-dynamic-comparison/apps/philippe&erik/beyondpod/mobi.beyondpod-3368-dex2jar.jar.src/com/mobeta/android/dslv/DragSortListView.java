  ...
  extends ListView
{
  ...
  private static int buildRunList(SparseBooleanArray paramSparseBooleanArray, int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    {
      n = paramSparseBooleanArray.keyAt(j);
      if (n < paramInt2) {}
    }
    else
    {
  ...
  private static int findFirstSetIndex(SparseBooleanArray paramSparseBooleanArray, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((paramInt1 >= i) || (paramSparseBooleanArray.keyAt(paramInt1) >= paramInt2) || (paramSparseBooleanArray.valueAt(paramInt1)))
      {
        if (paramInt1 != i)
        {
          i = paramInt1;
  ...
  protected void dispatchDraw(Canvas paramCanvas)
  {
    ...
    for (f *= f;; f = 0.0F)
    {
      i = (int)(255.0F * this.mCurrFloatAlpha * f);
      paramCanvas.save();
    ...
    extends DragSortListView.SmoothAnimator
  {
    ...
    public void onStart()
    {
      ...
      {
        float f = 2.0F * DragSortListView.this.getWidth();
    ...
    public void onUpdate(float paramFloat1, float paramFloat2)
    {
      ...
      do
      {
        do
        {
          ...
          if (localView != null)
          {
            ...
            ((ViewGroup.LayoutParams)localObject).height = (this.mFirstChildHeight + i);
      ...
      ((ViewGroup.LayoutParams)localObject).height = (this.mSecondChildHeight + i);
      localView.setLayoutParams((ViewGroup.LayoutParams)localObject);
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/beyondpod/mobi.beyondpod-3368-dex2jar.jar!/com/mobeta/android/dslv/DragSortListView.class
