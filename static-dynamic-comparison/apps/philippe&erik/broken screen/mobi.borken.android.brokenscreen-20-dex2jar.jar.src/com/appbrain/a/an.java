  ...
  implements ae.c
{
  ...
  public final ViewGroup a(Context paramContext, ae.b paramb)
  {
    ...
    localLinearLayout.setPadding(q.b(8.0F), q.b(8.0F), q.b(8.0F), q.b(8.0F));
    ...
    paramContext = new LinearLayout.LayoutParams(q.b(128.0F), q.b(128.0F));
    ...
    paramContext = new LinearLayout.LayoutParams(-1, -2);
    paramContext.topMargin = q.b(16.0F);
  ...
  public final ViewGroup b(Context paramContext, ae.b paramb)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams2 = new LinearLayout.LayoutParams(q.b(128.0F), q.b(128.0F));
    ...
    localLayoutParams3.setMargins(q.b(16.0F), 0, q.b(16.0F), q.b(8.0F));
    paramContext.addView(paramb.d, localLayoutParams3);
    paramb.d.setGravity(1);
    localLayoutParams3 = new LinearLayout.LayoutParams(-1, -2);
    localLayoutParams3.setMargins(q.b(16.0F), 0, q.b(16.0F), q.b(16.0F));
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/broken screen/mobi.borken.android.brokenscreen-20-dex2jar.jar!/com/appbrain/a/an.class
