    ...
    implements IGamesSignInService
  {
      ...
      implements IGamesSignInService
    {
        ...
        throws RemoteException
      {
        ...
        //   46: aload_0
        //   47: getfield 43	com/google/android/gms/games/internal/IGamesSignInService$Stub$Proxy:ko	Landroid/os/IBinder;
        //   50: sipush 5006
        //   53: aload 4
        //   55: aload 5
        //   57: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   53: aload_0
        //   54: getfield 43	com/google/android/gms/games/internal/IGamesSignInService$Stub$Proxy:ko	Landroid/os/IBinder;
        //   57: sipush 5005
        //   60: aload 5
        //   62: aload 6
        //   64: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   60: aload_0
        //   61: getfield 43	com/google/android/gms/games/internal/IGamesSignInService$Stub$Proxy:ko	Landroid/os/IBinder;
        //   64: sipush 5003
        //   67: aload 6
        //   69: aload 7
        //   71: iconst_0
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.ko.transact(5009, localParcel1, localParcel2, 0);
          localParcel2.readException();
          paramString = localParcel2.readString();
          return paramString;
        }
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.ko.transact(9001, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/broken screen/mobi.borken.android.brokenscreen-20-dex2jar.jar!/com/google/android/gms/games/internal/IGamesSignInService.class
