...
class Event
{
  ...
  Event(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt6, int paramInt7, int paramInt8)
  {
  ...
  {
    this(paramEvent.eventId, paramString, paramEvent.randomVal, paramEvent.timestampFirst, paramEvent.timestampPrevious, paramEvent.timestampCurrent, paramEvent.visits, paramEvent.pagePath, paramEvent.category, paramEvent.action, paramEvent.label, paramEvent.value, paramEvent.screenWidth, paramEvent.screenHeight);
  ...
  Event(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3)
  {
    this(-1L, paramString1, -1, -1, -1, -1, -1, paramString2, paramString3, paramString4, paramString5, paramInt1, paramInt2, paramInt3);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/bubble blast/com.magmamobile.game.BubbleBlast-23-dex2jar.jar!/com/google/android/apps/analytics/Event.class
