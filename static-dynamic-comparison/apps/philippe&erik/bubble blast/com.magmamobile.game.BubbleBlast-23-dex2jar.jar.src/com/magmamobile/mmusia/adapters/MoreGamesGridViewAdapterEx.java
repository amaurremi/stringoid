...
public class MoreGamesGridViewAdapterEx
  extends BaseAdapter
{
  private Context mContext = null;
  private ItemMoreGames[] myDatas = null;
  
  public MoreGamesGridViewAdapterEx(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = new ItemGridViewMoreGame(this.mContext).getRootView();
      ...
      if (!MMUtils.isPackageNameInDevice(this.mContext, localItemMoreGames.pname)) {
        break label226;
      }
      paramViewGroup.txtTitle.setTextColor(-7829368);
      label128:
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/bubble blast/com.magmamobile.game.BubbleBlast-23-dex2jar.jar!/com/magmamobile/mmusia/adapters/MoreGamesGridViewAdapterEx.class
