...
public final class f
{
  ...
  public static int a(Context paramContext)
  {
    ...
    try
    {
      paramContext.getResources().getString(2130968600);
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (localObject != null)
      {
        i = ((Bundle)localObject).getInt("com.google.android.gms.version");
        if (i != 4452000) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramContext.getPackageManager().hasSystemFeature("android.hardware.type.watch"))
        {
          ...
          if (a((PackageInfo)localObject, a) != null) {
            break label280;
          }
    ...
    label280:
    if (((PackageInfo)localObject).versionCode < 4452000)
    {
      Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 4452000 but found " + ((PackageInfo)localObject).versionCode);
      return 2;
    }
    try
    {
  ...
  public static void b(Context paramContext)
  {
    ...
    if (i != 0)
    {
      ...
      for (;;)
      {
        ...
        throw new d(i);
        paramContext = cS.b("com.google.android.gms");
        continue;
        paramContext = cS.a("com.google.android.gms");
        continue;
        paramContext = cS.a();
      }
      throw new e(i, "Google Play Services not available", paramContext);
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/mp3 cutter/com.atomic.apps.ringtone.cutter-100007-dex2jar.jar!/com/google/android/gms/common/f.class
