...
final class ci
{
  ...
  public ci(int paramInt, long paramLong, String paramString1, String paramString2, String paramString3, Throwable paramThrowable)
  {
    this.dO = paramInt;
    this.ex = paramLong;
    this.ey = paramString1;
    this.ez = paramString2;
    this.eA = paramString3;
    this.eB = paramThrowable;
  }
  ...
  public final byte[] getBytes()
  {
    ...
    //   22: aload_3
    //   23: aload_0
    //   24: getfield 21	com/flurry/android/ci:dO	I
    //   27: invokevirtual 50	java/io/DataOutputStream:writeShort	(I)V
    //   30: aload_3
    //   31: astore 4
    //   33: aload_3
    //   34: aload_0
    //   35: getfield 23	com/flurry/android/ci:ex	J
    //   38: invokevirtual 54	java/io/DataOutputStream:writeLong	(J)V
    //   41: aload_3
    //   42: astore 4
    //   44: aload_3
    //   45: aload_0
    //   46: getfield 25	com/flurry/android/ci:ey	Ljava/lang/String;
    //   49: invokevirtual 58	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   52: aload_3
    //   53: astore 4
    //   55: aload_3
    //   56: aload_0
    //   57: getfield 27	com/flurry/android/ci:ez	Ljava/lang/String;
    //   60: invokevirtual 58	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   63: aload_3
    //   64: astore 4
    //   66: aload_3
    //   67: aload_0
    //   68: getfield 29	com/flurry/android/ci:eA	Ljava/lang/String;
    //   71: invokevirtual 58	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   74: aload_3
    //   75: astore 4
    //   77: aload_0
    //   78: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    //   81: ifnull +284 -> 365
    //   84: aload_3
    //   85: astore 4
    //   87: aload_0
    //   88: getfield 25	com/flurry/android/ci:ey	Ljava/lang/String;
    //   91: ldc 60
    ...
    //   137: astore 4
    //   139: aload_0
    //   140: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    ...
    //   204: astore 4
    //   206: aload_3
    //   207: invokestatic 96	com/flurry/android/bd:a	(Ljava/io/Closeable;)V
    //   210: iconst_0
    ...
    //   215: astore 4
    //   217: aload_0
    //   218: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    //   221: invokevirtual 100	java/lang/Throwable:getCause	()Ljava/lang/Throwable;
    //   224: ifnull +85 -> 309
    //   227: aload_3
    //   228: astore 4
    //   230: aload 6
    ...
    //   250: astore 4
    //   252: aload_0
    //   253: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    //   256: invokevirtual 100	java/lang/Throwable:getCause	()Ljava/lang/Throwable;
    ...
    //   317: invokevirtual 109	java/lang/String:getBytes	()[B
    //   320: astore 6
    //   322: aload_3
    //   323: astore 4
    //   325: aload_3
    //   326: aload 6
    //   328: arraylength
    //   329: invokevirtual 112	java/io/DataOutputStream:writeInt	(I)V
    //   332: aload_3
    //   333: astore 4
    //   335: aload_3
    //   336: aload 6
    //   338: invokevirtual 116	java/io/DataOutputStream:write	([B)V
    //   341: aload_3
    //   342: astore 4
    //   344: aload_3
    //   345: invokevirtual 119	java/io/DataOutputStream:flush	()V
    //   348: aload_3
    //   349: astore 4
    //   351: aload 5
    //   353: invokevirtual 122	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   356: astore 5
    //   358: aload_3
    //   359: invokestatic 96	com/flurry/android/bd:a	(Ljava/io/Closeable;)V
    //   362: aload 5
    //   364: areturn
    //   365: aload_3
    //   366: astore 4
    ...
    //   384: astore_3
    //   385: aload 4
    //   387: invokestatic 96	com/flurry/android/bd:a	(Ljava/io/Closeable;)V
    //   390: aload_3
    //   391: athrow
    //   392: astore_3
    //   393: aconst_null
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/randomchat/com.pioong-93-dex2jar.jar!/com/flurry/android/ci.class
