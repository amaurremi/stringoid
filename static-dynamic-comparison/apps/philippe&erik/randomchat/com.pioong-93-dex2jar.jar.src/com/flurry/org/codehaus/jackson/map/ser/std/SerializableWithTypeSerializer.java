  ...
  extends SerializerBase<JsonSerializableWithType>
{
    ...
    throws com.flurry.org.codehaus.jackson.map.JsonMappingException
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 31	com/flurry/org/codehaus/jackson/map/ser/std/SerializableWithTypeSerializer:createObjectNode	()Lcom/flurry/org/codehaus/jackson/node/ObjectNode;
    //   4: astore 9
    //   6: ldc 33
    //   8: astore 7
    //   10: aconst_null
    ...
    //   30: ifnull +108 -> 138
    //   33: aload_2
    //   34: invokestatic 39	com/flurry/org/codehaus/jackson/map/type/TypeFactory:rawClass	(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    //   37: astore_2
    //   38: aload 6
    //   40: astore 5
    //   42: aload 8
    ...
    //   64: checkcast 41	com/flurry/org/codehaus/jackson/schema/JsonSerializableSchema
    //   67: astore 7
    //   69: aload 7
    ...
    //   140: ldc 71
    //   142: aload 4
    //   144: invokevirtual 77	com/flurry/org/codehaus/jackson/node/ObjectNode:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   147: aload_3
    //   148: ifnull +27 -> 175
    //   151: aload 9
    //   153: ldc 79
    //   155: new 81	com/flurry/org/codehaus/jackson/map/ObjectMapper
    //   158: dup
    //   159: invokespecial 82	com/flurry/org/codehaus/jackson/map/ObjectMapper:<init>	()V
    //   162: aload_3
    //   163: ldc 84
    //   165: invokevirtual 88	com/flurry/org/codehaus/jackson/map/ObjectMapper:readValue	(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    //   168: checkcast 84	com/flurry/org/codehaus/jackson/JsonNode
    //   171: invokevirtual 91	com/flurry/org/codehaus/jackson/node/ObjectNode:put	(Ljava/lang/String;Lcom/flurry/org/codehaus/jackson/JsonNode;)Lcom/flurry/org/codehaus/jackson/JsonNode;
    //   174: pop
    //   175: aload 5
    //   177: ifnull +28 -> 205
    //   180: aload 9
    //   182: ldc 93
    //   184: new 81	com/flurry/org/codehaus/jackson/map/ObjectMapper
    //   187: dup
    //   188: invokespecial 82	com/flurry/org/codehaus/jackson/map/ObjectMapper:<init>	()V
    //   191: aload 5
    //   193: ldc 84
    //   195: invokevirtual 88	com/flurry/org/codehaus/jackson/map/ObjectMapper:readValue	(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    //   198: checkcast 84	com/flurry/org/codehaus/jackson/JsonNode
    //   201: invokevirtual 91	com/flurry/org/codehaus/jackson/node/ObjectNode:put	(Ljava/lang/String;Lcom/flurry/org/codehaus/jackson/JsonNode;)Lcom/flurry/org/codehaus/jackson/JsonNode;
    //   204: pop
    //   205: aload 9
    //   207: areturn
    //   208: astore_1
    ...
    //   4	202	9	localObjectNode	com.flurry.org.codehaus.jackson.node.ObjectNode
    // Exception table:
    //   from	to	target	type
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/randomchat/com.pioong-93-dex2jar.jar!/com/flurry/org/codehaus/jackson/map/ser/std/SerializableWithTypeSerializer.class
