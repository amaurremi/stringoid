  ...
  implements Parcelable
{
  ...
  public BackStackState(n paramn, d paramd)
  {
    paramn = paramd.b;
    int k;
    ...
    if (paramn != null)
    {
      ...
      k = j + 1;
      arrayOfInt[j] = paramn.c;
      arrayOfInt = this.a;
      int m = k + 1;
      if (paramn.d != null) {}
      for (j = paramn.d.mIndex;; j = -1)
      {
        arrayOfInt[k] = j;
        arrayOfInt = this.a;
        j = m + 1;
        arrayOfInt[m] = paramn.e;
        arrayOfInt = this.a;
        k = j + 1;
        arrayOfInt[j] = paramn.f;
        arrayOfInt = this.a;
        j = k + 1;
        arrayOfInt[k] = paramn.g;
        arrayOfInt = this.a;
        k = j + 1;
        arrayOfInt[j] = paramn.h;
        if (paramn.i == null) {
          break label311;
        }
        m = paramn.i.size();
        ...
        while (k < m)
        {
          this.a[j] = ((Fragment)paramn.i.get(k)).mIndex;
          k += 1;
          j += 1;
        }
      }
  ...
  public d a(n paramn)
  {
    ...
    while (j < this.a.length)
    {
      ...
      k = localObject[k];
      if (k >= 0) {}
      for (locale.d = ((Fragment)paramn.f.get(k));; locale.d = null)
      {
        localObject = this.a;
        k = j + 1;
        ...
        for (;;)
        {
          ...
          localObject = (Fragment)paramn.f.get(this.a[k]);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/app/BackStackState.class
