...
public final class GooglePlayServicesUtil
{
  ...
  private static Dialog a(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    for (Object localObject1 = new AlertDialog.Builder(paramActivity, 5);; localObject1 = null)
    {
      ...
      for (paramFragment = new gz(paramActivity, paramOnCancelListener, paramInt2);; paramFragment = new gz(paramFragment, paramOnCancelListener, paramInt2))
      {
  ...
  public static boolean a(PackageManager paramPackageManager, PackageInfo paramPackageInfo)
  {
    ...
    do
    {
      do
      {
        ...
        bool1 = bool3;
        if (a(paramPackageInfo, De) != null) {
          bool1 = true;
        }
        bool2 = bool1;
      } while (bool1);
      bool2 = bool1;
    } while (a(paramPackageInfo, Dd) == null);
  ...
  public static boolean b(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    try
    {
      boolean bool = paramActivity instanceof h;
      i = bool;
    }
    ...
    if (i != 0)
    {
      paramActivity = ((h)paramActivity).e();
  ...
  public static boolean b(PackageManager paramPackageManager)
  {
    synchronized (Di)
    {
      ...
      try
      {
        if (a(paramPackageManager.getPackageInfo("com.google.android.gms", 64), new byte[][] { Dd[1] }) != null) {}
        for (Dh = 1; Dh != 0; Dh = 0) {
          return true;
        }
      }
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      try
      {
        ...
        if (!ii.aD(localPackageInfo.versionCode)) {
          break label307;
        }
      }
      catch (PackageManager.NameNotFoundException paramContext)
      {
        try
        {
          ...
          if (a(localPackageInfo, new byte[][] { CV[1], Da[1] }) != null) {
            break label146;
          }
        ...
        if (a(paramContext, new byte[][] { Da[0] }) == null)
        {
          ...
          else
          {
            try
            {
              ...
              paramContext = a(paramContext, CV);
              if (paramContext == null)
              {
      ...
      int i = ii.aB(5089000);
      if (ii.aB(localPackageInfo.versionCode) < i)
      {
        Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 5089000 but found " + localPackageInfo.versionCode);
        return 2;
      }
      try
      {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/common/GooglePlayServicesUtil.class
