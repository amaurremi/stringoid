  ...
  implements SafeParcelable
{
  ...
  LatLngBounds(int paramInt, LatLng paramLatLng1, LatLng paramLatLng2)
  {
    ...
    {
      hm.b(bool, "southern latitude exceeds northern latitude (%s > %s)", new Object[] { Double.valueOf(paramLatLng1.latitude), Double.valueOf(paramLatLng2.latitude) });
      this.xM = paramInt;
  ...
  public int hashCode()
  {
    return hk.hashCode(new Object[] { this.southwest, this.northeast });
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/maps/model/LatLngBounds.class
