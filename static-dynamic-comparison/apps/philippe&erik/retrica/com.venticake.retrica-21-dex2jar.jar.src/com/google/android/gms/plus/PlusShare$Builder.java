...
public class PlusShare$Builder
{
  ...
  public PlusShare$Builder(Activity paramActivity, PlusClient paramPlusClient)
  {
    ...
    {
      bool = true;
      hm.a(bool, "PlusClient must not be null.");
      hm.a(paramPlusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
      hm.a(paramPlusClient.jS().by("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
  ...
  {
    hm.a(this.abH, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
    if ((paramUri != null) && (!TextUtils.isEmpty(paramUri.toString()))) {}
    for (boolean bool = true;; bool = false)
    {
      hm.b(bool, "Must provide a call to action URL");
      ...
      {
        hm.a(PlusShare.bv(paramString2), "The specified deep-link ID was malformed.");
  ...
  public Builder addStream(Uri paramUri)
  {
    ...
    this.abI.add(localUri);
    this.abI.add(paramUri);
    return this;
  }
  ...
  public Intent getIntent()
  {
    ...
    int i;
    boolean bool1;
    if ((this.abI != null) && (this.abI.size() > 1))
    {
      i = 1;
      ...
      bool1 = true;
      label59:
      hm.a(bool1, "Call-to-action buttons are only available for URLs.");
      if ((bool4) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
        break label312;
      }
      bool1 = true;
      label84:
      hm.a(bool1, "The content URL is required for interactive posts.");
      bool1 = bool2;
      if (bool4)
      {
        bool1 = bool2;
      ...
      label125:
      hm.a(bool1, "Must set content URL or content deep-link ID to use a call-to-action button.");
      if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
        hm.a(PlusShare.bv(this.mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
      }
      if ((i == 0) && (bool3))
      {
        ...
        this.mIntent.putExtra("android.intent.extra.STREAM", (Parcelable)this.abI.get(0));
        label217:
        this.abI = null;
      }
      if ((i != 0) && (!bool3))
      {
        ...
        this.mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", this.abI);
      }
    }
    for (;;)
    {
  ...
  {
    hm.b(this.abH, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
    if (!TextUtils.isEmpty(paramString1)) {}
    for (boolean bool = true;; bool = false)
    {
      hm.b(bool, "The deepLinkId parameter is required.");
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/plus/PlusShare$Builder.class
