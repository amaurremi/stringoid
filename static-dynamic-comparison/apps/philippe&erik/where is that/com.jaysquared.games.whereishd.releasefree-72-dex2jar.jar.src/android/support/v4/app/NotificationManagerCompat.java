...
public class NotificationManagerCompat
{
    ...
    implements Handler.Callback, ServiceConnection
  {
    ...
    private void updateListenerMap()
    {
      ...
      if (localObject1.equals(this.mCachedEnabledPackages)) {}
      for (;;)
      {
        return;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/android/support/v4/app/NotificationManagerCompat.class
