...
abstract class ActionBarActivityDelegate
{
  ...
  static ActionBarActivityDelegate createDelegate(ActionBarActivity paramActionBarActivity)
  {
    if (Build.VERSION.SDK_INT >= 20) {
      return new ActionBarActivityDelegateApi20(paramActionBarActivity);
    }
    if (Build.VERSION.SDK_INT >= 18) {
      return new ActionBarActivityDelegateJBMR2(paramActionBarActivity);
    }
    ...
    implements ActionBarDrawerToggle.Delegate
  {
    ...
    {
      TypedArray localTypedArray = ActionBarActivityDelegate.this.mActivity.obtainStyledAttributes(new int[] { ActionBarActivityDelegate.this.getHomeAsUpIndicatorAttrId() });
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/android/support/v7/app/ActionBarActivityDelegate.class
