...
public class k
{
  ...
  public static ViewGroup a(Activity paramActivity, d paramd)
  {
    ...
    {
      b.a("Gestures disabled: Error loading gesture data.", paramActivity);
    }
    return null;
  }
    ...
    implements GestureOverlayView.OnGesturePerformedListener
  {
    ...
    public void onGesturePerformed(final GestureOverlayView paramGestureOverlayView, Gesture paramGesture)
    {
      ...
      {
        new AlertDialog.Builder(this.b).setMessage(paramGestureOverlayView).setTitle("Ad Information").setPositiveButton("Share", new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            k.a.b(k.a.this).startActivity(Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", paramGestureOverlayView), "Share via"));
          }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/google/ads/internal/k.class
