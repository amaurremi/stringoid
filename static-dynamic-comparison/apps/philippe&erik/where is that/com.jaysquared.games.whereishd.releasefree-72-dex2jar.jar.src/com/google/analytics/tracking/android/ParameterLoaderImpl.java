  ...
  implements ParameterLoader
{
  ...
  private int getResourceIdForType(String paramString1, String paramString2)
  {
    ...
    for (String str = this.mOverrideResourcePackageName;; str = this.mContext.getPackageName()) {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/google/analytics/tracking/android/ParameterLoaderImpl.class
