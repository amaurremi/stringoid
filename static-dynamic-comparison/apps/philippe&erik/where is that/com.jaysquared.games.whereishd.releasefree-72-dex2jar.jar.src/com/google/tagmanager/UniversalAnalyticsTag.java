  ...
  extends TrackingTag
{
  ...
  private boolean checkBooleanProperty(Map<String, TypeSystem.Value> paramMap, String paramString)
  {
    ...
    return paramMap.getBoolean();
  }
  
  private Map<String, String> convertToGaFields(TypeSystem.Value paramValue)
  {
    if ((paramValue == null) || (paramValue.getType() != TypeSystem.Value.Type.MAP)) {
  ...
  {
    ((TypeSystem.Value)paramMap.get(ACCOUNT)).getString();
  ...
  {
    Object localObject;
    if (paramValue.getType() != TypeSystem.Value.Type.MAP)
    {
      localObject = null;
      return (Map<String, String>)localObject;
    }
    HashMap localHashMap = new HashMap(paramValue.getMapKeyCount());
    int i = 0;
    for (;;)
    {
      localObject = localHashMap;
      if (i >= paramValue.getMapKeyCount()) {
        break;
      }
      localHashMap.put(Types.valueToString(paramValue.getMapKey(i)), Types.valueToString(paramValue.getMapValue(i)));
      i += 1;
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/google/tagmanager/UniversalAnalyticsTag.class
