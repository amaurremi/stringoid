...
public final class AnalyticsDatabaseManager
{
  ...
  private AnalyticsEvent a(Cursor paramCursor)
  {
    ...
    com.inmobi.commons.internal.Log.debug("[InMobi]-[Analytics]-4.1.1", "IMAppDatabaseManager->" + localAnalyticsEvent.getEventType() + "-" + l);
    if (l > -1L)
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          paramCursor = this.b.query("transactiondetail", i, "_id = ?", new String[] { str }, null, null, null);
          paramCursor.moveToFirst();
  ...
  {
    com.inmobi.commons.internal.Log.debug("[InMobi]-[Analytics]-4.1.1", "IMAppDatabaseManager->insertEvents-" + paramAnalyticsEvent.getEventType());
    ...
    if (paramLong < AnalyticsUtils.getMaxdbcount())
    {
      ...
      {
        localCursor = this.b.query("attemptdata", h, "levelid = ?", new String[] { paramAnalyticsEvent.getEventLevelId() }, null, null, null, "1");
    ...
    for (;;)
    {
      ...
      break;
      com.inmobi.commons.internal.Log.debug("[InMobi]-[Analytics]-4.1.1", "Database full");
      break label294;
      label811:
      localObject = "0";
      str1 = "0";
  ...
  {
    com.inmobi.commons.internal.Log.debug("[InMobi]-[Analytics]-4.1.1", "IMAppDatabaseManager->deleteEvents");
  ...
  {
    com.inmobi.commons.internal.Log.debug("[InMobi]-[Analytics]-4.1.1", "IMAppDatabaseManager->getEvents");
    ArrayList localArrayList = new ArrayList();
    if (!this.b.isOpen())
    {
      android.util.Log.v("[InMobi]-[Analytics]-4.1.1", "IMAppDatabaseManager->getEvents()-database is not open");
  ...
  public void deleteEvents(List<Long> paramList)
  {
    ...
    catch (Exception paramList)
    {
      for (;;)
      {
        com.inmobi.commons.internal.Log.internal("[InMobi]-[Analytics]-4.1.1", "Error deleting from DB.");
      }
    }
    finally {}
  }
  ...
  public List<AnalyticsEvent> getEvents()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        com.inmobi.commons.internal.Log.internal("[InMobi]-[Analytics]-4.1.1", "Error reading events from DB.");
        ArrayList localArrayList = new ArrayList();
      }
    }
    finally {}
  ...
  public void insertEvents(AnalyticsEvent paramAnalyticsEvent)
  {
    ...
    catch (Exception paramAnalyticsEvent)
    {
      for (;;)
      {
        com.inmobi.commons.internal.Log.internal("[InMobi]-[Analytics]-4.1.1", "Error in inserting into DB.", paramAnalyticsEvent);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/commons/analytics/db/AnalyticsDatabaseManager.class
