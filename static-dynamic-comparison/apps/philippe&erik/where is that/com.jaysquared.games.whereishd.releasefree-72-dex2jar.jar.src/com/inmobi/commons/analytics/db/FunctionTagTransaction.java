  ...
  extends AnalyticsFunctions
{
  ...
  private AnalyticsEvent a(AnalyticsEvent paramAnalyticsEvent)
  {
    for (;;)
    {
      ...
      {
        Log.internal("[InMobi]-[Analytics]-4.1.1", "Failed to set purchase bundle info", localException);
        return paramAnalyticsEvent;
      }
    }
    return paramAnalyticsEvent;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/commons/analytics/db/FunctionTagTransaction.class
