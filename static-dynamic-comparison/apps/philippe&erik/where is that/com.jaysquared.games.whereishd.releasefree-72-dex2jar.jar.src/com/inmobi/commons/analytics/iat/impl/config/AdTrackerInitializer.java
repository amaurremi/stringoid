...
public class AdTrackerInitializer
{
  ...
  private static void a(Context paramContext)
  {
    ...
    while ((a != null) || (paramContext != null))
    {
      ...
      {
        Log.internal("[InMobi]-[AdTracker]-4.1.1", "Exception while retreiving configs.");
        return;
      }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/commons/analytics/iat/impl/config/AdTrackerInitializer.class
