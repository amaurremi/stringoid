...
public class Base62
{
  ...
  public static String fromBase10(long paramLong)
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Failed to convert to base 62", localException);
    }
    return null;
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/commons/thirdparty/Base62.class
