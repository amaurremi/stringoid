  ...
  extends JSController
{
  ...
  private JSController.ExpandProperties a(JSController.ExpandProperties paramExpandProperties)
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "Device current rotation: " + j);
    Log.debug("[InMobi]-[RE]-4.1.1", "Density of device: " + this.b);
    ...
    {
      Log.debug("[InMobi]-[RE]-4.1.1", "Device Width: " + k + " Device height: " + m);
      ...
      if (paramExpandProperties.y < 0)
      {
        ...
        Log.debug("[InMobi]-[RE]-4.1.1", "topStuff: " + paramExpandProperties.topStuff + " ,bottomStuff: " + paramExpandProperties.bottomStuff);
      }
      Log.debug("[InMobi]-[RE]-4.1.1", "loc 0: " + localObject[0] + " loc 1: " + localObject[1]);
      ...
      Log.debug("[InMobi]-[RE]-4.1.1", "final expanded width after density : " + paramExpandProperties.width + "final expanded height after density " + paramExpandProperties.height + "portrait width requested :" + paramExpandProperties.portraitWidthRequested + "portrait height requested :" + paramExpandProperties.portraitHeightRequested);
  ...
  public void close()
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> close");
  ...
  public void expand(String paramString)
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> expand: url: " + paramString);
    try
    {
      ...
      {
        Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> Already expanded state");
        return;
      }
      if (this.imWebView.getStateVariable() == IMWebView.ViewState.HIDDEN)
      {
        Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> Expand cannot be called in hidden state. Doing nothing.");
        return;
      }
    }
    catch (Exception paramString)
    {
      Log.debug("[InMobi]-[RE]-4.1.1", "Exception while expanding the ad. ", paramString);
      return;
    }
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> At the time of expand the properties are: Expandable width: " + this.temporaryexpProps.width + " Expandable height: " + this.temporaryexpProps.height + " Expandable orientation: " + this.temporaryexpProps.orientation + " Expandable lock orientation: " + this.temporaryexpProps.lockOrientation + " Expandable Modality: " + this.temporaryexpProps.isModal + " Expandable Use custom close " + this.temporaryexpProps.useCustomClose);
  ...
  public String getOrientation()
  {
    ...
    try
    {
      ...
      Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> getOrientation: " + str);
      return str;
    }
    catch (Exception localException)
    {
      Log.debug("[InMobi]-[RE]-4.1.1", "Error getOrientation: " + "-1", localException);
    }
    return "-1";
  }
  ...
  public String getPlacementType()
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> getPlacementType");
  ...
  public String getState()
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> getState");
  ...
  public boolean isViewable()
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> isViewable");
  ...
  public void open(String paramString)
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> open: url: " + paramString);
  ...
  public void resize()
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> resize");
    try
    {
      if (this.imWebView.getStateVariable() == IMWebView.ViewState.RESIZING)
      {
        Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> Already resize state");
        return;
      }
      if (this.imWebView.getStateVariable() == IMWebView.ViewState.HIDDEN)
      {
        Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> Resize cannot be called in hidden state. Doing nothing.");
        return;
      }
    }
    catch (Exception localException)
    {
      Log.debug("[InMobi]-[RE]-4.1.1", "Exception while expanding the ad. ", localException);
      return;
    }
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> At the time of resize the properties are: Resize width: " + localResizeProperties.width + " Resize height: " + localResizeProperties.height + " Resize offsetX: " + localResizeProperties.offsetX + " Resize offsetY: " + localResizeProperties.offsetY + " customClosePosition: " + localResizeProperties.customClosePosition + " allowOffscreen: " + localResizeProperties.allowOffscreen);
  ...
  public void setExpandProperties(String paramString)
  {
    ...
    try
    {
      ...
      Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> ExpandProperties is set: Expandable Width: " + this.expProps.width + " Expandable height: " + this.expProps.height + " Expandable orientation: " + this.expProps.orientation + " Expandable lock orientation: " + this.expProps.lockOrientation + " Expandable Modality: " + this.expProps.isModal + " Expandable Use Custom close: " + this.expProps.useCustomClose);
    ...
    {
      Log.debug("[InMobi]-[RE]-4.1.1", "Exception while setting the expand properties " + paramString);
    }
  }
  ...
  public void setOrientationProperties(String paramString)
  {
    ...
    try
    {
      ...
      Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> OrientationProperties is set: Expandable orientation: " + this.expProps.orientation + " Expandable lock orientation: " + this.expProps.lockOrientation);
  ...
  public void setResizeProperties(String paramString)
  {
    ...
    try
    {
      ...
      Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> ResizeProperties is set: Resize Width: " + this.d.width + " Resize height: " + this.d.height + " Resize offsetX: " + this.d.offsetX + " Resize offsetY: " + this.d.offsetY + " customClosePosition: " + this.d.customClosePosition + " allowOffscreen: " + this.d.allowOffscreen);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public void useCustomClose(boolean paramBoolean)
  {
    ...
    Log.debug("[InMobi]-[RE]-4.1.1", "JSDisplayController-> useCustomClose" + paramBoolean);
    this.imWebView.setCustomClose(paramBoolean);
  }
}


/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/re/controller/JSDisplayController.class
