  ...
  extends ViewGroup
{
  ...
  boolean addToRoot(View paramView)
  {
    ...
    } while ((paramView == null) || (!(paramView instanceof ViewGroup)));
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramBoolean)
    {
      ...
      this.mProgressBar.layout(paramInt1 - this.mProgressIndicatorRadius, paramInt2 - this.mProgressIndicatorRadius, this.mProgressIndicatorRadius + paramInt1, this.mProgressIndicatorRadius + paramInt2);
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/mopub/nativeads/SpinningProgressView.class
