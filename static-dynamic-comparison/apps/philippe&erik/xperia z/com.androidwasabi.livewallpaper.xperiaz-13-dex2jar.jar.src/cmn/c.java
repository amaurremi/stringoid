...
{
  private static final Map a = new e();
  private final d b;
  private int c;
  ...
  private String a(String paramString)
  {
    try
    {
      paramString = (String)d.b(this.b).get(this.c) + paramString;
      return paramString;
    }
    finally
    {
  ...
  private void a()
  {
    try
    {
      this.c = ((this.c + 1) % d.b(this.b).size());
      return;
    }
    finally
    {
  ...
  {
    // Byte code:
    //   0: invokestatic 80	cmn/aq:a	()Lorg/apache/http/impl/client/DefaultHttpClient;
    //   3: astore 6
    //   5: iconst_0
    //   6: istore_3
    //   7: aconst_null
    ...
    //   19: aload_0
    //   20: aload_1
    //   21: invokespecial 84	cmn/c:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   182: astore 5
    //   184: aload 8
    //   186: invokestatic 155	cmn/c:a	(Lorg/apache/http/HttpResponse;)V
    //   189: aload 5
    //   191: athrow
    //   192: astore 5
    //   194: aload 7
    ...
    //   199: aload_0
    //   200: invokespecial 160	cmn/c:a	()V
    //   203: iload_3
    //   204: iconst_1
    //   205: iadd
    //   206: istore_3
    ...
    //   235: astore 5
    //   237: aload 8
    //   239: invokestatic 155	cmn/c:a	(Lorg/apache/http/HttpResponse;)V
    //   242: aload 5
    //   244: areturn
    //   245: aload 8
    ...
    //   267: aload 8
    //   269: invokestatic 155	cmn/c:a	(Lorg/apache/http/HttpResponse;)V
    //   272: aconst_null
    //   273: areturn
    //   274: aload 8
    ...
    //   326: astore 5
    //   328: aload 8
    //   330: invokestatic 155	cmn/c:a	(Lorg/apache/http/HttpResponse;)V
    //   333: aload 5
    //   335: athrow
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/xperia z/com.androidwasabi.livewallpaper.xperiaz-13-dex2jar.jar!/cmn/c.class
