  ...
  implements bf
{
  ...
  public final ViewGroup a(Context paramContext, be parambe)
  {
    ...
    localLinearLayout.setPadding(aj.b(8.0F), aj.b(8.0F), aj.b(8.0F), aj.b(8.0F));
    ...
    paramContext = new LinearLayout.LayoutParams(aj.b(128.0F), aj.b(128.0F));
    ...
    paramContext = new LinearLayout.LayoutParams(-1, -2);
    paramContext.topMargin = aj.b(16.0F);
  ...
  public final ViewGroup b(Context paramContext, be parambe)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams2 = new LinearLayout.LayoutParams(aj.b(128.0F), aj.b(128.0F));
    ...
    localLayoutParams3.setMargins(aj.b(16.0F), 0, aj.b(16.0F), aj.b(8.0F));
    paramContext.addView(parambe.d, localLayoutParams3);
    parambe.d.setGravity(1);
    localLayoutParams3 = new LinearLayout.LayoutParams(-1, -2);
    localLayoutParams3.setMargins(aj.b(16.0F), 0, aj.b(16.0F), aj.b(16.0F));
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/xperia z/com.androidwasabi.livewallpaper.xperiaz-13-dex2jar.jar!/com/appbrain/a/bq.class
