  ...
  extends LayerDrawable
{
  ...
  public a(Drawable[] paramArrayOfDrawable, float[] paramArrayOfFloat)
  {
  ...
  private static Drawable a(Drawable paramDrawable, Context paramContext)
  {
    if ((paramDrawable instanceof GradientDrawable)) {
      return new b(paramDrawable.getConstantState().newDrawable(paramContext.getResources()));
    }
    return c.a(paramDrawable, paramContext.getResources());
  }
  
  public static a a(Context paramContext, Drawable paramDrawable)
  {
  ...
  public static a b(Context paramContext, Drawable paramDrawable)
  {
    paramContext = a(paramDrawable, paramContext);
    paramDrawable = b();
    return new a(new Drawable[] { paramContext }, paramDrawable);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/xperia z/com.androidwasabi.livewallpaper.xperiaz-13-dex2jar.jar!/com/appbrain/d/a.class
