  ...
  public static Type canonicalize(Type paramType)
  {
    ...
    if ((paramType instanceof Class))
    {
      ...
      if (paramType.isArray()) {
        localObject = new .Gson.Types.GenericArrayTypeImpl(canonicalize(paramType.getComponentType()));
      }
    }
    do
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/xperia z/com.androidwasabi.livewallpaper.xperiaz-13-dex2jar.jar!/com/google/gson/internal/$Gson$Types.class
