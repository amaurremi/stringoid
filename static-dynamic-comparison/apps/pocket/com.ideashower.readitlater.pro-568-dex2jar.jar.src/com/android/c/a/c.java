  ...
  implements a
{
  ...
  public Bundle a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   35: aload 5
    //   37: aload 4
    //   39: invokevirtual 36	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   42: aload_0
    //   43: getfield 15	com/android/c/a/c:a	Landroid/os/IBinder;
    //   46: iconst_4
    //   47: aload 5
    //   49: aload 6
    //   51: iconst_0
    //   52: invokeinterface 42 5 0
    //   57: pop
    //   58: aload 6
    //   60: invokevirtual 45	android/os/Parcel:readException	()V
    //   63: aload 6
    //   65: invokevirtual 49	android/os/Parcel:readInt	()I
    //   68: ifeq +29 -> 97
    //   71: getstatic 63	android/os/Bundle:CREATOR	Landroid/os/Parcelable$Creator;
    //   74: aload 6
    //   76: invokeinterface 69 2 0
    //   81: checkcast 55	android/os/Bundle
    //   84: astore_2
    //   85: aload 6
  ...
  public Bundle a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    //   42: aload 6
    //   44: aload 5
    //   46: invokevirtual 36	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   49: aload_0
    //   50: getfield 15	com/android/c/a/c:a	Landroid/os/IBinder;
    //   53: iconst_3
    //   54: aload 6
    //   56: aload 7
    //   58: iconst_0
    //   59: invokeinterface 42 5 0
    //   64: pop
    //   65: aload 7
    //   67: invokevirtual 45	android/os/Parcel:readException	()V
    //   70: aload 7
    //   72: invokevirtual 49	android/os/Parcel:readInt	()I
    //   75: ifeq +29 -> 104
    //   78: getstatic 63	android/os/Bundle:CREATOR	Landroid/os/Parcelable$Creator;
    //   81: aload 7
    //   83: invokeinterface 69 2 0
    //   88: checkcast 55	android/os/Bundle
    //   91: astore_2
    //   92: aload 7
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/com/android/c/a/c.class
