  ...
  protected final String _handleUnusualFieldName(int paramInt)
  {
    ...
    do
    {
      ...
      if (j < m)
      {
        ...
        j = this._inputPtr - 1;
        this._inputPtr = i;
        return this._symbols.findSymbol(this._inputBuffer, j, i - j, paramInt);
        bool = false;
        break;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/org/codehaus/jackson/impl/ReaderBasedParser.class
