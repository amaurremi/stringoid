...
public final class TypeFactory
{
  ...
  protected JavaType _fromParameterizedClass(Class paramClass, List paramList)
  {
    if (paramClass.isArray()) {
      return ArrayType.construct(_constructType(paramClass.getComponentType(), null), null, null);
    }
  ...
  public JavaType[] findTypeParameters(Class paramClass1, Class paramClass2, TypeBindings paramTypeBindings)
  {
    ...
    for (;;)
    {
      ...
      if (((HierarchicType)localObject1).isGeneric())
      {
        ...
        while (i < j)
        {
          paramClass1.addBinding(localObject2[i].getName(), instance._constructType(paramClass2[i], paramTypeBindings));
          i += 1;
        }
      }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/org/codehaus/jackson/map/type/TypeFactory.class
