  ...
  private void decode(String paramString)
  {
    ...
    try
    {
      ...
      if (!paramString.isNull("errors"))
      {
        ...
        this.errorCode = z_T4JInternalParseUtil.getInt("code", paramString);
      }
      return;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/TwitterException.class
