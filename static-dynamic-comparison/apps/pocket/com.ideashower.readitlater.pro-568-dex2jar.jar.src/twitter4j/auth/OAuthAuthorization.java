  ...
  implements Serializable, Authorization, OAuthSupport
{
  ...
  public static String encodeParameters(List paramList)
  {
    return encodeParameters(paramList, "&", false);
  }
  
  public static String encodeParameters(List paramList, String paramString, boolean paramBoolean)
  {
  ...
  static String normalizeAuthorizationHeaders(List paramList)
  {
    Collections.sort(paramList);
    return encodeParameters(paramList);
  }
  
  static String normalizeRequestParameters(List paramList)
  {
    Collections.sort(paramList);
    return encodeParameters(paramList);
  }
  ...
  private void parseGetParameters(String paramString, List paramList)
  {
    int i = 0;
    int j = paramString.indexOf("?");
    if (-1 != j) {
      paramString = z_T4JInternalStringUtil.split(paramString.substring(j + 1), "&");
    }
    for (;;)
    {
      try
  ...
  static List toParamList(HttpParameter[] paramArrayOfHttpParameter)
  {
  ...
  public List generateOAuthSignatureHttpParams(String paramString1, String paramString2)
  {
  ...
  String generateSignature(String paramString, OAuthToken paramOAuthToken)
  {
    // Byte code:
    //   0: ldc 14
    //   2: invokestatic 351	javax/crypto/Mac:getInstance	(Ljava/lang/String;)Ljavax/crypto/Mac;
    //   5: astore 5
    //   7: aload_2
    //   8: ifnonnull +62 -> 70
    //   11: new 353	javax/crypto/spec/SecretKeySpec
    //   14: dup
    //   15: new 143	java/lang/StringBuilder
    //   18: dup
    //   19: invokespecial 144	java/lang/StringBuilder:<init>	()V
    //   22: aload_0
    //   23: getfield 268	twitter4j/auth/OAuthAuthorization:consumerSecret	Ljava/lang/String;
    //   26: invokestatic 196	twitter4j/internal/http/HttpParameter:encode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   40: invokevirtual 357	java/lang/String:getBytes	()[B
    //   43: ldc 14
    //   45: invokespecial 360	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   48: astore_3
    //   49: aload 5
    //   51: aload_3
    //   52: invokevirtual 364	javax/crypto/Mac:init	(Ljava/security/Key;)V
    //   55: aload 5
    //   57: aload_1
    //   58: invokevirtual 357	java/lang/String:getBytes	()[B
    //   61: invokevirtual 368	javax/crypto/Mac:doFinal	([B)[B
    //   64: astore_1
    //   65: aload_1
    //   66: invokestatic 373	twitter4j/internal/http/BASE64Encoder:encode	([B)Ljava/lang/String;
    //   69: areturn
    //   70: aload_2
    //   71: invokevirtual 377	twitter4j/auth/OAuthToken:getSecretKeySpec	()Ljavax/crypto/spec/SecretKeySpec;
    //   74: astore 4
    //   76: aload 4
    //   78: astore_3
    //   79: aload 4
    //   81: ifnonnull -32 -> 49
    //   84: new 353	javax/crypto/spec/SecretKeySpec
    //   87: dup
    //   88: new 143	java/lang/StringBuilder
    //   91: dup
    //   92: invokespecial 144	java/lang/StringBuilder:<init>	()V
    //   95: aload_0
    //   96: getfield 268	twitter4j/auth/OAuthAuthorization:consumerSecret	Ljava/lang/String;
    //   99: invokestatic 196	twitter4j/internal/http/HttpParameter:encode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   110: aload_2
    //   111: invokevirtual 380	twitter4j/auth/OAuthToken:getTokenSecret	()Ljava/lang/String;
    //   114: invokestatic 196	twitter4j/internal/http/HttpParameter:encode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   123: invokevirtual 357	java/lang/String:getBytes	()[B
    //   126: ldc 14
    //   128: invokespecial 360	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   131: astore_3
    //   132: aload_2
    //   133: aload_3
    //   134: invokevirtual 384	twitter4j/auth/OAuthToken:setSecretKeySpec	(Ljavax/crypto/spec/SecretKeySpec;)V
    //   137: goto -88 -> 49
    //   140: astore_1
    //   141: getstatic 55	twitter4j/auth/OAuthAuthorization:logger	Ltwitter4j/internal/logging/Logger;
    //   144: ldc_w 386
    //   147: aload_1
    //   148: invokevirtual 390	twitter4j/internal/logging/Logger:error	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   151: new 392	java/lang/AssertionError
    //   154: dup
    //   155: aload_1
    //   156: invokespecial 395	java/lang/AssertionError:<init>	(Ljava/lang/Object;)V
    //   159: athrow
    //   160: astore_1
    //   161: getstatic 55	twitter4j/auth/OAuthAuthorization:logger	Ltwitter4j/internal/logging/Logger;
    //   164: ldc_w 397
    //   167: aload_1
    //   168: invokevirtual 390	twitter4j/internal/logging/Logger:error	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   171: new 392	java/lang/AssertionError
    //   174: dup
    //   175: aload_1
    //   176: invokespecial 395	java/lang/AssertionError:<init>	(Ljava/lang/Object;)V
    //   179: athrow
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/auth/OAuthAuthorization.class
