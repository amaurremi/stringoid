  ...
  implements Serializable, Configuration
{
  ...
  public int hashCode()
  {
    ...
    for (;;)
    {
      ...
      return ((i38 + (i37 + (i36 + (i35 + (i34 + (i33 + (i32 + (i31 + (i30 + (i29 + (i28 + (i27 + (i26 + (i25 + (i24 + (((i23 + (i22 + (i21 + (i20 + (i19 + (i18 + (i17 + (i16 + (i15 + (i14 + (i13 + (i12 + (i11 + (i10 + (i9 + (i8 + (i7 + (i6 + (((((((((i5 + (i4 + (i3 + (i2 + (i1 + (n + (m + (k + (j + i * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31 + i41) * 31 + i42) * 31 + i43) * 31 + i44) * 31 + i45) * 31 + i46) * 31 + i47) * 31 + i48) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31 + i49) * 31 + i50) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31) * 31 + i39) * 31 + i40;
      i = 0;
      break;
      label1030:
      j = 0;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/conf/ConfigurationBase.class
