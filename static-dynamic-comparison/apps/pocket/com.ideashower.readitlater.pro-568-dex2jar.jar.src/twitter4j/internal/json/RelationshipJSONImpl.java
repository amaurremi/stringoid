  ...
  implements Serializable, Relationship
{
  ...
  static ResponseList createRelationshipList(HttpResponse paramHttpResponse, Configuration paramConfiguration)
  {
    try
    {
      if (paramConfiguration.isJSONStoreEnabled()) {
  ...
  public int hashCode()
  {
    ...
    for (;;)
    {
      ...
      return (((n + (m + (k + (j + (i + i3 * 31) * 31) * 31) * 31) * 31) * 31 + i1) * 31 + i4) * 31 + i2;
      i = 0;
      break;
      label165:
      j = 0;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/internal/json/RelationshipJSONImpl.class
