  ...
  implements Serializable, User
{
  ...
  static PagableResponseList createPagableUserList(HttpResponse paramHttpResponse, Configuration paramConfiguration)
  {
    try
    {
      if (paramConfiguration.isJSONStoreEnabled()) {
  ...
  static ResponseList createUserList(HttpResponse paramHttpResponse, Configuration paramConfiguration)
  {
    return createUserList(paramHttpResponse.asJSONArray(), paramHttpResponse, paramConfiguration);
  }
  
  static ResponseList createUserList(JSONArray paramJSONArray, HttpResponse paramHttpResponse, Configuration paramConfiguration)
  {
    for (;;)
    {
      int i;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/internal/json/UserJSONImpl.class
