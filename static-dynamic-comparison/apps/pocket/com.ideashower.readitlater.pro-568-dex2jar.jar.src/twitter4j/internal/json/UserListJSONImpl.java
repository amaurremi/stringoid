  ...
  implements Serializable, UserList
{
  ...
  static PagableResponseList createPagableUserListList(HttpResponse paramHttpResponse, Configuration paramConfiguration)
  {
    for (;;)
    {
      int i;
  ...
  static ResponseList createUserListList(HttpResponse paramHttpResponse, Configuration paramConfiguration)
  {
    for (;;)
    {
      int i;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/pocket/com.ideashower.readitlater.pro-568-dex2jar.jar!/twitter4j/internal/json/UserListJSONImpl.class
