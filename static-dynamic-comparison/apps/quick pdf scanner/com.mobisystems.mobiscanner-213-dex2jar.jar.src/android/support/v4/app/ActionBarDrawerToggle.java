...
import android.support.v4.widget.DrawerLayout.b;
import android.view.MenuItem;
import android.view.View;
import android.view.Window;

public class ActionBarDrawerToggle
  implements DrawerLayout.b
{
    ...
    implements Drawable.Callback
  {
    ...
    public void draw(Canvas paramCanvas)
    {
      ...
      paramCanvas.save();
      if (p.g(ActionBarDrawerToggle.this.mActivity.getWindow().getDecorView()) == 1) {}
      for (int i = 1;; i = 0)
      {
        if (i != 0) {
          j = -1;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/app/ActionBarDrawerToggle.class
