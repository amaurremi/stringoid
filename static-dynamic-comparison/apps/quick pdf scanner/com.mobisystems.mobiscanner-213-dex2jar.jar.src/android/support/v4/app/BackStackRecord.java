  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  int commitInternal(boolean paramBoolean)
  {
    ...
    if (FragmentManagerImpl.DEBUG)
    {
      ...
      dump("  ", null, new PrintWriter(new d("FragmentManager")), null);
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
