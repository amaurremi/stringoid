  ...
  extends FragmentManager
{
      ...
      if (paramParcelable.mActive != null)
      {
        ...
        while (i < paramParcelable.mBackStack.length)
        {
          ...
          if (DEBUG)
          {
            ...
            paramArrayList.dump("  ", new PrintWriter(new d("FragmentManager")), false);
          }
  ...
  public String toString()
  {
    ...
    if (this.mParent != null) {
      c.a(this.mParent, localStringBuilder);
    }
    for (;;)
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/app/FragmentManagerImpl.class
