  ...
  extends LoaderManager
{
  ...
  final android.support.v4.b.h<LoaderInfo> mInactiveLoaders = new android.support.v4.b.h();
  final android.support.v4.b.h<LoaderInfo> mLoaders = new android.support.v4.b.h();
  boolean mRetaining;
  ...
  public <D> android.support.v4.content.h<D> getLoader(int paramInt)
  {
    if (this.mCreatingLoader) {
      throw new IllegalStateException("Called while creating a loader");
    }
  ...
  public <D> android.support.v4.content.h<D> initLoader(int paramInt, Bundle paramBundle, LoaderManager.LoaderCallbacks<D> paramLoaderCallbacks)
  {
    if (this.mCreatingLoader) {
      throw new IllegalStateException("Called while creating a loader");
    }
  ...
  public <D> android.support.v4.content.h<D> restartLoader(int paramInt, Bundle paramBundle, LoaderManager.LoaderCallbacks<D> paramLoaderCallbacks)
  {
    if (this.mCreatingLoader) {
      throw new IllegalStateException("Called while creating a loader");
    }
  ...
  public String toString()
  {
    ...
    c.a(this.mActivity, localStringBuilder);
    ...
    implements h.a<Object>
  {
    ...
    android.support.v4.content.h<Object> mLoader;
    ...
    void callOnLoadFinished(android.support.v4.content.h<Object> paramh, Object paramObject)
    {
      String str;
      ...
      for (;;)
      {
        try
        {
          if (LoaderManagerImpl.DEBUG) {
            Log.v("LoaderManager", "  onLoadFinished in " + paramh + ": " + paramh.dataToString(paramObject));
          }
          this.mCallbacks.onLoadFinished(paramh, paramObject);
          if (LoaderManagerImpl.this.mActivity != null) {
    ...
    public void onLoadComplete(android.support.v4.content.h<Object> paramh, Object paramObject)
    {
      if (LoaderManagerImpl.DEBUG) {
      ...
      do
      {
        ...
        if ((this.mData != paramObject) || (!this.mHaveData))
        {
          ...
          this.mHaveData = true;
          if (this.mStarted) {
            callOnLoadFinished(paramh, paramObject);
          }
        }
        paramh = (LoaderInfo)LoaderManagerImpl.this.mInactiveLoaders.get(this.mId);
        if ((paramh != null) && (paramh != this))
        {
          paramh.mDeliveredData = false;
          paramh.destroy();
    ...
    public String toString()
    {
      ...
      localStringBuilder.append(" : ");
      c.a(this.mLoader, localStringBuilder);
      localStringBuilder.append("}}");
      return localStringBuilder.toString();
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/app/LoaderManagerImpl.class
