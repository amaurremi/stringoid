  ...
  implements Iterable<Intent>
{
  ...
  public void startActivities(Bundle paramBundle)
  {
    ...
    Intent[] arrayOfIntent = (Intent[])this.mIntents.toArray(new Intent[this.mIntents.size()]);
    arrayOfIntent[0] = new Intent(arrayOfIntent[0]).addFlags(268484608);
    if (!a.startActivities(this.mSourceContext, arrayOfIntent, paramBundle))
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/android/support/v4/app/TaskStackBuilder.class
