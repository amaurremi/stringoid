  ...
  implements Parcelable.Creator<GroundOverlayOptions>
{
  static void a(GroundOverlayOptions paramGroundOverlayOptions, Parcel paramParcel, int paramInt)
  {
    ...
    b.c(paramParcel, 1, paramGroundOverlayOptions.lX());
    b.a(paramParcel, 2, paramGroundOverlayOptions.uT(), false);
    b.a(paramParcel, 3, paramGroundOverlayOptions.uU(), paramInt, false);
    b.a(paramParcel, 4, paramGroundOverlayOptions.getWidth());
    b.a(paramParcel, 5, paramGroundOverlayOptions.getHeight());
    b.a(paramParcel, 6, paramGroundOverlayOptions.uV(), paramInt, false);
    b.a(paramParcel, 7, paramGroundOverlayOptions.getBearing());
    b.a(paramParcel, 8, paramGroundOverlayOptions.uS());
    b.a(paramParcel, 9, paramGroundOverlayOptions.isVisible());
    b.a(paramParcel, 10, paramGroundOverlayOptions.uW());
    b.a(paramParcel, 11, paramGroundOverlayOptions.uX());
    b.a(paramParcel, 12, paramGroundOverlayOptions.uY());
    b.D(paramParcel, i);
  }
  
  public GroundOverlayOptions bm(Parcel paramParcel)
  {
  ...
  public GroundOverlayOptions[] dU(int paramInt)
  {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/quick pdf scanner/com.mobisystems.mobiscanner-213-dex2jar.jar!/com/google/android/gms/maps/model/e.class
