  ...
  extends SerializerBase<JsonSerializable>
{
    ...
    throws com.flurry.org.codehaus.jackson.map.JsonMappingException
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 31	com/flurry/org/codehaus/jackson/map/ser/std/SerializableSerializer:createObjectNode	()Lcom/flurry/org/codehaus/jackson/node/ObjectNode;
    //   4: astore 9
    //   6: ldc 33
    //   8: astore 7
    //   10: aconst_null
    ...
    //   30: ifnull +111 -> 141
    //   33: aload_2
    //   34: invokestatic 39	com/flurry/org/codehaus/jackson/map/type/TypeFactory:type	(Ljava/lang/reflect/Type;)Lcom/flurry/org/codehaus/jackson/type/JavaType;
    //   37: invokevirtual 45	com/flurry/org/codehaus/jackson/type/JavaType:getRawClass	()Ljava/lang/Class;
    //   40: astore_2
    //   41: aload 6
    //   43: astore 5
    //   45: aload 8
    ...
    //   67: checkcast 47	com/flurry/org/codehaus/jackson/schema/JsonSerializableSchema
    //   70: astore 7
    //   72: aload 7
    ...
    //   143: ldc 76
    //   145: aload 4
    //   147: invokevirtual 82	com/flurry/org/codehaus/jackson/node/ObjectNode:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   150: aload_3
    //   151: ifnull +27 -> 178
    //   154: aload 9
    //   156: ldc 84
    //   158: new 86	com/flurry/org/codehaus/jackson/map/ObjectMapper
    //   161: dup
    //   162: invokespecial 87	com/flurry/org/codehaus/jackson/map/ObjectMapper:<init>	()V
    //   165: aload_3
    //   166: ldc 89
    //   168: invokevirtual 93	com/flurry/org/codehaus/jackson/map/ObjectMapper:readValue	(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    //   171: checkcast 89	com/flurry/org/codehaus/jackson/JsonNode
    //   174: invokevirtual 96	com/flurry/org/codehaus/jackson/node/ObjectNode:put	(Ljava/lang/String;Lcom/flurry/org/codehaus/jackson/JsonNode;)Lcom/flurry/org/codehaus/jackson/JsonNode;
    //   177: pop
    //   178: aload 5
    //   180: ifnull +28 -> 208
    //   183: aload 9
    //   185: ldc 98
    //   187: new 86	com/flurry/org/codehaus/jackson/map/ObjectMapper
    //   190: dup
    //   191: invokespecial 87	com/flurry/org/codehaus/jackson/map/ObjectMapper:<init>	()V
    //   194: aload 5
    //   196: ldc 89
    //   198: invokevirtual 93	com/flurry/org/codehaus/jackson/map/ObjectMapper:readValue	(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    //   201: checkcast 89	com/flurry/org/codehaus/jackson/JsonNode
    //   204: invokevirtual 96	com/flurry/org/codehaus/jackson/node/ObjectNode:put	(Ljava/lang/String;Lcom/flurry/org/codehaus/jackson/JsonNode;)Lcom/flurry/org/codehaus/jackson/JsonNode;
    //   207: pop
    //   208: aload 9
    //   210: areturn
    //   211: astore_1
    ...
    //   4	205	9	localObjectNode	com.flurry.org.codehaus.jackson.node.ObjectNode
    // Exception table:
    //   from	to	target	type
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/randomchat/com.pioong-93-dex2jar.jar!/com/flurry/org/codehaus/jackson/map/ser/std/SerializableSerializer.class
