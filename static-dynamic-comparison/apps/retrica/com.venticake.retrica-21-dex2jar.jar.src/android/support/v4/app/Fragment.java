  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  private static final android.support.v4.d.k<String, Class<?>> sClassMap = new android.support.v4.d.k();
  h mActivity;
  boolean mAdded;
  View mAnimatingAway;
  Bundle mArguments;
  ...
  public static Fragment instantiate(Context paramContext, String paramString, Bundle paramBundle)
  {
    ...
    {
      throw new g("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an" + " empty constructor that is public", paramContext);
    }
  ...
  void instantiateChildFragmentManager()
  {
    ...
    this.mChildFragmentManager.a(this.mActivity, new k()
    {
  ...
  void performCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      if (paramBundle != null)
      {
        ...
        this.mChildFragmentManager.a(paramBundle, null);
        this.mChildFragmentManager.k();
      }
    }
  }
  ...
  void performSaveInstanceState(Bundle paramBundle)
  {
    ...
    if (this.mChildFragmentManager != null)
    {
      Parcelable localParcelable = this.mChildFragmentManager.i();
  ...
  public void startActivity(Intent paramIntent)
  {
    ...
    this.mActivity.a(this, paramIntent, -1);
  }
  ...
  public void startActivityForResult(Intent paramIntent, int paramInt)
  {
    ...
    this.mActivity.a(this, paramIntent, paramInt);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/app/Fragment.class
