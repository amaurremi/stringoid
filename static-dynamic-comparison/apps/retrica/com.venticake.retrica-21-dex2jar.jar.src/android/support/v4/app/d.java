  ...
  implements Runnable
{
  ...
  int a(boolean paramBoolean)
  {
    ...
    if (n.a)
    {
      ...
      a("  ", null, new PrintWriter(new android.support.v4.d.d("FragmentManager")), null);
    }
    this.n = true;
    if (this.k) {}
  ...
  public p b(Fragment paramFragment)
  {
    e locale = new e();
    locale.c = 6;
    locale.d = paramFragment;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (locale != null)
    {
      ...
      case 1: 
        ...
        this.a.a(localFragment, n.c(this.i), this.j);
      }
      for (;;)
      {
        locale = locale.b;
        ...
        if (locale.i != null)
        {
          ...
          localFragment = locale.d;
          localFragment.mNextAnim = locale.g;
          this.a.c(localFragment, n.c(this.i), this.j);
          continue;
          localFragment = locale.d;
          localFragment.mNextAnim = locale.h;
          this.a.b(localFragment, n.c(this.i), this.j);
          continue;
          localFragment = locale.d;
          localFragment.mNextAnim = locale.g;
          this.a.e(localFragment, n.c(this.i), this.j);
          continue;
          localFragment = locale.d;
          localFragment.mNextAnim = locale.g;
          this.a.d(localFragment, n.c(this.i), this.j);
        }
      }
    }
    if (paramBoolean) {
  ...
  public p c(Fragment paramFragment)
  {
    e locale = new e();
    locale.c = 7;
    locale.d = paramFragment;
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/app/d.class
