  ...
  extends Activity
{
  ...
  final k c = new k()
  {
    ...
    {
      return h.this.findViewById(paramAnonymousInt);
    }
  };
  boolean d;
  boolean e;
  ...
  boolean j;
  boolean k;
  android.support.v4.d.k<String, s> l;
  s m;
  ...
  s a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (this.l == null) {
      this.l = new android.support.v4.d.k();
    }
    s locals = (s)this.l.get(paramString);
    if (locals == null)
    {
      if (paramBoolean2)
      {
        locals = new s(paramString, this, paramBoolean1);
        this.l.put(paramString, locals);
      }
      return locals;
    }
    locals.a(this);
  ...
  public View onCreateView(String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, i.a);
    String str1 = str2;
    if (str2 == null) {
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    {
      int i3 = this.l.size();
      localObject2 = new s[i3];
      int n = i3 - 1;
      while (n >= 0)
      {
        localObject2[n] = ((s)this.l.c(n));
        n -= 1;
      }
      n = 0;
      i2 = n;
      if (i1 < i3)
      {
        ...
        for (;;)
        {
          ...
          break;
          ((s)localObject3).h();
          this.l.remove(((s)localObject3).d);
        }
      }
    }
    else
    ...
    ((j)localObject2).a = null;
    ((j)localObject2).b = localObject1;
    ((j)localObject2).c = null;
    ((j)localObject2).d = localArrayList;
    ((j)localObject2).e = this.l;
    return localObject2;
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/app/h.class
