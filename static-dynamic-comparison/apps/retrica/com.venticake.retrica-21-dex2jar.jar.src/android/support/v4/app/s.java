  ...
  extends q
{
  ...
  s(String paramString, h paramh, boolean paramBoolean)
  {
    this.d = paramString;
    this.e = paramh;
    this.f = paramBoolean;
  ...
  public void a(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    if (this.b.b() > 0)
    {
      ...
      while (i < this.b.b())
      {
        ...
        paramPrintWriter.print(": ");
        paramPrintWriter.println(localt.toString());
        localt.a(str, paramFileDescriptor, paramPrintWriter, paramArrayOfString);
        i += 1;
      }
    }
    if (this.c.b() > 0)
  ...
  public boolean a()
  {
    ...
    if (i < j)
    {
      t localt = (t)this.b.b(i);
      if ((localt.h) && (!localt.f)) {}
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/app/s.class
