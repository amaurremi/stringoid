  ...
  implements e, Filterable
{
  ...
  void a(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    for (this.g = new c(this, null);; this.g = null)
    {
      if (bool)
      {
        if (this.f != null) {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/widget/a.class
