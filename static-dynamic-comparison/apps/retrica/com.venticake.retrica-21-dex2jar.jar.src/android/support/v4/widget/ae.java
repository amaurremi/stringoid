...
public class ae
{
  ...
  private ae(Context paramContext, ViewGroup paramViewGroup, af paramaf)
  {
  ...
  public static ae a(ViewGroup paramViewGroup, float paramFloat, af paramaf)
  {
    paramViewGroup = a(paramViewGroup, paramaf);
    paramViewGroup.b = ((int)(paramViewGroup.b * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static ae a(ViewGroup paramViewGroup, af paramaf)
  {
    return new ae(paramViewGroup.getContext(), paramViewGroup, paramaf);
  }
  ...
  {
    int i2 = ak.c(paramMotionEvent);
    int i1 = 0;
    while (i1 < i2)
    {
      int i3 = ak.b(paramMotionEvent, i1);
      float f1 = ak.c(paramMotionEvent, i1);
      float f2 = ak.d(paramMotionEvent, i1);
      this.f[i3] = f1;
      this.g[i3] = f2;
      i1 += 1;
    }
  ...
  private void h()
  {
    ...
    a(a(aq.a(this.l, this.c), this.n, this.m), a(aq.b(this.l, this.c), this.n, this.m));
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)aq.a(this.l, this.c), (int)aq.b(this.l, this.c));
  }
  
  public boolean a(MotionEvent paramMotionEvent)
  {
    int i2 = ak.a(paramMotionEvent);
  ...
  public void b(MotionEvent paramMotionEvent)
  {
    ...
    case 5: 
      do
      {
        do
        {
          ...
          f1 = ak.c(paramMotionEvent, i3);
          f2 = ak.d(paramMotionEvent, i3);
          a(f1, f2, i1);
          if (this.a != 0) {
            break;
          }
    ...
    case 2: 
      if (this.a == 1)
      {
        i1 = ak.a(paramMotionEvent, this.c);
        f1 = ak.c(paramMotionEvent, i1);
        f2 = ak.d(paramMotionEvent, i1);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v4/widget/ae.class
