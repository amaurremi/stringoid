  ...
  implements View.OnClickListener
{
  ...
  public e(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap)
  {
  ...
  public View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    paramContext.setTag(new f(paramContext));
    return paramContext;
  }
  ...
  {
    paramContext = (f)paramView.getTag();
    if (this.w != -1) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    catch (RuntimeException paramView)
    {
      ...
      if (paramViewGroup != null) {
        ((f)paramViewGroup.getTag()).a.setText(paramView.toString());
      }
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/android/support/v7/widget/e.class
