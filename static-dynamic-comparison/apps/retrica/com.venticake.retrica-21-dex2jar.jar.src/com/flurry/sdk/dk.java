...
public class dk
{
  ...
  public void a(java.io.DataOutputStream paramDataOutputStream, String paramString1, String paramString2)
  {
    ...
    //   0: aload_1
    //   1: ldc -117
    //   3: invokevirtual 145	java/io/DataOutputStream:writeShort	(I)V
    //   6: aload_1
    //   7: iconst_2
    //   8: invokevirtual 145	java/io/DataOutputStream:writeShort	(I)V
    //   11: aload_1
    //   12: aload_2
    //   13: invokevirtual 148	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   16: aload_1
    //   17: aload_3
    //   18: invokevirtual 148	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   21: aload_1
    //   22: aload_0
    //   23: getfield 150	com/flurry/sdk/dk:b	Z
    //   26: invokevirtual 153	java/io/DataOutputStream:writeBoolean	(Z)V
    //   29: aload_1
    //   30: aload_0
    //   31: getfield 31	com/flurry/sdk/dk:d	J
    //   34: invokevirtual 156	java/io/DataOutputStream:writeLong	(J)V
    //   37: aload_0
    //   38: getfield 158	com/flurry/sdk/dk:c	Ljava/util/List;
    ...
    //   52: iflt +67 -> 119
    //   55: aload_0
    //   56: getfield 158	com/flurry/sdk/dk:c	Ljava/util/List;
    //   59: iload 4
    //   61: invokeinterface 165 2 0
    //   66: checkcast 119	com/flurry/sdk/dh
    //   69: invokevirtual 168	com/flurry/sdk/dh:a	()[B
    //   72: astore_2
    //   73: aload_2
    //   74: arraylength
    //   75: istore 5
    ...
    //   80: iadd
    //   81: aload_1
    //   82: invokevirtual 169	java/io/DataOutputStream:size	()I
    //   85: iadd
    //   86: ldc -86
    //   88: if_icmple +41 -> 129
    //   91: bipush 6
    ...
    //   108: iload 4
    //   110: invokevirtual 66	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   113: invokevirtual 55	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   116: invokestatic 71	com/flurry/sdk/eo:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   119: aload_1
    //   120: iconst_0
    //   121: invokevirtual 145	java/io/DataOutputStream:writeShort	(I)V
    //   124: aload_1
    //   125: invokestatic 177	com/flurry/sdk/fe:a	(Ljava/io/Closeable;)V
    //   128: return
    //   129: aload_1
    //   130: iload 5
    //   132: invokevirtual 145	java/io/DataOutputStream:writeShort	(I)V
    //   135: aload_1
    //   136: aload_2
    //   137: invokevirtual 180	java/io/DataOutputStream:write	([B)V
    //   140: iload 4
    //   142: iconst_1
    //   143: isub
    //   144: istore 4
    ...
    //   155: ldc -74
    //   157: aload_2
    //   158: invokestatic 185	com/flurry/sdk/eo:a	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   161: new 75	java/io/IOException
    //   164: dup
    //   165: aload_2
    //   166: invokevirtual 188	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   169: invokespecial 78	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   172: athrow
    //   173: astore_2
    //   174: aload_1
    //   175: invokestatic 177	com/flurry/sdk/fe:a	(Ljava/io/Closeable;)V
    //   178: aload_2
    //   179: athrow
  ...
  public boolean a(DataInputStream paramDataInputStream, String paramString)
  {
    ...
    //   31: invokestatic 71	com/flurry/sdk/eo:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   34: iload_3
    //   35: ldc -117
    //   37: if_icmpne +18 -> 55
    //   40: aload_0
    //   41: aload_2
    //   42: aload_1
    //   43: invokespecial 195	com/flurry/sdk/dk:a	(Ljava/lang/String;Ljava/io/DataInputStream;)Z
    //   46: istore 4
    //   48: aload_1
    //   49: invokestatic 177	com/flurry/sdk/fe:a	(Ljava/io/Closeable;)V
    //   52: iload 4
    //   54: ireturn
    //   55: iconst_3
    //   56: getstatic 23	com/flurry/sdk/dk:a	Ljava/lang/String;
    //   59: ldc -59
    //   61: invokestatic 71	com/flurry/sdk/eo:a	(ILjava/lang/String;Ljava/lang/String;)V
    //   64: goto -16 -> 48
    //   67: astore_2
    //   68: bipush 6
    ...
    //   73: ldc -57
    //   75: aload_2
    //   76: invokestatic 185	com/flurry/sdk/eo:a	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   79: new 75	java/io/IOException
    //   82: dup
    //   83: aload_2
    //   84: invokevirtual 188	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   87: invokespecial 78	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   90: athrow
    //   91: astore_2
    //   92: aload_1
    //   93: invokestatic 177	com/flurry/sdk/fe:a	(Ljava/io/Closeable;)V
    //   96: aload_2
    //   97: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/flurry/sdk/dk.class
