  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  public ExceptionReporter(Tracker paramTracker, Thread.UncaughtExceptionHandler paramUncaughtExceptionHandler, Context paramContext)
  {
    ...
    this.tO = paramUncaughtExceptionHandler;
    this.tP = paramTracker;
    this.tQ = new StandardExceptionParser(paramContext, new ArrayList());
  ...
  public void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    {
      str = this.tQ.getDescription(str, paramThrowable);
      aa.C("Tracking Exception: " + str);
      this.tP.send(new HitBuilders.ExceptionBuilder().setDescription(str).setFatal(true).build());
      GoogleAnalytics.getInstance(this.mContext).dispatchLocalHits();
      if (this.tO != null)
      {
        aa.C("Passing exception to original handler.");
        this.tO.uncaughtException(paramThread, paramThrowable);
      }
      return;
    }
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/analytics/ExceptionReporter.class
