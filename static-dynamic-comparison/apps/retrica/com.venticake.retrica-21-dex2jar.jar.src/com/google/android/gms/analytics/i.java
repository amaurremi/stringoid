  ...
  extends SQLiteOpenHelper
{
  ...
  i(h paramh, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   73: invokestatic 114	com/google/android/gms/analytics/aa:D	(Ljava/lang/String;)V
    //   76: aload_2
    //   77: ifnull +9 -> 86
    //   80: aload_2
  ...
  {
    if ((this.b) && (this.c + 3600000L > h.a(this.a).a())) {
    ...
    catch (SQLiteException localSQLiteException)
    {
      ...
      {
        Object localObject2;
        h.c(this.a).getDatabasePath(h.b(this.a)).delete();
      }
    }
  ...
  {
    ai.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      {
        paramSQLiteDatabase.execSQL(h.e());
        return;
      }
    }
    finally
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/analytics/i.class
