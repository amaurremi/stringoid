  ...
  implements SafeParcelable
{
  ...
  private java.io.FileOutputStream eT()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 68	com/google/android/gms/common/data/a:Ez	Ljava/io/File;
    //   4: ifnonnull +13 -> 17
    ...
    //   19: ldc 79
    //   21: aload_0
    //   22: getfield 68	com/google/android/gms/common/data/a:Ez	Ljava/io/File;
    ...
    //   45: putfield 36	com/google/android/gms/common/data/a:Ew	Landroid/os/ParcelFileDescriptor;
    //   48: aload_1
  ...
  public Bitmap eS()
  {
    Object localObject1;
    if (!this.Ey) {
      localObject1 = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(this.Ew));
    }
    try
    {
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    if (this.Ew == null)
    {
      ...
      localObject = new DataOutputStream(eT());
    }
    try
    {
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/common/data/a.class
