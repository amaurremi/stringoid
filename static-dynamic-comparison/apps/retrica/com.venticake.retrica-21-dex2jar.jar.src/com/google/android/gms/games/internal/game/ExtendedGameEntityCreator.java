  ...
  implements Parcelable.Creator<ExtendedGameEntity>
{
  static void a(ExtendedGameEntity paramExtendedGameEntity, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramExtendedGameEntity.ia(), paramInt, false);
    b.c(paramParcel, 1000, paramExtendedGameEntity.getVersionCode());
    b.c(paramParcel, 2, paramExtendedGameEntity.hR());
    b.a(paramParcel, 3, paramExtendedGameEntity.hS());
    b.c(paramParcel, 4, paramExtendedGameEntity.hT());
    b.a(paramParcel, 5, paramExtendedGameEntity.hU());
    b.a(paramParcel, 6, paramExtendedGameEntity.hV());
    b.a(paramParcel, 7, paramExtendedGameEntity.hW(), false);
    b.a(paramParcel, 8, paramExtendedGameEntity.hX());
    b.a(paramParcel, 9, paramExtendedGameEntity.hY(), false);
    b.b(paramParcel, 10, paramExtendedGameEntity.hQ(), false);
    b.a(paramParcel, 11, paramExtendedGameEntity.hZ(), paramInt, false);
    b.G(paramParcel, i);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/games/internal/game/ExtendedGameEntityCreator.class
