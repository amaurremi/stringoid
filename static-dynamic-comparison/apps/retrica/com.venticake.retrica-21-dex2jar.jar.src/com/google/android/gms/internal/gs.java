...
public class gs
{
  ...
  public static String a(Calendar paramCalendar)
  {
    ...
    return ((String)localObject).replace("+0000", CO[0]);
  }
  ...
  public static void a(JSONObject paramJSONObject, List<WebImage> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext()) {
        localJSONArray.put(((WebImage)paramList.next()).dZ());
      }
    }
    try
    {
  ...
  public static Calendar aq(String paramString)
  {
    ...
    for (paramString = "yyyyMMdd'T'HHmmss";; paramString = CP)
    {
      ...
      {
        label127:
        BG.b("Error parsing string: %s", new Object[] { paramString.getMessage() });
      }
    }
    return null;
  }
  ...
  private static String ar(String paramString)
  {
    ...
    {
      BG.c("Error extracting the date: %s", new Object[] { paramString.getMessage() });
    }
    return null;
  }
  ...
  private static String as(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          BG.b("Error extracting the time substring: %s", new Object[] { paramString.getMessage() });
          return null;
        }
    ...
    } while (paramString.length() != "HHmmss".length() + CO[0].length());
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/retrica/com.venticake.retrica-21-dex2jar.jar!/com/google/android/gms/internal/gs.class
