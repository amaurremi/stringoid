            ...
            for (int i = Q(); ; i = j) {
                ...
                if (j <= paramInt3) {
                    if (j == paramInt3) {
                        this.p.a(paramInt1);
                        localObject = this.p;
                        arrayOfChar = ((sp) localObject).e();
                        paramInt1 = ((sp) localObject).d();
                        paramInt3 = ((sp) localObject).c();
                ...
                if (j < 0) {
                    ...
                    if (j < 0) {
                        ...
                        if (i == -2) {
                            ...
                            c = arrayOfChar[i];
                            if (!paramha.a(c)) {
                                throw a(paramha, c, 3, "expected padding character '" + paramha.b() + "'");
                            }
                            localsj.a(m >> 4);
                            continue;
                        }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/flurry/sdk/hy.class
