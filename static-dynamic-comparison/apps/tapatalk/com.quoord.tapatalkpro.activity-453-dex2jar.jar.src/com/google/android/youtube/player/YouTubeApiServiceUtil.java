...
public final class YouTubeApiServiceUtil {
    ...
    public static YouTubeInitializationResult isYouTubeApiServiceAvailable(Context paramContext) {
        try {
            ...
            if (!localPackageManager.getApplicationInfo(str, 0).enabled) {
                return YouTubeInitializationResult.SERVICE_DISABLED;
            }
            paramContext = YouTubeInitializationResult.SUCCESS;
            return paramContext;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/google/android/youtube/player/YouTubeApiServiceUtil.class
