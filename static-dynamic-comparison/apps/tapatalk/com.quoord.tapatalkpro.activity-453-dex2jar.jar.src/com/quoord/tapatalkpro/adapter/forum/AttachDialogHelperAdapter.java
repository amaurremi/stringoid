...
public class AttachDialogHelperAdapter
        extends BaseAdapter {
    private ArrayList<String> mAttachArray = new ArrayList();
    private Activity mContext;

    public AttachDialogHelperAdapter(Activity paramActivity) {
        this.mContext = paramActivity;
        this.mAttachArray.add(paramActivity.getString(2131099996));
        try {
            this.mAttachArray.add(paramActivity.getString(2131099997));
            return;
        } catch (Exception paramActivity) {
        }
    }

    public AttachDialogHelperAdapter(Activity paramActivity, ForumStatus paramForumStatus) {
        this.mContext = paramActivity;
        this.mAttachArray.add(paramActivity.getString(2131099996));
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/adapter/forum/AttachDialogHelperAdapter.class
