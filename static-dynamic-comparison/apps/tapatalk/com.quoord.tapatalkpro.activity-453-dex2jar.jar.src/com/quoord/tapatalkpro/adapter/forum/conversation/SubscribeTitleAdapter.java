...
public class SubscribeTitleAdapter
        extends BaseAdapter {
    ...
    public SubscribeTitleAdapter(Activity paramActivity, ArrayList<String> paramArrayList) {
    ...
    public View getDropDownView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        paramView = LayoutInflater.from(this.mActivity).inflate(2130903376, null);
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        paramView = LayoutInflater.from(this.mActivity).inflate(2130903375, null);
        ...
        paramViewGroup.setText(((String) this.mData.get(paramInt)).trim());
        return paramView;
    }
}


/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/adapter/forum/conversation/SubscribeTitleAdapter.class
