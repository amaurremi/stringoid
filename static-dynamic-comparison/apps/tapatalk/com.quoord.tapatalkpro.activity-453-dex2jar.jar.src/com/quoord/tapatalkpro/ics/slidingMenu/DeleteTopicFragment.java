...
public class DeleteTopicFragment
        extends BaseListFragment {
    private ActionBar bar;
    private DeleteTopicAdapter deleteAdapter;
    private ForumStatus forumStatus;
    private ListView listView;

    public static DeleteTopicFragment newInstance() {
        return new DeleteTopicFragment();
    }
    ...
    public void onActivityCreated(Bundle paramBundle) {
        ...
        this.deleteAdapter = new DeleteTopicAdapter(this.mActivity, this.forumStatus.getUrl(), this.listView, true, this);
    }
            ...
            public Dialog onCreateDialog(Bundle paramAnonymousBundle) {
                new AlertDialog.Builder(getActivity()).setMessage(2131099971).setPositiveButton(2131099792, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int) {
                        ((LatestTopicAdapter) DeleteTopicFragment.this.adapter).cleanDatas();
                        new MarkAllReadAdapter(DeleteTopicFragment.this.mActivity, DeleteTopicFragment.this.forumstatus.getUrl());
                    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/ics/slidingMenu/DeleteTopicFragment.class
