...
import com.quoord.tapatalkpro.adapter.forum.ReportedTopicAdapter;
import com.quoord.tapatalkpro.bean.ForumStatus;
import com.quoord.tapatalkpro.ics.BaseListFragment;
import com.quoord.tapatalkpro.util.ThemeUtil;

public class ReportTopicFragment
        extends BaseListFragment {
    private ActionBar bar;
    private ForumStatus forumStatus;
    private ListView listView;
    private Activity mActivity;
    private ReportedTopicAdapter reportAdapter;

    public static ReportTopicFragment newInstance() {
        return new ReportTopicFragment();
    }
    ...
    public void onActivityCreated(Bundle paramBundle) {
        ...
        this.reportAdapter = new ReportedTopicAdapter(this.mActivity, this.forumStatus.getUrl(), this.listView, this);
    }
            ...
            public Dialog onCreateDialog(Bundle paramAnonymousBundle) {
                new AlertDialog.Builder(getActivity()).setMessage(2131099971).setPositiveButton(2131099792, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int) {
                        ((LatestTopicAdapter) ReportTopicFragment.this.adapter).cleanDatas();
                        new MarkAllReadAdapter(ReportTopicFragment.this.mActivity, ReportTopicFragment.this.forumstatus.getUrl());
                    }
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/ics/slidingMenu/ReportTopicFragment.class
