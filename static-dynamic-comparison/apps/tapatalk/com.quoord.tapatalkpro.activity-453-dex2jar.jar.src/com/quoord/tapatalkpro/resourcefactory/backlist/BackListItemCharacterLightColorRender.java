...
public class BackListItemCharacterLightColorRender
    ...
    public BackListItemCharacterLightColorRender(Context paramContext) {
        initCharacterColorProduct(paramContext);
    }

    private void initCharacterColorProduct(Context paramContext) {
        setBackColor(paramContext.getResources().getColor(2131165214));
        setDefaultColor(paramContext.getResources().getColor(2131165214));
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/resourcefactory/backlist/BackListItemCharacterLightColorRender.class
