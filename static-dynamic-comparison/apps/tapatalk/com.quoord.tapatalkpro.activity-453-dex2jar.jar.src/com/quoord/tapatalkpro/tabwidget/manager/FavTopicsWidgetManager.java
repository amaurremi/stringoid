...
import com.quoord.tapatalkpro.tabwidget.FavTopicsWidget;
...
public class FavTopicsWidgetManager {
    public static final String PREFS_NAME = "com.quoord.tapatalkpro.tabwidget.manager.FavTopicsWidgetManager";
    private static final String TOPIC_ID_PREFIX = "favtopics_";
    private static final Map<Integer, FavTopicsWidget> mWidgets = new ConcurrentHashMap();
    private static final FavTopicsWidgetManager sInstance = new FavTopicsWidgetManager();

    private FavTopicsWidget get(int paramInt) {
        return (FavTopicsWidget) mWidgets.get(Integer.valueOf(paramInt));
    }

    public static FavTopicsWidgetManager getInstance() {
        return sInstance;
    }

    public static int loadForumIdPref(Context paramContext, int paramInt) {
        return paramContext.getSharedPreferences("com.quoord.tapatalkpro.tabwidget.manager.FavTopicsWidgetManager", 0).getInt("favtopics_" + paramInt, -1);
    }

    private void put(int paramInt, FavTopicsWidget paramFavTopicsWidget) {
        mWidgets.put(Integer.valueOf(paramInt), paramFavTopicsWidget);
    }
    ...
    public static void removeWidgetPrefs(Context paramContext, int paramInt) {
        Object localObject = paramContext.getSharedPreferences("com.quoord.tapatalkpro.tabwidget.manager.FavTopicsWidgetManager", 0);
    ...
    public static void saveWidgetPrefs(Context paramContext, int paramInt1, int paramInt2) {
        paramContext.getSharedPreferences("com.quoord.tapatalkpro.tabwidget.manager.FavTopicsWidgetManager", 0).edit().putInt("favtopics_" + paramInt1, paramInt2).commit();
    }
    ...
    public void createWidgets(Context paramContext, int[] paramArrayOfInt) {
        ...
        //   20: iload_3
        //   21: iaload
        //   22: invokevirtual 145	com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager:getOrCreateWidget	(Landroid/content/Context;I)Lcom/quoord/tapatalkpro/tabwidget/FavTopicsWidget;
        //   25: pop
        //   26: iload_3
        //   27: iconst_1
        //   28: iadd
        ...
        //   0	38	0	this	FavTopicsWidgetManager
    ...
    public void deleteAllWidgets(Context paramContext) {
        ...
        //   56: aload_1
        //   57: aload 4
        //   59: invokevirtual 157	com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager:deleteWidgets	(Landroid/content/Context;[I)V
        //   62: aload_0
        //   63: monitorexit
        //   64: return
        //   65: aload_3
        ...
        // Local variable table:
        //   start	length	slot	name	signature
        //   0	117	0	this	FavTopicsWidgetManager
    ...
    public void deleteWidgets(Context paramContext, int[] paramArrayOfInt) {
        ...
        //   19: iaload
        //   20: istore 5
        //   22: invokestatic 176	com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager:getInstance	()Lcom/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager;
        //   25: iload 5
        //   27: invokespecial 178	com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager:get	(I)Lcom/quoord/tapatalkpro/tabwidget/FavTopicsWidget;
        //   30: astore 6
        //   32: aload 6
        //   34: ifnull +8 -> 42
        //   37: aload 6
        //   39: invokevirtual 181	com/quoord/tapatalkpro/tabwidget/FavTopicsWidget:onDeleted	()V
        //   42: aload_0
        //   43: aload_1
        //   44: iload 5
        //   46: invokespecial 183	com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager:remove	(Landroid/content/Context;I)V
        //   49: iload_3
        //   50: iconst_1
        //   51: iadd
        //   52: istore_3
        ...
        // Local variable table:
        //   start	length	slot	name	signature
        //   0	61	0	this	FavTopicsWidgetManager
        //   0	61	1	paramContext	Context
        //   0	61	2	paramArrayOfInt	int[]
        //   7	46	3	i	int
        //   4	8	4	j	int
        //   20	25	5	k	int
        //   30	8	6	localFavTopicsWidget	FavTopicsWidget
        // Exception table:
        //   from	to	target	type
        //   2	6	56	finally
        //   22	32	56	finally
    ...
    public void deleteWidgetsByForumId(Context paramContext, String paramString) {
        ...
        //   62: aload_1
        //   63: aload 6
        //   65: invokevirtual 157	com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager:deleteWidgets	(Landroid/content/Context;[I)V
        //   68: aload_0
        //   69: monitorexit
        //   70: return
        //   71: aload 5
        ...
        // Local variable table:
        //   start	length	slot	name	signature
        //   0	154	0	this	FavTopicsWidgetManager
    ...
    public void dump(FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString) {
        ...
        for (; ; ) {
            ...
            paramArrayOfString = (FavTopicsWidget) paramFileDescriptor.next();
    ...
    public FavTopicsWidget getOrCreateWidget(Context paramContext, int paramInt) {
        try {
            FavTopicsWidget localFavTopicsWidget2 = getInstance().get(paramInt);
            FavTopicsWidget localFavTopicsWidget1 = localFavTopicsWidget2;
            if (localFavTopicsWidget2 == null) {
                localFavTopicsWidget1 = new FavTopicsWidget(paramContext, paramInt, loadForumIdPref(paramContext, paramInt));
                put(paramInt, localFavTopicsWidget1);
                localFavTopicsWidget1.start();
            }
            return localFavTopicsWidget1;
        } finally {
        }
    }
    ...
    public void updateWidgets(Context paramContext, int[] paramArrayOfInt) {
        for (; ; ) {
            ...
            try {
                ...
                FavTopicsWidget localFavTopicsWidget = getInstance().get(k);
                if (localFavTopicsWidget != null) {
                    localFavTopicsWidget.reset();
                } else {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/com/quoord/tapatalkpro/tabwidget/manager/FavTopicsWidgetManager.class
