...
public abstract class ToStringStyle
    ...
    protected void removeLastFieldSeparator(StringBuffer paramStringBuffer) {
        ...
        int n = this.fieldSeparator.length();
        int k;
        int i;
        if ((m > 0) && (n > 0) && (m >= n)) {
            k = 1;
        ...
        for (; ; ) {
            int j = k;
            if (i < n) {
                if (paramStringBuffer.charAt(m - 1 - i) != this.fieldSeparator.charAt(n - 1 - i)) {
                    j = 0;
                }
            } else {
                if (j != 0) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/org/apache/commons/lang/builder/ToStringStyle.class
