            ...
            for (; ; ) {
                if (j < k) {
                    ...
                    if (localStackTraceElement.getClassName().startsWith(str)) {
                        j = localStackTraceElement.getClassName().hashCode();
                        k = localStackTraceElement.getMethodName().hashCode();
                        this.stackLineHash = (this.stackLineHash * 31 + (j + k));
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/ExceptionDiagnosis.class
