...
public final class GeoQuery
    ...
    public int hashCode() {
        ...
        for (int k = this.accuracy.hashCode(); ; k = 0) {
            ...
            return (((i * 31 + j) * 31 + k) * 31 + m) * 31 + this.maxResults;
            i = 0;
            break;
            j = 0;
            break label33;
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/GeoQuery.class
