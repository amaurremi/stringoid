        ...
        try {
            ...
            if (!paramJSONObject.isNull("entities")) {
                ...
                if (!((JSONObject) localObject).isNull("user_mentions")) {
                    ...
                    this.userMentionEntities = new UserMentionEntity[j];
                    i = 0;
                    while (i < j) {
                ...
                if (!((JSONObject) localObject).isNull("urls")) {
                    ...
                    j = localJSONArray.length();
                    this.urlEntities = new URLEntity[j];
                    i = 0;
                    while (i < j) {
                ...
                if (!((JSONObject) localObject).isNull("hashtags")) {
                    ...
                    j = localJSONArray.length();
                    this.hashtagEntities = new HashtagEntity[j];
                    i = 0;
                    while (i < j) {
                ...
                if (!((JSONObject) localObject).isNull("symbols")) {
                    ...
                    j = localJSONArray.length();
                    this.symbolEntities = new SymbolEntity[j];
                    i = 0;
                    while (i < j) {
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/internal/json/StatusJSONImpl.class
