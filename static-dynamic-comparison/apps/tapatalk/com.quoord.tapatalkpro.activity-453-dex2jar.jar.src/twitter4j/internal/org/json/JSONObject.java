...
public class JSONObject {
    ...
    private void populateMap(Object paramObject) {
        ...
        try {
            ...
            if (((String) localObject2).equals("getClass")) {
                break label269;
            }
            if (!((String) localObject2).equals("getDeclaringClass")) {
                break label184;
            }
        } catch (Exception localException) {
            for (; ; ) {
    ...
    String toString(int paramInt1, int paramInt2)
        ...
        for (; ; ) {
            ...
            localStringBuilder.append(quote(localObject2.toString()));
            localStringBuilder.append(": ");
            localStringBuilder.append(valueToString(this.map.get(localObject2), paramInt1, j));
...
/* Location:              /Users/amaurremi/uw/stringoid stuff/static vs dynamic/tapatalk/com.quoord.tapatalkpro.activity-453-dex2jar.jar!/twitter4j/internal/org/json/JSONObject.class
