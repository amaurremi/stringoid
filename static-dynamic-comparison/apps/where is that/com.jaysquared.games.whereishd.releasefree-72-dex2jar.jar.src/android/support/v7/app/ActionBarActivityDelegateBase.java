  ...
  implements MenuPresenter.Callback, MenuBuilder.Callback
{
  ...
  private void applyFixedSizeWindow()
  {
    ...
    if (localTypedArray.hasValue(6))
    {
      ...
      localTypedArray.getValue(6, (TypedValue)localObject3);
    }
    if (localTypedArray.hasValue(4))
    {
      ...
      localTypedArray.getValue(4, (TypedValue)localObject4);
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/android/support/v7/app/ActionBarActivityDelegateBase.class
