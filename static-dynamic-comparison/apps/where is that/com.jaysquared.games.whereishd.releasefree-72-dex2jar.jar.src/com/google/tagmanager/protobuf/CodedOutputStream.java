...
public final class CodedOutputStream
{
  ...
  public void writeGroupNoTagWithCachedSizes(MutableMessageLite paramMutableMessageLite)
    throws IOException
  {
    paramMutableMessageLite.writeToWithCachedSizes(this);
  }
  
  public void writeGroupWithCachedSizes(int paramInt, MutableMessageLite paramMutableMessageLite)
    throws IOException
  {
    writeTag(paramInt, 3);
    writeGroupNoTagWithCachedSizes(paramMutableMessageLite);
    writeTag(paramInt, 4);
  }
  ...
  public void writeMessageNoTagWithCachedSizes(MutableMessageLite paramMutableMessageLite)
    throws IOException
  {
    writeRawVarint32(paramMutableMessageLite.getCachedSize());
    paramMutableMessageLite.writeToWithCachedSizes(this);
  }
  ...
  public void writeMessageWithCachedSizes(int paramInt, MutableMessageLite paramMutableMessageLite)
    throws IOException
  {
    writeTag(paramInt, 2);
    writeMessageNoTagWithCachedSizes(paramMutableMessageLite);
  }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/google/tagmanager/protobuf/CodedOutputStream.class
