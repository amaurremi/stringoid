...
public class InMobiAnalytics
{
  ...
  public static void beginSection(String paramString, Map<String, String> paramMap)
  {
    ...
    {
      Log.debug("[InMobi]-[Analytics]-4.1.1", "Please pass a valid Section Name");
    }
  }
  ...
  public static void reportCustomGoal(String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.1.1", "Unable to report custom goal due to unexpected exception.", paramString);
    }
  }
  ...
  public static void tagEvent(String paramString, Map<String, String> paramMap)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.1.1", "Unable to tag event due to unexpected exception.", paramString);
    }
  }
  ...
  public static void tagTransactionManually(Intent paramIntent, Bundle paramBundle)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.1.1", "Unable to tag transaction due to unexpected exception.", paramIntent);
    }
  }
}


/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/analytics/InMobiAnalytics.class
