  ...
  implements HttpRequestCallback
{
  ...
  public void notifyResult(int paramInt, Object paramObject)
  {
    ...
    if (paramInt == 0)
    {
      InterstitialView.a(this.a, ((Response)paramObject).getAdResponse());
      InterstitialView.b(this.a, ((Response)paramObject).getImpressionId());
      InterstitialView.b(this.a).sendEmptyMessage(308);
    }
    while (paramInt != 1) {
      return;
    }
    long l = System.currentTimeMillis() - InterstitialView.c(this.a);
    Message localMessage = InterstitialView.b(this.a).obtainMessage(309);
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/androidsdk/f.class
