...
public class IMAIController
{
  ...
  {
    Log.debug("[InMobi]-[Network]-4.1.1", paramString);
  }
  ...
  public void openEmbedded(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      Log.internal("[InMobi]-[Network]-4.1.1", "IMAI openEmbedded failed", localException);
      return;
    }
  ...
  public void openExternal(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      Log.internal("[InMobi]-[Network]-4.1.1", "IMAI openExternal failed", localException);
    }
  }
  ...
  public void ping(String paramString, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      Log.internal("[InMobi]-[Network]-4.1.1", "IMAI ping failed", localException);
      return;
    }
  ...
  public void pingInWebView(String paramString, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      Log.internal("[InMobi]-[Network]-4.1.1", "IMAI pingInWebView failed", localException);
      return;
    }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/androidsdk/impl/imai/IMAIController.class
