  ...
  extends DatabaseHandler
{
  ...
  public static ClickDatabaseManager getInstance()
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        Object localObject1;
        Log.internal("[InMobi]-[Network]-4.1.1", "Exception getting DB Manager Instance", localException);
  ...
  public boolean deleteClickEvents(ArrayList<Long> paramArrayList)
  {
    ...
    //   66: aconst_null
    //   67: invokevirtual 163	com/inmobi/androidsdk/impl/imai/db/ClickDatabaseManager:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   70: pop
    //   71: goto -49 -> 22
    //   74: astore_1
    //   75: ldc 107
    ...
    //   90: ireturn
    //   91: aload_0
    //   92: invokevirtual 168	com/inmobi/androidsdk/impl/imai/db/ClickDatabaseManager:close	()V
    //   95: iconst_1
    //   96: istore 4
    //   98: goto -12 -> 86
    //   101: iconst_0
  ...
  public IMAIClickEventList getClickEvents(int paramInt)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          Log.internal("[InMobi]-4.1.1", "Failed to get clicks from db", localException);
          continue;
        }
  ...
  public int getNoOfEvents()
  {
    ...
    {
      Log.internal("[InMobi]-[Network]-4.1.1", "Exception getting no of click events", localException);
    }
    return 0;
  }
  ...
  public void insertClick(ClickData paramClickData)
  {
    ...
    catch (Exception paramClickData)
    {
      for (;;)
      {
        paramClickData.printStackTrace();
        Log.internal("[InMobi]-4.1.1", "Failed to insert click event to db", paramClickData);
      }
    }
    finally {}
  }
  ...
  public boolean updateRetryCount(ArrayList<ClickData> paramArrayList)
  {
    ...
    //   31: aload_1
    //   32: invokeinterface 137 1 0
    //   37: checkcast 185	com/inmobi/androidsdk/impl/imai/db/ClickData
    //   40: astore_3
    //   41: new 240	android/content/ContentValues
    //   44: dup
    //   45: invokespecial 241	android/content/ContentValues:<init>	()V
    //   48: astore 4
    //   50: aload 4
    //   52: ldc 8
    //   54: aload_3
    //   55: invokevirtual 306	com/inmobi/androidsdk/impl/imai/db/ClickData:getClickId	()J
    //   58: invokestatic 248	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   61: invokevirtual 251	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   64: aload 4
    //   66: ldc 11
    //   68: aload_3
    //   69: invokevirtual 254	com/inmobi/androidsdk/impl/imai/db/ClickData:getClickUrl	()Ljava/lang/String;
    //   72: invokevirtual 257	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   75: aload 4
    //   77: ldc 14
    //   79: aload_3
    //   80: invokevirtual 282	com/inmobi/androidsdk/impl/imai/db/ClickData:isFollowRedirects	()Z
    //   83: invokestatic 265	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   86: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Boolean;)V
    //   89: aload 4
    //   91: ldc 17
    //   93: aload_3
    //   94: invokevirtual 260	com/inmobi/androidsdk/impl/imai/db/ClickData:isPingWv	()Z
    //   97: invokestatic 265	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   100: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Boolean;)V
    //   103: aload 4
    //   105: ldc 20
    //   107: aload_3
    //   108: invokevirtual 271	com/inmobi/androidsdk/impl/imai/db/ClickData:getRetryCount	()I
    //   111: iconst_1
    //   112: iadd
    //   113: invokestatic 276	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   116: invokevirtual 279	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   119: aload 4
    //   121: ldc 23
    //   123: aload_3
    //   124: invokevirtual 244	com/inmobi/androidsdk/impl/imai/db/ClickData:getTimestamp	()J
    //   127: invokestatic 248	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   130: invokevirtual 251	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   133: aload_0
    //   134: ldc 26
    //   136: aload 4
    //   138: ldc_w 308
    //   141: iconst_1
    //   142: anewarray 310	java/lang/String
    //   145: dup
    //   146: iconst_0
    //   147: aload_3
    //   148: invokevirtual 306	com/inmobi/androidsdk/impl/imai/db/ClickData:getClickId	()J
    //   151: invokestatic 313	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   154: aastore
    //   155: invokevirtual 317	com/inmobi/androidsdk/impl/imai/db/ClickDatabaseManager:update	(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)J
    //   158: pop2
    //   159: goto -137 -> 22
    //   162: astore_1
    //   163: ldc 107
    ...
    //   177: ireturn
    //   178: aload_0
    //   179: invokevirtual 168	com/inmobi/androidsdk/impl/imai/db/ClickDatabaseManager:close	()V
    //   182: iconst_1
    //   183: istore_2
    //   184: goto -10 -> 174
    //   187: iconst_0
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/androidsdk/impl/imai/db/ClickDatabaseManager.class
