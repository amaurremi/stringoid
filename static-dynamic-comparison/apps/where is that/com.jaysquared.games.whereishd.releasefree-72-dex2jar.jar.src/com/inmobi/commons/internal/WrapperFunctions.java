...
public class WrapperFunctions
{
  ...
  private static void a(WebView paramWebView, int paramInt)
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot set hardware accl", paramWebView);
      return;
    }
  ...
  public static int getDisplayHeight(Display paramDisplay)
  {
    ...
    catch (NoSuchMethodException localNoSuchMethodException1)
    {
      for (;;)
      {
        ...
        {
          int i;
          Log.internal("[InMobi]-4.1.1", "Cannot get display height", paramDisplay);
          return 0;
        }
        ...
        {
          Log.internal("[InMobi]-4.1.1", "Cannot get display height", localNoSuchMethodException2);
          i = 0;
        }
      }
  ...
  public static int getDisplayWidth(Display paramDisplay)
  {
    ...
    catch (NoSuchMethodException localNoSuchMethodException1)
    {
      for (;;)
      {
        ...
        {
          int i;
          Log.internal("[InMobi]-4.1.1", "Cannot get display width", paramDisplay);
          return 0;
        }
        catch (IllegalAccessException paramDisplay)
        {
        ...
        {
          Log.internal("[InMobi]-4.1.1", "Cannot get display width", localNoSuchMethodException2);
          i = 0;
        }
      }
      i = ((Integer)((Method)localObject1).invoke(paramDisplay, (Object[])null)).intValue();
  ...
  public static int getParamConfigScreenSize()
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get screen size", localNoSuchFieldException);
      return 0;
    }
    catch (Exception localException)
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get screen size", localException);
    }
    return 0;
  }
  ...
  public static int getParamConfigSmallestScreenSize()
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get smallest screen size", localNoSuchFieldException);
      return 0;
    }
    catch (Exception localException)
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get smallest screen size", localException);
    }
    return 0;
  }
  ...
  {
    // Byte code:
    //   0: getstatic 163	com/inmobi/commons/internal/WrapperFunctions:a	I
    //   3: ifne +45 -> 48
    //   6: ldc 2
    //   8: monitorenter
    //   9: getstatic 163	com/inmobi/commons/internal/WrapperFunctions:a	I
    //   12: ifne +33 -> 45
    //   15: new 165	android/view/ViewGroup$LayoutParams
    //   18: dup
    //   19: iconst_1
    //   20: iconst_1
    //   21: invokespecial 168	android/view/ViewGroup$LayoutParams:<init>	(II)V
    //   24: astore_1
    //   25: ldc -91
    //   27: ldc -86
    //   29: invokevirtual 147	java/lang/Class:getField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   32: astore_0
    //   33: aload_0
    //   34: ifnull +11 -> 45
    //   37: aload_0
    //   38: aload_1
    //   39: invokevirtual 153	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   42: putstatic 163	com/inmobi/commons/internal/WrapperFunctions:a	I
    //   45: ldc 2
    //   47: monitorexit
    //   48: getstatic 163	com/inmobi/commons/internal/WrapperFunctions:a	I
    //   51: ireturn
    //   52: astore_0
    //   53: ldc -91
    //   55: ldc -84
    //   57: invokevirtual 147	java/lang/Class:getField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   60: astore_0
    //   61: goto -28 -> 33
    //   64: astore_0
    //   65: ldc 52
  ...
  public static int getParamLandscapeOrientation(int paramInt)
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get landscape orientation", localNoSuchFieldException);
      return 0;
    }
    catch (Exception localException)
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get landscape orientation", localException);
    }
    return 0;
  }
  ...
  public static int getParamPortraitOrientation(int paramInt)
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get portrait orientation", localNoSuchFieldException);
      return 1;
    }
    catch (Exception localException)
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get portrait orientation", localException);
    }
    return 1;
  }
  ...
  public static String getSSLErrorUrl(SslError paramSslError)
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get SSL Url", paramSslError);
    }
    return null;
  }
    ...
    throws Exception
  {
    ...
    {
      Log.internal("[InMobi]-4.1.1", "Cannot get video bitmap", paramString);
      throw paramString;
    }
  }
}
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/commons/internal/WrapperFunctions.class
