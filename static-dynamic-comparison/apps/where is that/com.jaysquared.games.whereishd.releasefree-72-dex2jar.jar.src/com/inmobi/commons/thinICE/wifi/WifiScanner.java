...
public final class WifiScanner
{
  ...
  private static void d()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 35	com/inmobi/commons/thinICE/wifi/WifiScanner:c	Landroid/os/Handler;
    //   6: astore_0
    //   7: aload_0
    //   8: ifnonnull +7 -> 15
    //   11: ldc 2
    //   13: monitorexit
    //   14: return
    //   15: getstatic 35	com/inmobi/commons/thinICE/wifi/WifiScanner:c	Landroid/os/Handler;
    //   18: getstatic 42	com/inmobi/commons/thinICE/wifi/WifiScanner:e	Ljava/lang/Runnable;
    ...
    //   27: getstatic 37	com/inmobi/commons/thinICE/wifi/WifiScanner:d	Z
    //   30: ifeq +9 -> 39
    ...
    //   39: aconst_null
    //   40: putstatic 35	com/inmobi/commons/thinICE/wifi/WifiScanner:c	Landroid/os/Handler;
    //   43: aconst_null
    //   44: putstatic 33	com/inmobi/commons/thinICE/wifi/WifiScanner:b	Lcom/inmobi/commons/thinICE/wifi/WifiScanListener;
    //   47: aconst_null
    //   48: putstatic 31	com/inmobi/commons/thinICE/wifi/WifiScanner:a	Landroid/content/Context;
    //   51: iconst_0
    //   52: putstatic 37	com/inmobi/commons/thinICE/wifi/WifiScanner:d	Z
    //   55: goto -44 -> 11
    //   58: astore_0
    //   59: ldc 2
    //   61: monitorexit
  ...
  public static boolean requestScan(Looper paramLooper, Context paramContext, WifiScanListener paramWifiScanListener, long paramLong, boolean paramBoolean)
  {
    ...
    //   48: putstatic 31	com/inmobi/commons/thinICE/wifi/WifiScanner:a	Landroid/content/Context;
    //   51: aload_2
    //   52: putstatic 33	com/inmobi/commons/thinICE/wifi/WifiScanner:b	Lcom/inmobi/commons/thinICE/wifi/WifiScanListener;
    //   55: iload 5
    //   57: putstatic 37	com/inmobi/commons/thinICE/wifi/WifiScanner:d	Z
    //   60: new 68	android/os/Handler
    //   63: dup
    //   64: aload_0
    //   65: invokespecial 155	android/os/Handler:<init>	(Landroid/os/Looper;)V
    //   68: putstatic 35	com/inmobi/commons/thinICE/wifi/WifiScanner:c	Landroid/os/Handler;
    //   71: getstatic 35	com/inmobi/commons/thinICE/wifi/WifiScanner:c	Landroid/os/Handler;
    //   74: getstatic 42	com/inmobi/commons/thinICE/wifi/WifiScanner:e	Ljava/lang/Runnable;
    //   77: lload_3
    //   78: invokevirtual 159	android/os/Handler:postDelayed	(Ljava/lang/Runnable;J)Z
    //   81: pop
    //   82: getstatic 37	com/inmobi/commons/thinICE/wifi/WifiScanner:d	Z
    //   85: ifeq +9 -> 94
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/inmobi/commons/thinICE/wifi/WifiScanner.class
