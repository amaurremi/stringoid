  ...
  implements Closeable
{
  ...
  public DiskLruCacheStrictLineReader(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
  ...
  public DiskLruCacheStrictLineReader(InputStream paramInputStream, Charset paramCharset)
  {
        ...
        localObject2 = new ByteArrayOutputStream(this.end - this.pos + 80)
        {
          public String toString()
          {
            ...
            for (int i = this.count - 1;; i = this.count) {
              try
              {
                String str = new String(this.buf, 0, i, DiskLruCacheStrictLineReader.this.charset.name());
                return str;
              }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/where is that/com.jaysquared.games.whereishd.releasefree-72-dex2jar.jar!/com/mopub/nativeads/DiskLruCacheStrictLineReader.class
