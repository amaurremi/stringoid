...
{
  AdManager$16(AlertDialog paramAlertDialog, ArrayList paramArrayList1, ArrayList paramArrayList2, ImageButton paramImageButton1, ImageButton paramImageButton2) {}
  ...
  public void onClick(View paramView)
  {
    if (this.val$adDialog != null)
    {
      ...
      if (AdManager.access$10() >= 0) {
        break label58;
      }
      AdManager.access$11(0);
      this.val$nextBtn.setEnabled(true);
      this.val$prevBtn.setEnabled(true);
      if (AdManager.access$10() - 4 < 0) {
        this.val$prevBtn.setEnabled(false);
      }
    }
    return;
    label58:
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/xperia z/com.androidwasabi.livewallpaper.xperiaz-13-dex2jar.jar!/com/androidwasabi/ads/AdManager$16.class
