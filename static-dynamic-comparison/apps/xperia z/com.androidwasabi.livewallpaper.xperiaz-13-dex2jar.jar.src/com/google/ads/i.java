  ...
  implements Runnable
{
  ...
  private <T extends NetworkExtras, U extends MediationServerParameters> void a(MediationAdapter<T, U> paramMediationAdapter)
  {
    ...
    if (localActivity == null) {
      throw new i.a("Activity became null while trying to instantiate adapter.");
    }
      ...
      for (localObject2 = (NetworkExtras)this.c.getNetworkExtras((Class)localObject2);; localObject2 = null)
      {
        ...
        if (this.a.a.a())
        {
          if (!(paramMediationAdapter instanceof MediationInterstitialAdapter)) {
            throw new i.a("Adapter " + this.b + " doesn't support the MediationInterstitialAdapter" + " interface.");
          }
        ...
        for (;;)
        {
          ...
          if (!(paramMediationAdapter instanceof MediationBannerAdapter)) {
            throw new i.a("Adapter " + this.b + " doesn't support the MediationBannerAdapter interface");
          }
...
/* Location:              /Users/amaurremi/uw/stringoid/static-dynamic-comparison/apps/xperia z/com.androidwasabi.livewallpaper.xperiaz-13-dex2jar.jar!/com/google/ads/i.class
